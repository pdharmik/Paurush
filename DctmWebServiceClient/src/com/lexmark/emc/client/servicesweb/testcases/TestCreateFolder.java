...
public class TestCreateFolder {
	...
	public static void main(String[] args){
		...
		try {
			...
			// TODO Auto-generated catch block
			e.printStackTrace();
		} catch (ECMServiceException_Exception e) {
			// TODO Auto-generated catch block
			e.getMessage();
	...
	private static String getInputParameter() {
		...
		try {
			 ...
			 */
			folderInfo.setDestinationPath("/Services Web/Services Portal/Public Documents");
			folderInfo.setObjectName("services-web1");
