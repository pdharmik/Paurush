...
public class TestMoveContent {
	...
	private static String getInputParameter() {
		...
		try {
			...
			/*folderInfo.setRFolderPath("/Temp/Example/move-me");
			folderInfo.setDestinationPath("/Temp/Example/copy-under-this-folder");*/
			
			folderInfo.setRFolderPath("/Temp/services-web/services-web2");
			folderInfo.setDestinationPath("/Temp/services-web/services-web11");
