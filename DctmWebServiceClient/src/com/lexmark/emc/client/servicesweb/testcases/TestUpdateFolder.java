...
public class TestUpdateFolder {
	...
	private static String getInputParameter() {
		...
		try {
			...
			/*folderInfo.setRFolderPath("/Temp/Example/folder-to-rename");
			folderInfo.setObjectName("new-folder-name");*/
			
			folderInfo.setRFolderPath("/Temp/services-web/services-web1");
			folderInfo.setObjectName("services-web11");
