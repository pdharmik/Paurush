			...
			<table class="cellTable">
				...
				<tr> 
					...
					<div class="float-right">
						<a href="javascript:back();" class="button_cancel div-style87"><spring:message code="button.cancel"/></a>&nbsp;
						<a href="javascript:document.SRLocaleDetailsForm.submit();" class="button anchor-style3" ><spring:message code="button.submit"/></a>
					</div>
					</td>
				</tr>
			</table></td></tr>
