...
<div class="main-wrap">
	<div class="content">
		...
		<div class="right-column"> --%>
		 <div class="div-style86"> 
		 <h3 class="pageTitle"><spring:message code='serviceRequest.title.serviceRequest'/></h3>
		 
					<div class="grid-controls">
						<div class="utilities">
							<ul>
								<li class="first"><img src="/LexmarkServicesPortal/images/transparent.png" class="ui_icon_sprite spreadsheet-icon cursor-pointer" onClick="return download('csv')" title="<spring:message code='image.title.downloadCSV'/>"; /></li>
								<li><img src="/LexmarkServicesPortal/images/transparent.png" class="ui_icon_sprite pdf-icon cursor-pointer" onClick="return download('pdf')" title="<spring:message code='image.title.downloadPDF'/>"; /></li>
								<li><img src="/LexmarkServicesPortal/images/transparent.png" class="ui_icon_sprite print-icon cursor-pointer" onClick="return print()" title="<spring:message code='image.title.print'/>"; /></li>
							</ul>
						</div><!-- utilities -->
						<div class="expand-min">
							<ul>
								...
								<li>
									<a href="#grid" id='headerImageButton'><img class="ui_icon_sprite customize-icon cursor-pointer" src="<html:imagesPath/>transparent.png"  /></a>
									&nbsp;<a href="#grid" id='headerMenuButton'><spring:message code="serviceRequest.label.customize"/></a>
								</li>
								
								<li>
								<img onclick="javascript:doReset();" src="<html:imagesPath/>transparent.png" class="ui_icon_sprite reset-icon cursor-pointer"
