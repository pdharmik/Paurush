...
.tableHeader { background: url("/LexmarkServicesPortal/images/gridImgs/lex/header-bg.png") repeat-x scroll left top transparent; }

.tableHeader th {
	background: url("/LexmarkServicesPortal/images/gridImgs/lex/hdr_divider.gif") no-repeat scroll left center transparent;
 background: url("/LexmarkServicesPortal/images/gridImgs/lex/header-bg.png") repeat-x scroll left top transparent !ie;
	height: 20px;
	padding: 5px;
	font-weight: bold;
}
...
<div style="">
 <div class="div-style79">
   		<div class="div-style80">
    		<img  src="<html:imagesPath/>transparent.png" class="ui_icon_sprite email-icon cursor-pointer" onClick="return showEmailPopup(); hideSelect();"/>&nbsp; 
       		<img src="/LexmarkServicesPortal/images/transparent.png" class="ui_icon_sprite print-icon cursor-pointer" onClick="return print()" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				...
				<div class="columns two">
					<div id="contactInfoFirstColum" class="first-column">
						<dl>
							...
							<dd class="word-break-break-all"><label><spring:message code="serviceRequest.label.email" />:</label> ${serviceRequestConfirmationForm.serviceRequest.requestor.emailAddress}</dd>
						</dl>
					</div><!-- first-column -->
					<div id="contactInfoSecondColum"  class="second-column">
						<dl>
							...
							<dd class="word-break-break-all"><label><spring:message code="serviceRequest.label.email" />:</label>${serviceRequestConfirmationForm.serviceRequest.primaryContact.emailAddress}</dd>
						</dl>
					</div><!-- second-column -->
					...
					<div id="contactInfoThirdColum" class="third-column">
						<dl>
					        ...
					        <dd class="word-break-break-all"><label><spring:message code="serviceRequest.label.email" />:</label>${serviceRequestConfirmationForm.serviceRequest.secondaryContact.emailAddress}</dd>
						</dl>
					</div><!-- third-column --> 
					</c:if>
					</c:if>
...
<table width="100%" class="float-left">
	<tr>
 	<td class="div-style85">
...
function backToMapView(){
	...
	//window.location.href='fleet-management';
	 ...
	 var lat="${serviceRequestConfirmationForm.serviceRequest.serviceAddress.lbsLatitude}";
	 
		var lon="${serviceRequestConfirmationForm.serviceRequest.serviceAddress.lbsLongitude}";
