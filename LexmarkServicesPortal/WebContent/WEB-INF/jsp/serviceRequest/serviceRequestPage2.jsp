...
<!-- *****************Device Information******************* -->
			<div class="contentHeadId">
				...
				<div class="contentDataId_Left padding-top-5px">
			...
			<div class="contentDataId_Right padding-top-5px">
					<!-- *********************************Service Address*********************************** -->
					 <div class="portlet-wrap rounded"> 
					 <div class="portlet-header">               	
...
<!-- *****************************problemDescription******************************* -->
 			...
 			<div class="portlet-wrap rounded margin-top-10px">
			<div class="portlet-header">
			<h3><spring:message code="serviceRequest.label.problemDescription" /></h3>
			</div>
			<div class="portlet-wrap-inner margin-left-10px">
			<table width="500px">
				<tr>
					<td><b>*<spring:message
						code="serviceRequest.label.problemDescription" /></b><br />
					<form:textarea class="div-style89" path="serviceRequest.problemDescription" maxlength="2000" id="problemDescription" onfocus="jQuery(this).removeClass('errorColor');" onmousedown="jQuery(this).removeClass('errorColor');"/></td>
				</tr>
				...
				<tr>
					...
					<c:choose>
						...
						<c:otherwise>
								...
								<c:forEach items="${serviceRequestConfirmationForm.asset.entitlement.serviceDetails}" var="serviceDetail">
									<c:choose>
										...
										<input type="checkbox" class="selectedServiceDetails" name="selectedServiceDetails" value="${serviceDetail.serviceDetailId}" onclick="showHideDiv(this,'exchangeOfOption'); clearBorder()" /> ${serviceDetail.serviceDetailDescription}<br />
											<div id="exchangeOfOption" style="display: none;" class="div-style90" >
												<form:textarea	id="TextExchangeofOption" class="text-Exchange-of-Option" path="serviceRequest.optionExchangeOtherDescription" onblur="javascript:doOnblur(this,'exchangeofOption');" onfocus="javascript:doOnFocus(this,'exchangeofOption');" maxlength="2000"/>
											</div>
										</c:when>	
										<c:otherwise>
							...
							<div id="otherDiv" style="display: none;" class="div-style90">
								<form:textarea id = "TextOther" class="TextOther" path="serviceRequest.otherRequestedService" onblur="javascript:doOnblur(this,'other');" onfocus="javascript:doOnFocus(this,'other');" maxlength="2000" />
							</div>
							<div class="clear"></div>
      ...
      <div class="portletBlock infoBox rounded shadow">
				...
				<form:form id="serviceRequestAttachmentForm" name="serviceRequestAttachmentForm" commandName="fileUploadForm" method="post" enctype="multipart/form-data">
			     ...
			     function validteDuplicateFile(fileName, fileCount){
					  ...
					  <button class="button cursor-pointer" type="button" id="btnBrowse" ><spring:message code="changemanagement.common.button.browse"/></button>&nbsp;&nbsp;					
					  <button class="button cursor-pointer" type="button" id="btnUpload" onclick="uploadFile();"><spring:message code="changemanagement.common.button.attach"/></button>
					  <span style="display: none">
		...
		<form:form id="dummyForm" name="dummyForm" method="post" class="margin-bottom-10px">
			<div align="right" class="div-style93"><!-- Submit & Cancel -->
