...
<div class="main-wrap">
	<div class="content">
		<table width="100%">
			...
			<tr><td><table class="cellTable">
				<tr class="buttonContainer float-left">
					<td class="table-td-style29">
						<a href="javascript:callOmnitureAction('Service Request', 'Service Request Locale List Add Locale');location.href=addURL;" class="button anchor-style3"><spring:message code="serviceRequestLocaleListPage.addLocaleDetails"/></a>
					</td>
				</tr>
				<tr>
					<td>
					<div id="gridbox" class="div-style88"></div></td>
				</tr>
				<tr> 
					<td height="20">
