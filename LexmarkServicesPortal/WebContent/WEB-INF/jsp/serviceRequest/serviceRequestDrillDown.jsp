...
<script type="text/javascript"> //CI-6 : Start : Attachment
...
<div class="main-wrap">
<br/>
  <div id="serviceUtilityBox" class="div-style79">
     <div class="div-style80">
    		<img src="<html:imagesPath/>transparent.png" class="ui_icon_sprite email-icon cursor-pointer" onClick="loadGridDataForEmail()" /> 
       		<img src="/LexmarkServicesPortal/images/transparent.png" class="ui_icon_sprite print-icon cursor-pointer" onClick="loadGridDataForPrint()" />
    </div>
	<div class="div-style81">
		...
		<c:if test="${serviceRequestForm.createServiceRequestFlag}" > 
    				...
    				<button class="button" onClick="doSubmitSR();">
    				 ...
    				 -->
    				<a class="button color-white" href='<portlet:renderURL windowState="<%= LiferayWindowState.EXCLUSIVE.toString() %>">
				...
				<div class="columns two">
					<div id="problemDescription" class="first-column">
						<dl>
							...
							<dd>${fn:replace(serviceRequestForm.serviceRequest.problemDescription, newLineChar, "<br/>")}</dd>
							<!-- added for CI5 -->
							<br />
					...
					<div id="typeOfServiceNeeded" class="second-column">
						<dl>
							...
							<dd>${serviceRequestForm.serviceRequest.otherRequestedService}</dd>
							<c:forEach items="${serviceRequestForm.serviceRequest.selectedServiceDetails}" var="selectedServiceDetial" varStatus="status">				
								<c:choose>
									<c:when test="${selectedServiceDetial.serviceDetailDescription == 'Option Exchange'}">
										<c:if test="${serviceRequestForm.serviceRequest.optionExchangeOtherDescription != null && fn:trim(serviceRequestForm.serviceRequest.optionExchangeOtherDescription) != ''}">
											...
											<dd>&nbsp;&nbsp;&nbsp;&nbsp;${serviceRequestForm.serviceRequest.optionExchangeOtherDescription}</dd><br>
										</c:if>	
									</c:when>
									<c:otherwise> 
...
<!--								<dd>&nbsp;&nbsp;&nbsp;&nbsp;${serviceRequestForm.serviceRequest.otherRequestedService}</dd><br>-->
<!--							</c:if>-->

							<br/>
							<!-- partha added start -->
							
								<dt><spring:message	code='serviceRequest.label.helpdeskReference' /></dt>
								<dd>&nbsp;${serviceRequestForm.serviceRequest.helpdeskReferenceNumber}</dd><br>
					...
					<!-- partha added start-->
					<div id="eta" class="third-column">
						<dl>
							<dt>&nbsp;&nbsp;<spring:message code="serviceRequest.label.eta" /></dt>							
							<c:choose>
								<c:when test="${serviceRequestForm.serviceRequest.serviceRequestDateETA != null || fn:trim(serviceRequestForm.serviceRequest.serviceRequestDateETA) != '' }">
									<dd>${serviceRequestForm.serviceRequest.serviceRequestETA}</dd>
								</c:when>
								<c:otherwise> 
									<dd>${serviceRequestForm.serviceRequest.serviceRequestSLA}</dd>
								</c:otherwise>
							</c:choose>							
						</dl>
					</div>
			...
			<table>
				<tr>
					<td style="display:block;">
						<img id="img_tab_associatedTicketsGrid" class="ui_icon_sprite expand-icon cursor-pointer" src="<html:imagesPath/>transparent.png" onClick="expandCollapesGrid('tab_associatedTicketsGrid');"  />
					</td>
					<td>
			...
			<div id="div_problemInfoPrintTable">
				<div id="tab_associatedTicketsGrid"  style="display:none;">
        			<div id="div_SRAssociatedContainer" class="width-100per"></div>
		...
		<div class="portlet-wrap-inner">
			<div class="columns two">
					<div class="first-column">
						<div id="divDeviceImgs" class="device width-300px" >
...
<!-- 				   ENDS Changes for Defect 7490 MPS 2.1 -->
	...
	<div id="tab_status" class="portlet-wrap rounded">
		...
		<div>
			<table>
				<tr>
					<td style="display:block;">
						<img id="img_tab_statusGrid" class="ui_icon_sprite expand-icon cursor-pointer" src="<html:imagesPath/>transparent.png" onClick="expandCollapesGrid('tab_statusGrid');" />
					</td>
			...
			<div class="status-block">
						...
						<div class="status-info" style="display:block;">
							...
							<div id="div_technicianProgressBar" class="div-style84"></div><br/><!-- status-bar -->
							<c:choose>
								<c:when test="${serviceRequestForm.serviceRequestTechnicianProgress==0}">
									<table width="480" class="div-style83">
									<tr height="30">
										<td width="33%"></td>
						...
						<table>
							<tr>
								<td>
								<img id="img_tab_technicianGrid" class="ui_icon_sprite expand-icon cursor-pointer" src="<html:imagesPath/>transparent.png" onClick="expandCollapesGrid('tab_technicianGrid');"  />
								</td>
								<td>
								<spring:message code="serviceRequest.label.showDetail"/>
								</td>
			...
			<div class="status-block">
						...
						<div class="status-info"  style="display:block;">
							...
							<div id="div_inProgressBar" class="div-style84"></div><br/><!-- status-bar -->
							<c:choose>
						...
						<table>
							<tr>
								<td>
								<img id="img_tab_inprocessGrid" class="ui_icon_sprite expand-icon cursor-pointer" src="<html:imagesPath/>transparent.png" onClick="expandCollapesGrid('tab_inprocessGrid');"  />
								</td>
								<td>
								<spring:message code="serviceRequest.label.showDetail"/>
								</td>
						...
						<div id="div_inprocessPrintTable">
							<div id="tab_inprocessGrid"  style="display:block;">
								<div id="div_inprocessGridContainer" class="gridbox_light width-100per"></div>
			...
			<div class="status-block">
						...
						<div class="status-info" style="display:block;">
							...
							<div id="div_shipmentProgressBar${status.count}" class="div-style84"></div><br/><!-- status-bar -->
							<c:choose>
						...
						<table>
							<tr>
								<td>
								<img id="img_tab_shipmentGrid${status.count}"  class="ui_icon_sprite expand-icon cursor-pointer" src="<html:imagesPath/>transparent.png" onClick="expandCollapesGrid('tab_shipmentGrid${status.count}');" />
								</td>
								<td>
								<spring:message code="serviceRequest.label.showDetail"/>
								</td>
			...
			<div class="status-block">
				...
				<div class="status-info" style="display:block;">
					...
					<div id="div_inProgressReturnNoTrackNumProgressBar" class="div-style84"></div><br/><!-- status-bar -->
					<c:choose>
				...
				<table>
					<tr>
						<td>
						<img id="img_tab_inProgressReturnNoTrackNumGrid" class="ui_icon_sprite expand-icon cursor-pointer" src="<html:imagesPath/>transparent.png" onClick="expandCollapesGrid('tab_inProgressReturnNoTrackNumGrid');" />
						</td>
						<td>
						<spring:message code="serviceRequest.label.showDetail"/>
						</td>
				...
				<div id="div_inProgressReturnNoTrackNumPrintTable">
					<div id="tab_inProgressReturnNoTrackNumGrid"  style="display:block;">
						<div id="div_inProgressReturnNoTrackNumGrid_container" class="gridbox_light width-100per"></div>
			...
			<div class="status-block">
						...
						<div class="status-info" style="display:block;">
							...
							<div id="div_returnProgressBar${status.count}" class="div-style84"></div><br/><!-- status-bar -->
							<c:choose>
						...
						<table>
							<tr>
								<td>
								<img id="img_tab_returnShipmentGrid${status.count}" class="ui_icon_sprite expand-icon cursor-pointer" src="<html:imagesPath/>transparent.png" onClick="expandCollapesGrid('tab_returnShipmentGrid${status.count}');" />
								</td>
								<td>
								<spring:message code="serviceRequest.label.showDetail"/>
								</td>
						...
						<div id="div_returnShipmentPrintTable${status.count}">
							...
							<div id="div_returnShipmentGrid_container${status.count}" class="width-100per"></div>
			...
			<div class="status-block">
				...
				<div class="status-info" style="display:block;">
					...
					<div id="div_deliveredReturnNoTrackNumProgressBar" class="div-style84"></div><br/><!-- status-bar -->
					<c:choose>
				...
				<table>
					<tr>
						<td>
						<img id="img_tab_deliveredReturnNoTrackNumGrid" class="ui_icon_sprite expand-icon cursor-pointer" src="<html:imagesPath/>transparent.png" onClick="expandCollapesGrid('tab_deliveredReturnNoTrackNumGrid');"  />
						</td>
						<td>
						<spring:message code="serviceRequest.label.showDetail"/>
						</td>
				...
				<div id="div_deliveredReturnNoTrackNumPrintTable">
					<div id="tab_deliveredReturnNoTrackNumGrid"  style="display:block;">
						<div id="div_deliveredReturnNoTrackNumGrid_container" class="gridbox_light width-100per"></div>
   ...
   <div id="tab_contactInfo" class="portlet-wrap rounded">
				...
				<div class="columns two">
					<div id="contactInfoFirstColum" class="first-column">
						<dl>
							...
							<dd class="word-wrap-break-word"><label><spring:message code="serviceRequest.label.email" />:</label> ${serviceRequestForm.serviceRequest.requestor.emailAddress}</dd>
						</dl>
					</div><!-- first-column -->
					<div id="contactInfoSecondColum" class="second-column">
						<dl>
							...
							<!-- Fix for Floor Support Defect-12762 -->
							<dd class="word-wrap-break-word"><label><spring:message code="serviceRequest.label.email" />:</label>${serviceRequestForm.serviceRequest.primaryContact.emailAddress}</dd>
					...
					<div id="contactInfoThirdColum" class="third-column">
						<dl>
							...
							<!-- Fix for Floor Support Defect-12762 -->
					        <dd class="word-wrap-break-word"><label><spring:message code="serviceRequest.label.email" />:</label>${serviceRequestForm.serviceRequest.secondaryContact.emailAddress}</dd>
						</dl>
					</div><!-- third-column --> 
					</c:if>
					</c:if>
			...
			<div class="portlet-wrap-inner">
				<div id="div_notificationsPrintTable">
					<div id="notificationsGrid" style="display:block;">
						<div id="div_notifications_container" class="width-100per"></div>
    ...
    <div class="portlet-wrap" class="width-50per">
    <div class="portlet-wrap rounded">
			<div class="portlet-header">
...
//     };
 	...
 	/** 
 	  ...
 	  */
 	if(${serviceRequestForm.serviceRequest.serviceActivityStatus!= null && serviceRequestForm.serviceRequestTechnicianXML!= null}){
