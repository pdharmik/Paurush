				...
				<div class="columns two">
					<div class="first-column">
						<dl>
							...
							<dd>${serviceRequestForm.serviceRequest.problemDescription}</dd>
							<!-- added for CI5 -->
							<br />
							<dt>
								<spring:message code="serviceRequest.label.resolutionCode" />
							</dt>
							<dd>${serviceRequestForm.serviceRequest.resolutionCode}</dd>
...
<!-- 						Customer Reporting Name fetched for CI BRD 14-02-04 -->
					...
					<div class="third-column">
						...
						<c:if test="${serviceRequestForm.serviceRequest.serviceAddress.addressLine1==''||serviceRequestForm.serviceRequest.serviceAddress.addressLine1==null}">
							...
							${serviceRequestForm.serviceRequest.serviceAddress.addressLine1}</dt>
			...
			<div class="status-block">
				...
				<div class="status-info" style="display:block;">
					<div class="icon" id="truckRightImage">
						<img class="ui_icon_sprite widgets inProcess-icon" src="${serviceRequestForm.serviceHost}<html:imagesPath/>transparent.png" alt="shipment"  width="50"/>
					</div><!-- icon -->
