...
<div id="FilterDetails">
			<div id="filterLocation" class="filterLocationPref">
					...
					<div id="filterCountryStateCity">
						...
						<a id="${prefixId}addRessLink" onClick="openAddressPopup()" class="cursor-pointer"><spring:message code='lbs.label.selectaddress'/></a>
						</div>
					</div>
				...
				<div id="${prefixId}customerHierarchy" class="customerHierarchyPref">
					<div class="filterHeader">
						...
						<a id="${prefixId}customerHierarchyDir" onclick="popUpChlTree()" class="cursor-pointer"><spring:message code='lbs.label.customerhierarchy'/></a><br/>
				...
				<div id="DeviceProperties">
					<ul>
						...
						<li>
							<input id="${prefixId}productModel" type="text" name="productModel" value="<spring:message code='serviceRequest.label.productModel'/>" />							
						</li>
						...
						<ul id="${prefixId}assetInstallDateDiv" style="display: inline;"><%-- Don't remove this DIV  --%>					
								...
								<img id="${prefixId}imgLocalizedBeginDateAsset" src="<html:imagesPath/>transparent.png" class="ui_icon_sprite calendar-icon cursor-pointer" />
								</li>
								...
								<img id="${prefixId}imgLocalizedEndDateAsset" src="<html:imagesPath/>transparent.png" class="ui_icon_sprite calendar-icon cursor-pointer" />
								</li>
							</ul>
						<li>
						</ul>
					...
					<ul>
						...
						<li class="width-100per">
							<ul id="${prefixId}dateRangeFilterContainer"><%-- Don't remove this DIV  --%>					
								...
								<img id="${prefixId}imgLocalizedBeginDate" src="<html:imagesPath/>transparent.png" class="ui_icon_sprite calendar-icon cursor-pointer" />
								</li>
								...
								<img id="${prefixId}imgLocalizedEndDate" src="<html:imagesPath/>transparent.png" class="ui_icon_sprite calendar-icon cursor-pointer" />
								</li>
							</ul>
						</li>
					</ul>		
	...
	<div style="display: none;" id="${prefixId}customizepop" class="customizePopup">
			...
			<script type="text/javascript" src="<html:rootPath/>js/LbsCommonFilters.js?version=0.3"></script>
			<script>
			...
			function generateHTMLforDeviceCustomize(prefix){
				...
				var finalHtml="<div class=\"popupHeader popupSubHeader\"></div><br/><table><tr>";
				var countt=0;
