...
<div id="toggleView">
	...
	<div id="toggleGridView" onClick="changeView('map');callOmnitureAction('<%=LexmarkSPOmnitureConstants.FLEETMANAGER%>','<%=LexmarkSPOmnitureConstants.MAPVIEW%>');" style="display: none;"><div id="viewText"><span id="View_viewIcon" class="ui_icon_sprite map-view-icon"></span><spring:message code='lbs.label.mapview'/></div></div>
 	<div id="toggleMapsView" onClick="changeView('grid');callOmnitureAction('<%=LexmarkSPOmnitureConstants.FLEETMANAGER%>','<%=LexmarkSPOmnitureConstants.LISTVIEW%>');" style="display: none;"><div id="viewText"><span id="View_viewIcon" class="ui_icon_sprite list_view-icon"></span><spring:message code='lbs.label.gridview'/></div></div>
</div>	
