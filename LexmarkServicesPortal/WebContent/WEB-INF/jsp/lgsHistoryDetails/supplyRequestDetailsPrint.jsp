...
<style type="text/css" >
	td,th {font-size:12px;padding:0 5px 0 5px;}
	@media print{
...
<!--[if lt IE 9]>
	<style type="text/css">
	.journal-content-article h2.step{
		padding-top:0px !important;
	}
	
	#divPrintBodyTop .portletBlock{
		clear:both;
	}
		.dhx_page{
	...
	#divPrintBodyTop .portletBlock .columnsTwo{
		width:47% !important;
	}
	#selectedAsset ul.form li label{
		margin-left:0% !important;
	}
	#divPrintBodyTop ul.form li label{
	...
	#divPrintBodyTop ul.form li span{
		width:auto !important;
	}
	#divPrintBodyBottom .columnsTwo{
		width:45% !important;
	}
	
	#divPrintBodyBottom .form{
		width:90% !important;
	}
	#divPrintBodyBottom .form li{
		padding-left:0 !important;
		width:100% !important;
	}
	#divPrintBodyBottom .form li label{
		margin-left:0 !important;
		width:200px !important;
	}
	#divPrintBodyBottom .form li span{
		width:auto !important;
	}
	</style>
<![endif]-->
