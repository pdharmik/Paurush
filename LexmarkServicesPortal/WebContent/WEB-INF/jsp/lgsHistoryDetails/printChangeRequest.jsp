...
<link rel="stylesheet" type="text/css" href="<html:rootPath/>css/in-styles.css?version=<html:fileCacheVersion/>" />
	<div id="content-wrapper-inner">
      ...
      <div id="divPrintBody"> </div>
		...
		<div>
								<a onClick="javascript:doPrint();" id="topPrintLink">
									<img src="/LexmarkServicesPortal/images/transparent.png" class="ui_icon_sprite print-icon" style="cursor:pointer" title="<spring:message code='requestInfo.link.printThisPage'/>" />
