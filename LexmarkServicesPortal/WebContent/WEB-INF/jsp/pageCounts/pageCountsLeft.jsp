...
<div class="left-nav" height="100%">
			<div class="left-nav-inner" style="overflow:hidden;">
 			<!--Below heading added for UI change-CI-7 14.02 Release-->
				 <h4 class="h2-style2"><spring:message code="meterRead.title.filters"/></h4>
					<table class="displayGrid">
            </table>
				<!-- left-nav-header -->
				<ul class="filters">
					<li><a  href="#" class="font-weight-bold" id="BookMarked" onclick="reLoadGrid('BookMarked');"><spring:message code="meterRead.label.bookmarkedDevices"/></a></li>
	...
	<div class="leftOverlay rounded shadow" >
				<div class="columnInner padding-5px-important" >
				<div class="float-right margin-right-5px">
				...
				<!--<div id="errorDiv" style="display: none;color:red;"></div>  -->
					<div id="locationTreeDiv" >
						<h4 class="margin-0px"><strong><spring:message code="requestInfo.heading.filterByLocation"/></strong></h4>													
					...
					<div id="chlTreeDiv">
						<h4 class="margin-0px"><strong><spring:message code="requestInfo.heading.filterByChl"/></strong></h4>
