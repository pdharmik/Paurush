...
<div id="pageCountWarningPage" class="div-style28">
<table width="100%">
	<tr>
		...
		<table width="100%">
			...
			<tr><td width="18%" align="center"><h4 class="text-decoration-underline"><spring:message code="meterRead.listHeader.serialNumber" /></h4></td>
				<td width="15%" align="center"><h4 class="text-decoration-underline"><spring:message code="meterRead.label.readDate" /></h4></td>
				<td width="18%" align="center"><h4 class="text-decoration-underline"><spring:message code="meterRead.label.newPageCount" /></h4></td>
				<td width="24%" align="center"><h4 class="text-decoration-underline"><spring:message code="meterRead.label.newColorPageCount" /></h4></td>
		...
		<table width="100%">
			...
			<tr>
				<td align="left"><h4 class="text-decoration-underline"><spring:message code="meterRead.label.response" /></h4></td>
			</tr>
			<tr><td align="left"><div id="warningMsgBW"></div></td></tr>
			<tr><td align="left"><div id="warningMsgcolor"></div></td></tr>
			<tr><td align="left"><div id="msgNotUpdate"></div></td></tr>
