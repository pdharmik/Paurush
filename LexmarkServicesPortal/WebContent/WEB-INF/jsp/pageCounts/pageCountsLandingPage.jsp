...
<table width="1000px">
    ...
    <div class="journal-content-article" >
     ...
     <!-- END -->
			<div class="main-wrap">
				<div class="content">
					<table width="100%" class="table-style15">
						<tr>
						...
						<tr>
							<td width="40%" class="labelBold table-td-style28"><spring:message code="pageCounts.label.importUpdatesFromAnExcelSpreadsheet"/><br></td>
							<td width="10%" class="labelBold table-td-style28">&nbsp;</td>
							<td width="40%" class="labelBold table-td-style28"><spring:message code="pageCounts.label.updateThroughOurWebInterface"/><br></td>
						</tr>
						<tr>
							<td class="table-td-style28"><spring:message code="pageCounts.label.descriptionTextForImportUpdates"/><br></td>
							<td class="labelBold table-td-style28" align="center"><spring:message code="pageCounts.label.or"/></td>
							<td class="table-td-style28"><spring:message code="pageCounts.label.descriptionTextForUtilizingTableBelow"/><br></td>
						</tr>
					...
					<div class="portlet-wrap div-style78" >
