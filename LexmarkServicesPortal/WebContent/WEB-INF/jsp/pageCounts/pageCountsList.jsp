...
.ie .gridbox .button, .ie .gridbox .button:focus {
	background: url(/LexmarkServicesPortal/images/buttonBg.jpg) #0076a3 repeat-x 0px 0px;
	border-radius: .4em;
					...
					<div class="grid-controls">
						...
						<div class="expand-min">
							<ul>
								...
								<li>
									<img src="<html:imagesPath/>transparent.png" class="ui_icon_sprite reset-icon cursor-pointer" alt="<spring:message code="serviceRequest.label.reset"/>" onclick="javascript:doReset();"  /> 
