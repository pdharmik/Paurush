	...
	<div class="content">
		...
		<spring:message code="deviceFinder.label.allDevices.filterByCHL"/></h3>
					...
					<div class="grid-controls">
						<div class="utilities">
							<ul>
								<li class="first cursor-pointer" onClick="return download('csv')" ><img src="<html:imagesPath/>transparent.png" class="ui_icon_sprite spreadsheet-icon"  title="<spring:message code='image.title.downloadCSV'/>"; /><spring:message code='rebranding.label.XLS'/></li>
								<li onClick="return download('pdf')"; class="cursor-pointer";><img src="<html:imagesPath/>transparent.png" class="ui_icon_sprite pdf-icon"  title="<spring:message code='image.title.downloadPDF'/>"; /><spring:message code='rebranding.label.PDF'/></li>
								<li onClick="return print()" class="cursor-pointer";><img src="<html:imagesPath/>transparent.png" class="ui_icon_sprite print-icon"  title="<spring:message code='requestInfo.tooltip.print'/>"; /><spring:message code='requestInfo.tooltip.print'/></li>
							</ul>
						</div><!-- utilities -->
						<div class="expand-min">
							<ul>
								...
								<li>
									<a href="#grid" id='headerImageButton'><img src="<html:imagesPath/>transparent.png" class="ui_icon_sprite customize-icon cursor-pointer"  /></a>
...
<%--Div for CI BRD 13-10-14 Defect #7768 START--%>
		<div id="limitalertbox" class="modal-dialogbox1" >
    		<div class="columnInner" id="loadingDialog"><div class="columnsTwo w50"><img src="/LexmarkServicesPortal/images/jQueryAlert/important.gif" class="green-check-img" ></img></div>
		...
		<div id="nodatafoundbox" class="modal-dialogbox1">
    		<div class="columnInner" id="loadingDialog"><div class="columnsTwo w50"><img src="/LexmarkServicesPortal/images/jQueryAlert/important.gif" class="green-check-img" ></img></div>
    		<div class="columnsTwo w70p">
...
callOmnitureAction('<%=LexmarkSPOmnitureConstants.DEVICEFINDER%>', '<%=LexmarkSPOmnitureConstants.DEVICEFINDERLISTCREATEREQUEST%>'); 
	...
	//Modified for MPS
	deviceListGrid.setColSorting("na,str,str,str,str,str,str,str,str,str,str,na,na,str,str,str,str,str,str,str,na,na,str,na,na");
