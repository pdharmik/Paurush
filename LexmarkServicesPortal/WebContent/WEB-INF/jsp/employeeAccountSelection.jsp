			...
			<!-- changed by rituparna -->
				...
				<td align="left" width="530px">
					<div id="divEmployeeAccountSelection" class="divEmployeeAccountSelection"></div>
					 <button id="btnSubmit" class="button div-style103" type="submit" onClick="return submitEmployeeForm()" ><spring:message code="button.submit"/></button>
				</td>
