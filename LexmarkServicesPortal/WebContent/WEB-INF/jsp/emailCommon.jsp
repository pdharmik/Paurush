	...
	<div id="divToAddress" width = "100%" height="250" border = "1" valign="top" >
		<table width="100%" height="100%" border="0" valign="top">
  		...
  		<tr>
    		...
    		<td width="65%">
        		<textarea id="txtToAddress" name="txtToAddress" rows="4" class="width-400px" wrap="virtual" onkeypress="getKeyCode(event);cleanStatus();" onkeyup="cleanStatus();" onpropertychange="initEmailFormat(this);" oninput="initEmailFormat(this);"  onblur="lost(this);"></textarea>
    		</td>
    		<td width="5%"></td>
  		</tr>
  		<tr>
