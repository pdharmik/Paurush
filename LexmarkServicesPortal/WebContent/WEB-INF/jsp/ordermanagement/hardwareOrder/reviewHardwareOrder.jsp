	...
	<div class="portletBlock infoBox rounded shadow">
       ...
       <!-- Parts Detail End -->
						...
						<h4><spring:message code="requestInfo.heading.orderInstructions"/></h4>
							<ul class="form">
								...
								<li>
									...
									<span class="multiLine word-break-break-all">${hardwareDetailPageForm.specialInstruction}</span>
								</li>
          ...
          <div class="columnsTwo">
				...
				<div class="portletBlock">
					<div class="wHalf displayGrid columnInnerTable rounded shadow margin-left-4px" >
