...
<!-- Parts Detail Start -->
          ...
          <c:forEach items="${hardwareDetailPageForm.bundleList}" var="hardwareBundleListDetail" varStatus="counter" begin="0">
            ...
            <tr class="<c:if test="${counter.index % 2 ne 0}">altRow</c:if>" id= "bundleRow${counter.index}">
              ...
              <td class="w200">
				...
				<div class="lineClear">
				<span class="span-style5">Qty</span><span class="spaceClear"/>${hardwareBundleListDetail.orderQuantity}</td>
	...
	<div class="portletBlock infoBox rounded shadow">
		...
		<c:if test="${sessionScope.hardwareFinalFlags['finalTaxCalcFlag'] == 'true' && sessionScope.hardwareFinalFlags['finalShowPriceFlag'] == 'true'}"> 
			...
			<div class="floatR w250 div-style63" >
		...
		<c:if test="${sessionScope.hardwareFinalFlags['finalShowPriceFlag'] == 'true' && sessionScope.hardwareFinalFlags['finalTaxCalcFlag'] == 'true'}"> 
			<div class="wFull float-left"><label class="label-style1"><spring:message code="requestInfo.label.hardwareReviewNote"/></label><span><i><spring:message code="requestInfo.message.hardwareTax"/></i></span></div>
		</c:if>
	 ...
	 <p class="inlineTitle"><spring:message code="requestInfo.heading.shippingInformation"/></p>
            		...
            		<div class="infoBox columnInner rounded shadow">
							...
							<ul class="form">
								<li>
									...
									<span id="spclInstruction" class="multiLine word-break-break-all">${hardwareDetailPageForm.specialInstruction}</span>
								</li>
          ...
          <div class="columnsOne">
			 <div class="infoBox columnInner rounded shadow">
          			...
          			<div class="columnsOne">
            			<div class="infoBox columnInner rounded shadow bgSolid">
            				<h4><spring:message code="requestInfo.heading.notes"/></h4>
            				 <p id="notes" class="multiLine">${hardwareDetailPageForm.attachmentDescription}</p>
            			</div>
            		</div>
            	</div>
				</div>
				...
				<div class="portletBlock">
					<div class="wHalf displayGrid columnInnerTable rounded shadow margin-left-4px" id="attachmentDetailsTable">
