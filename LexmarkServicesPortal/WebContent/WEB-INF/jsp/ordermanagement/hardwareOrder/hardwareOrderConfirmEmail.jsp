...
<table width="800" border="0" cellspacing="0" cellpadding="0" align="center" class="emailPrintWraper" id="emailPrintWraper">
  ...
  <tr>
    <td class="table-td-style10"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="130" height="20" class="table-td-style11">
  ...
  <tr>
    <td valign="top" class="table-td-style12">
  ...
  <tr>
    <td valign="top" class="table-td-style13" id="message"></td>
  </tr>
  <tr>
    <td valign="top"><!-- PRIMARY SECONDARY CONTACTS & ADDITIONAL INFO - START -->
      ...
      <table width="100%" border="0" cellspacing="5" cellpadding="0">
        <tr>
          <td width="50%" valign="top" class="table-td-style14"><table width="100%" border="0" cellspacing="0" cellpadding="5">
              ...
              <tr>
                ...
                <td valign="top" class="table-td-style16"> <span id="primaryCont_name"> </span></td>
              </tr>
              <tr>
                <td valign="top" class="table-td-style16"><strong><spring:message code="requestInfo.label.phoneNumber"/></strong></td>
                <td valign="top" class="table-td-style16"><span id="primaryCont_phone"> </span></td>
              </tr>
              <tr>
                <td valign="top" class="table-td-style16"><strong><spring:message code="requestInfo.label.emailAddress"/></strong></td>
                <td valign="top" class="table-td-style16"><span id="primaryCont_email"> </span></td>
              </tr>
            </table></td>
          <td rowspan="2" valign="top" class="table-td-style14"><table width="100%" border="0" cellspacing="0" cellpadding="5">
              ...
              <tr>
                ...
                <td valign="top"  class="table-td-style16"><span id="addtnlInfo_customerRefId"> </span></td>
              </tr>
              <tr>
                <td valign="top"  class="table-td-style16"><strong><spring:message code="requestInfo.label.costCentre"/></strong></td>
                <td valign="top"  class="table-td-style16"><span id="addtnlInfo_costCenter"> </span></td>
              </tr>
              <tr>
                <td valign="top"  class="table-td-style16"><strong><spring:message code="requestInfo.label.description"/></strong></td>
                <td valign="top"  class="table-td-style16"><div class="smallNotesOverflow w300" id="addtnlInfo_description"> </div></td>
              </tr>
            </table></td>
        </tr>
        <tr id="secondaryContactTR">
          <td  valign="top" class="table-td-style14"><table width="100%" border="0" cellspacing="0" cellpadding="5">
              <tr>
                <th colspan="2" align="left" class="table-td-style15"><spring:message code="requestInfo.heading.secondaryContactForThisRequest"/></th>
              </tr>
              <tr>
                <td width="100" valign="top" class="table-td-style16"><strong><spring:message code="requestInfo.label.name"/></strong></td>
                <td valign="top" class="table-td-style16"><span id="secondaryCont_name"> </span></td>
              </tr>
              <tr>
                <td valign="top" class="table-td-style16"><strong><spring:message code="requestInfo.label.phoneNumber"/></strong></td>
                <td valign="top" class="table-td-style16"><span id="secondaryCont_phone"> </span></td>
              </tr>
              <tr>
                <td valign="top" class="table-td-style16"><strong><spring:message code="requestInfo.label.emailAddress"/></strong></td>
                <td valign="top" class="table-td-style16"><span id="secondaryCont_email"> </span></td>
              </tr>
            </table></td>
        </tr>
      </table>
      ...
      <table width="100%" border="0" cellspacing="5" cellpadding="0">
        <tr>
          <td valign="top" class="table-td-style12"><strong><spring:message code="requestInfo.orderSupplies.orderDetails.heading.ItemsInyourOrder"/></strong></td>
        </tr>
      </table>
       <table width="100%" border="0" cellspacing="5" cellpadding="0" id="forEmailpreconfHeader">
        <tr>
          <td valign="top" class="table-td-style12"><strong><spring:message code="requestInfo.heading.preConfhardware"/></strong></td>
        </tr>
      </table>
     <div id="forEmailpreconf"></div>
      <table width="100%" border="0" cellspacing="5" cellpadding="0" id="forEmailaccessoriesHeader">
        <tr>
          <td valign="top" class="table-td-style12"><strong><spring:message code="requestInfo.heading.accessories"/></strong></td>
        </tr>
      </table>
     ...
     <table width="100%" border="0" cellspacing="5" cellpadding="0">
        <tr>
          <td width="50%" valign="top" class="table-td-style25">
          <table width="100%" border="0" cellspacing="0" cellpadding="5">
             <tr>
                <td valign="top" width="100" class="table-td-style16"><strong><spring:message code="requestInfo.label.partsPriceSubTotal"/></strong></td>
                <td valign="top"  class="table-td-style16"> <span>${hardwareDetailPageForm.subTotal}</span></td>
              </tr>
              <tr>
                <td valign="top" width="100" class="table-td-style16"><strong><spring:message code="requestInfo.label.partsTaxes"/></strong></td>
                <td valign="top"  class="table-td-style16"> <span>${hardwareDetailPageForm.tax}</span></td>
              </tr>
              <tr>
                <td valign="top" width="100" class="table-td-style16"><strong><spring:message code="requestInfo.label.partsTotalAmountPayable"/></strong></td>
                <td valign="top"  class="table-td-style16"> <span>${hardwareDetailPageForm.totalAmt}</span></td>
              </tr>
            </table></td>
			</table>
			<div class="wFull" style="">
			<div class="div-style66"><spring:message code="requestInfo.label.hardwareReviewNote"/></div>
			<div class="div-style67"><i><spring:message code="requestInfo.message.hardwareTax"/></i></div>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="5" id="shipToAddrTable">
              ...
              <tr>
               ...
               <tr>
                ...
                <td valign="top"  class="table-td-style16"> <span>${hardwareDetailPageForm.shipToAddress.physicalLocation1}</span></td>
              </tr>
               <tr>
                <td valign="top" width="100" class="table-td-style16"><strong><spring:message code="requestInfo.addressInfo.label.floor"/></strong></td>
                <td valign="top"  class="table-td-style16"> <span>${hardwareDetailPageForm.shipToAddress.physicalLocation2}</span></td>
              </tr>
               <tr>
                <td valign="top" width="100" class="table-td-style16"><strong><spring:message code="requestInfo.addressInfo.label.office"/></strong></td>
                <td valign="top"  class="table-td-style16"> <span>${hardwareDetailPageForm.shipToAddress.physicalLocation3}</span></td>
              </tr>
            </table></td>
          <td valign="top" class="table-td-style14"><table width="100%" border="0" cellspacing="0" cellpadding="5">
              <tr>
              ...
              <tr>
                ...
                <td valign="top"  class="table-td-style16"> <div class="smallNotesOverflow w300" id="spclInstruction"></div></td>
              </tr>
      ...
      <table width="100%" border="0" cellspacing="5" cellpadding="0">
       <tr>
          <td valign="top" class="table-td-style14"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td width="100" valign="top" class="table-td-style18"><strong><spring:message code="requestInfo.label.poNumber"/></strong></td>
                <td valign="top" class="table-td-style18"><span >${hardwareDetailPageForm.poNumber}</span></td>
              </tr>
              </c:if>
              <c:if test="${not empty hardwareDetailPageForm.creditCardEncryptedNo && hardwareDetailPageForm.creditCardEncryptedNo ne null}">
              <tr>
                <td width="100" valign="top" class="table-td-style18"><strong><spring:message code="requestInfo.label.creditCardNo"/></strong></td>
                <td valign="top" class="table-td-style18"><span >${hardwareDetailPageForm.creditCardEncryptedNo}</span></td>
              </tr>
              </c:if>
            </table></td>
        </tr>
      ...
      <table width="100%" border="0" cellspacing="5" cellpadding="0">
        <tr>
          <td valign="top" class="table-td-style12"><strong><spring:message code="requestInfo.heading.coveredService"/></strong></td>
        </tr>
      </table>
      <table width="100%" border="0" cellspacing="5" cellpadding="0">
        <tr>
          <td valign="top" class="table-td-style14"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="180px" valign="top" class="table-td-style18"><strong><spring:message code="requestInfo.label.coveredService"/></strong></td>
                <td valign="top" class="table-td-style18"><span ><c:choose><c:when test="${hardwareDetailPageForm.installationOnlyFlag eq 'true'}"><spring:message code="requestInfo.option.yes"/></c:when><c:otherwise><spring:message code="requestInfo.option.no"/></c:otherwise></c:choose></span></td>
              </tr>
            </table></td>
        </tr>
      </table>
      ...
      <table width="100%" border="0" cellspacing="5" cellpadding="0">
        <tr>
          <td width="50%" valign="top" class="table-td-style14"><table width="100%" border="0" cellspacing="0" cellpadding="5">
              ...
              <tr>
                <td valign="top" class="table-td-style16"> <div class="smallNotesOverflow w300" id="notes"></div></td>
              </tr>
            </table></td>
        </tr>
      </table>
