...
<table width="800" border="0" cellspacing="0" cellpadding="0" align="center" class="emailPrintWraper" id="emailPrintWraper">
  ...
  <tr>
    <td valign="top"><!-- PRIMARY SECONDARY CONTACTS & ADDITIONAL INFO - START -->
          ...
          <td width="50%" valign="top" class="table-td-style14"">
         	...
         	<table>
              <tr>
				...
				<th width="60" align="left" class="table-td-style15">
               ...
               <tr>
					...
					<td valign="top" class="table-td-style16">${assetPartListDetail.yield}</td>
					<td valign="top" class="table-td-style16">${assetPartListDetail.model}</td>
					<td align="right" valign="top" class="table-td-style16">${assetPartListDetail.orderQuantity}</td>
                	<c:if test="${sessionScope.accountCurrentDetails['splitterFlag'] == 'true'}">
										<c:if test="${sessionScope.catalogFinalFlags['finalShowPriceFlag'] == 'true'}">
                	<td  valign="top" class="table-td-style16">${assetPartListDetail.unitPrice}  (${catalogPartListDetail.currency})</td>
					<td  valign="top" class="table-td-style16">${assetPartListDetail.total}  (${catalogPartListDetail.currency})</td>
      ...
      <table width="100%" border="0" cellspacing="5" cellpadding="0">
      <tr><td valign="top" class="table-td-style12"><strong><spring:message code="requestInfo.heading.shippingInformation"/></strong></td></tr>
        <tr>
          <td width="50%" valign="top" class="table-td-style14">
          <table width="100%" border="0" cellspacing="0" cellpadding="5" id="shipToAddrTable">
              ...
              <tr>
                ...
                <td valign="top"  class="table-td-style16">${catalogDetailPageForm.shipToAddress.physicalLocation1} </td>
              </tr>
              <tr>
                <td valign="top" width="100" class="table-td-style16"><strong><spring:message code="requestInfo.addressInfo.label.floor"/></strong></td>
                <td valign="top"  class="table-td-style16"> ${catalogDetailPageForm.shipToAddress.physicalLocation2}</td>
              </tr>
              <tr>
                <td valign="top" width="100" class="table-td-style16"><strong><spring:message code="requestInfo.addressInfo.label.office"/></strong></td>
                <td valign="top"  class="table-td-style16">${catalogDetailPageForm.shipToAddress.physicalLocation3}</td>
              </tr>
            </table></td>
          <td valign="top" class="table-td-style14"><table width="100%" border="0" cellspacing="0" cellpadding="5">
              <tr>
              ...
              <%-- <tr>
                ...
                <td valign="top"  class="table-td-style16"><span id="defaultSpclInstruction"></span></td>
              </tr> --%>
              ...
              <tr>
                ...
                <td valign="top"  class="table-td-style16"><c:choose>
              ...
              <tr>
                <td valign="top"  class="table-td-style16"><strong><spring:message code="requestInfo.label.requestedDeliveryDate"/></strong></td>
                <td valign="top"  class="table-td-style16">${catalogDetailPageForm.requestedDeliveryDate}</td>
              </tr>
            </table></td>
        </tr>
      </table>
        ...
        <tr>
          <td valign="top" class="table-td-style14"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td valign="top" class="table-td-style18"><span id="poNumber">${ catalogDetailPageForm.poNumber}</span></td>
              </tr>
        ...
        <tr>
         <td width="50%" valign="top" class="table-td-style14">
		  ...
		  <c:if test="${catalogDetailPageForm.displayAttachmentList !=null && not empty catalogDetailPageForm.displayAttachmentList}">
              <tr>
                <th  width="220px" colspan="0" align="left" class="table-td-style15"><spring:message code="requestInfo.heading.attachmentFileName"/></th>
                <th  width="220px" colspan="0" align="left" class="table-td-style15"><spring:message code="requestInfo.heading.attachmentFileSizeKiloBytes"/></th>
              </tr>
              </c:if>
