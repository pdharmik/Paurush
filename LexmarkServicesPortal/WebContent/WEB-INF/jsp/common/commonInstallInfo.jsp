			...
			<c:choose>
				...
				<ul class="form  installCheck width-90per">
								  ...
								  <li class="move_type1"><%--Changed for CI Defect #7853 --%>
									...
									<div id="" class="move_type_confirmation div-style34" ><spring:message code="requestInfo.cm.manageAsset.label.doYouRequireLexmarkToPhysicallyMoveThisDevice"/></div>
