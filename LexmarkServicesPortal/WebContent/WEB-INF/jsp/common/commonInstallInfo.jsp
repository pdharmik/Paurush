...
<div class="columnsOne">
	<div class="infoBox columnInner rounded shadow">
			<c:choose>
				...
				<div class="portletBlock margin-left-1per">
				<ul class="form  installCheck width-90per">
								  ...
								  <li class="move_type1"><%--Changed for CI Defect #7853 --%>
									...
									<div id="" class="move_type_confirmation div-style34" ><spring:message code="requestInfo.cm.manageAsset.label.doYouRequireLexmarkToPhysicallyMoveThisDevice"/>&nbsp;<span class="req">*</span></div>
									<span class="radio radio_confirm div-style34">
										<form:radiobutton name="installAsset" path="installAssetFlag" value="Yes" 
				...
				<div class="portletBlock" class="margin-left-1per">
				<ul class="form  installCheck width-90per">
								  <div id="movetype_radio" class="">
								  <li class="move_type1"><%--Changed for CI Defect #7853 --%>
									<div style="">
			                        <%-- <label><spring:message code="requestInfo.cm.manageAsset.label.doYouRequireLexmarkToInstallThisDevice"/></label> --%>
									<div id="" class="move_type_confirmation div-style34"><spring:message code="requestInfo.cm.manageAsset.label.doYouRequireLexmarkToPhysicallyMoveThisDevice"/>&nbsp;<span class="req">*</span></div>
									<div class="radio radio_confirm div-style34">
									<div class="div-style34"><form:radiobutton name="installAsset" path="installAssetFlag" value="Yes" 
									id="installAssetYes" onclick="showHideMoveType('installAssetYes');"/>	
									<spring:message code="requestInfo.option.yes"/>
									</div>
									<div class="div-style34 margin-left-5px">
									<form:radiobutton name="installAsset" path="installAssetFlag" value="No"
									id="installAssetNo" onclick="showHideMoveType('installAssetNo');"/>
	...
	<spring:message code="requestInfo.cm.manageAsset.heading.pickupAddress"/>
		...
		<span style="display: none"> <form:input id="installAddressId"
						...
						<form:input
						id="installAddressName" path="assetDetail.installAddress.addressName" /> <form:input
	...
	<c:when test="${pageFlow eq 'fleetMgmtMove'}">
			...
			<div class="infoBox columnInner rounded shadow">
				...
				<%--For non LBS Adresses --%>
					...
					<li><label for="zone"><spring:message code='lbs.label.zone'/>: </label> <span><input type="text"
						id="zonemove"  value="" class="w100"
						 /></span></li>
						
					<li><label for="office"><spring:message
						code="requestInfo.addressInfo.label.office" /> </label> <span><input type="text"
						id="moveTophysicalLocation3" class="w100"
						 maxlength="100" /></span></li>
						</ul>
						</div>
...
var linkId;
	...
	//$("#installLevelOfDetails").val("Grid Level");
	if(curURL.indexOf('/fleet-management') != -1)
	{
