		...
		<tr>
  		...
  		<tr>
    		<td colspan="3" width="100%" height="60" align="right" valign="top">
    			 <button id="btnClose" class="button_cancel width-65px" onClick="closeEmailPopup(this);"><spring:message code='button.cancel'/></button> &nbsp; <button class="button width-65px" id="btnSendEmail" onClick="doSending();"><spring:message code='button.send'/></button>
    		</td>
  		</tr>
		</table>
</div>
