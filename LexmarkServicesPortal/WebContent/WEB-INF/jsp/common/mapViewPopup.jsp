...
<script type="text/javascript" src="/LexmarkServicesPortal/js/LbsService.js?version=3.74"></script>
			...
			autoOpen: false,
				...
				open: function(){
						 jQuery('#popupMapDiv').show();
							...
							//siebelJSON.defaultArea.floorId="26";
							...
							<%-- encryptionObj.setLBSFormPostURL("${formPost}?lang=<%=request.getLocale()%>"); --%>
							encryptionObj.setSiebelJSONString(JSON.stringify(siebelJSON,checkValue));
							//alert(encryptionObj.getEncryptionFlag());
