...
<div class="main-wrap">
	<div class="content">
        ...
        <%--Request History for Asset (CI) ENDS--%>
								...
								<!-- <div class="portletBodyWrap" > -->
							  	<div class="portletBlock infoBox rounded shadow columnsOne min-width-900px">
							  		<div class="columnsOne">
							  		<div class="columnInner">
							  		 <c:if test="${assetDetailPageForm.paymentTypes != null}">
									 <div id="paymentTypeAlert">
									 <div class="div-style68"><img src="<html:imagesPath/>attention.png" alt="alert" height="24" width="24"></div>
									 <div class="strong div-style69"><spring:message code="requestInfo.alert.enterPaymentType"/></div>
												   ...
												   <label><spring:message code="requestInfo.heading.billToAddress"/>:</label>
													<span>
														<span id="combo_zone1" name="combo_zone1"></span>
                  										...
                  										<span id="billToAddressLoading" class="treeLoading div-style61" style="display:none;"><img src="<html:imagesPath/>loading-icon.gif"/></span>
													</span>
												</li>
									</ul></div>
									</div>
								...
								<div id="modaldialogbox" class="modal-dialogbox2" >
    								<div class="columnInner" id="loadingDialog"><div class="columnsTwo w50"><img src="/LexmarkServicesPortal/images/green-check.png" class="green-check-img" ></img></div>
	 ...
	 function checkParts(Id,maxOrderQty){
		...
		if(Id.indexOf("Div") > -1){
			...
			newID = newID.substring(14, 15);
			 ...
			 if(ordQty>maxOrderQty){
				// orderQtyArr[i]=false;
				 ...
				 document.getElementById("MsgassetPartList["+newID+"].orderQuantity").style.display = 'block';
			...
			// nameElem.classList.remove("error");
			 document.getElementById("MsgassetPartList["+newID+"].orderQuantity").style.display = 'none';
			 }
