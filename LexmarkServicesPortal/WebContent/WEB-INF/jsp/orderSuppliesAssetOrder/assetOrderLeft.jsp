...
<div class="left-nav" height="100%">
	<div class="left-nav-inner" style="overflow:hidden;">
		...
		<ul class="filters">
			<li><a id= "linkViewAll" class="font-weight-bold" onClick="reloadGrid('CATEGORY', 'VIEWALL');callOmnitureAction('<%=LexmarkSPOmnitureConstants.ORDERSUPPLIESASSETLIST%>','<%=LexmarkSPOmnitureConstants.ORDERSUPPLIESALLASSETLIST%>');" href="javascript:void(0);" /><spring:message code="requestInfo.link.allAssets"/></a></li>
...
<%-- End --%>				
		...
		<div id='chlInfoDiv' style="display:none;">
				...
				<div class="div-style39"><img class="ui_icon_sprite trash-icon" src="<html:imagesPath/>transparent.png" id="deleteChlBtn" height="15" width="15" /></div>
		</div>
		...
		<div class="div-style39"><img class="ui_icon_sprite trash-icon" src="<html:imagesPath/>transparent.png" id="deleteDeviceLocBtn" height="15" width="15" /></div>
		</div>
