	...
	<div class="content">
		<div id="content-wrapper">
			...
			<div id="confirmOrderPrintWrapperTop">
              ...
              <li><a href="javascript:print();"><img src="/LexmarkServicesPortal/images/transparent.png" class="ui_icon_sprite print-icon" alt="<spring:message code="requestInfo.alt.printThisPage"/>" title="<spring:message code="requestInfo.title.printThisPage"/>"></a></li>
            </ul>
          </div>
