			 ...
			 <span style="display: none">
				...
				<div class="columnsTwo">
					<div class="infoBox columnInner rounded shadow">
						...
						<br/>
						<h4 id="changeHeader" style="display: none;"><spring:message code="changemanagement.common.heading.changeRequest"/></h4>
						<ul class="form division1">
							<li id="lbsAD" style="display: none;">
								<label>
									<span class="req">*</span><spring:message code="fleetmanagement.headers.LBSAddress"/> :
								</label> 
						...
						<div id="selectLocalAddress" style="display: none;">
							<ul class="form division1">
								<li><label for="building"><span class="req">*</span><spring:message code="changemanagement.common.label.building"/></label>
									<select id="bldng" class="bigInputs"></select><input type="text" id="building1" class="bigInputs"
									style="display: none;" /></li>
								<li><label for="floor"><span class="req">*</span><spring:message code="changemanagement.common.label.floor"/></label>
									<select id="flr" class="bigInputs"></select><input type="text" id="floor1" class="bigInputs"
									style="display: none;" /></li>
									
								<%-- <li style="display:none;"><label for="office"><spring:message code="changemanagement.common.label.office"/></label> <select id="campus"
						...
						<ul class="form division1">
							<li id="lod1" style="display: none;"><label><spring:message code="lbs.label.floorlod"/> :</label>
								<select id="lodFloor"
								class="smallSelect">
									<option value=""><spring:message code="changemanagement.common.option.select"/></option>
							...
							<li id="viewGrid" style="display: none;">
								<a href="#" id="addressGridLink"><spring:message code="fleetmanagement.headers.viewGrid"/></a>
								<div id="addressXYLblDiv">
									<label id="addressXYLbl"><spring:message code="fleetmanagement.headers.grid"/> : </label><label id="addressCoords"></label>
								</div>
							</li>
						</ul>
