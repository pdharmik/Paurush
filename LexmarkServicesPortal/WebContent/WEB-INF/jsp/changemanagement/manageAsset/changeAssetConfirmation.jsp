...
<div class="main-wrap">
 ...
 <div class="portletBlock">
		...
		<div class="portletBlock margin-left-5px">
			<ul class="installCheck list-style width-90per" >
					 <%--Changes Done for CI Defect #7853--START --%>
					  <li class="list-style">
						<span for="installAsset" class="font-weight-bold"><spring:message code="requestInfo.cm.manageAsset.label.doYouRequireLexmarkToPhysicallyMoveThisDevice"/></span>
						...
						<div id="move_type" class="move_type_confirmation width-auto float-left"><spring:message code="requestInfo.cm.manageAsset.label.moveTypeConfirm"/></div>
						<div id="" class="div-style31">${manageAssetFormForChange.moveType}</div> 
