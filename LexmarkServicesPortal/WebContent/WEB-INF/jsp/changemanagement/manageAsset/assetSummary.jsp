        ...
        <li>
          ...
          <span class="multiLine"><c:choose>
                   ...
                   <span id="addtnlDescription_add" class="span-description"> ${manageAssetForm.serviceRequest.addtnlDescription}</span>
                    ...
                    <c:when test='${typeOfRequest eq "Decomm_Asset"}'>
                    <span id="addtnlDescription_del" class="span-description">${manageAssetFormForDecommission.serviceRequest.addtnlDescription}</span>
                    </c:when>
                    </c:choose></span></li>
        <li>
...
<c:choose>
	...
	<li class="list-style width-90per" >
						<span class="font-weight-bold"><spring:message code="requestInfo.cm.manageAsset.label.doYouRequireLexmarkToPhysicallyMoveThisDevice" /></span>
                   ...
                   <%-- <c:if test="${not empty manageAssetFormForChange.moveType}">
                      ...
                      <li class="move_type1 list-style">
						<div id="move_type" class="move_type_confirmation div-style30" ><spring:message code="requestInfo.cm.manageAsset.label.moveTypeConfirm"/></div>
						<div id="installAssetFlag_change_value" class="div-style31" >${manageAssetFormForChange.moveType}</div> Changed for CI7 Defect 7853 
