...
<table width="600" border="0" cellspacing="0" cellpadding="0" align="center" class="emailPrintWraper" id="emailPrintWraper">
  ...
  <tr>
    <td class="table-td-style10"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="130" height="20" class="table-td-style11"><strong><span id="changeRequest"><spring:message code="requestInfo.cm.heading.changeRequest"/></span>&nbsp; &raquo; &nbsp;<span id="typeofpage"> </span></strong></td>
     </tr>
      </table></td>
      </tr>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="5">
             ...
             <c:if test="${typeOfFlow == 'CHL'}">
               ...
               <tr>
                ...
                <td valign="top" class="table-td-style16" id="cmSubArea1">
				</td>
              </tr>
              <tr>
             ...
             <c:if test="${typeOfFlow =='Others'}">
              ...
              <tr>
                <td width="100" valign="top" class="table-td-style16"><strong><spring:message code="requestInfo.label.area"/></strong></td>
                <td valign="top" class="table-td-style16" id="cmArea">
              ...
              <tr>
                ...
                <td valign="top" class="table-td-style16" id="cmSubArea">
