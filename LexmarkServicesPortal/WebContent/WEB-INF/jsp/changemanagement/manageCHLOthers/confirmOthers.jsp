...
function submitRequest(){
	...
	//alert(link);	
	document.getElementById('chlOthersFormId').action = link +"&forward=Others";
...
<div id="content-wrapper">
    <div class="journal-content-article">
      ...
      <h2 class="step"><spring:message code="requestInfo.cm.others.heading.others"/></h2> 
      </div>
      <!-- Added for CI7 BRD14-02-12 -->
...
<div class="main-wrap">
	<div class="content">
		...
		<!-- MAIN CONTENT BEGIN -->
          <h3 class="pageTitle"><spring:message code="requestInfo.cm.others.heading.others"/> - <spring:message code="requestInfo.heading.review"/></h3>
			  ...
			  <div class="portletBlock infoBox">			
					...
					<ul class="form wordBreak">
					  ...
					  <li>
	                    ...
	                    <c:if test="${chlOthersForm.cmSubAreaValue != '-Select-'}">
