  ...
  <div id="content-wrapper">
    ...
    <div class="main-wrap">
      <div class="content">
          ...
          <div class="error font-weight-bold" id="errorMsg" style="display:none;"></div>       
...
<form:hidden id="prevSRNumber" path="prevSRNumber"></form:hidden>
		  ...
		  <form:form id="fileUploadFormId" commandName="fileUploadForm" method="post" action="${uploadURL}" enctype="multipart/form-data" >
			...
			<nobr>
					...
					<button class="button_cancel cursor-pointer" type="button" id="btnUpload" ><spring:message code="button.attach"/></button>
				</nobr>
			...
			<iframe id="upload_target" name="upload_target" src="" style="display:none;"></iframe>
			  ...
			  <div id="uploadfiledetails" style="display: none" class="wHalf displayGrid columnInnerTable rounded shadow">
				 ...
				 <table>
		            ...
		            <tbody>
		              <tr class="odd">
		                <td class="w15"><img title="Delete" height="15" width="15" id="deleteAttachmentBtn" class="ui_icon_sprite ui-icon-closethick" src="<html:imagesPath/>transparent.png"></td>
