  ...
  <div id="content-wrapper">
    ...
    <div class="main-wrap">
      <div class="content">
		  ...
		  <div class="portletBlock clearBoth infoBox rounded shadow split">
				...
				<div class="columnInner">
                    ...
                    <ul id="inputValuesArea" class="form">
					  ...
					  <li>
                        ...
                        <span><select id="country" class="width-190px" onchange="loadStateList();"></select></span>
                      </li>
					  <li>
                        <label for="state"><spring:message code="requestInfo.addressInfo.label.region"/>
                        <span class="req">**</span>
                        </label>
                        <span><select  id="state" class="width-190px" disabled="disabled"></select>
