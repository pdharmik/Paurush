    ...
    <div class="main-wrap">
      <div class="content"> 
        ...
        <form:form id="fileUploadFormId" commandName="fileUploadForm" method="post" action="${attachDocumentAction}" enctype="multipart/form-data" >
			 ...
			 <button class="button_cancel cursor-pointer" type="button" id="btnBrowse" onclick="callOmnitureAction('<%=LexmarkSPOmnitureConstants.ASSETACCEPTANCE%>','<%=LexmarkSPOmnitureConstants.ASSETACCEPTANCEBROWSE%>');">
