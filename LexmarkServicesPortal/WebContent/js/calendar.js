...
var pathToImages = '<html:imagesPath/>';	// Relative to your HTML file
...
var selectBoxHighlightColor = '#d8d8d8'; // Highlight color of select boxes
var selectBoxRolloverBgColor = '#d8d8d8'; // Background color on drop down lists(rollover)
