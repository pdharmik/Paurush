...
public class UserInfoInterceptor extends HandlerInterceptorAdapter {
	...
	private void handleUserInforToSession(PortletRequest portletRequest)throws Exception{
		try{
			...
			logger.debug("################## PRINTING Role in UserInfoInterceptor STARTS ##########################");		
			UserDetails userDetails = (UserDetails)portletRequest.getPortletSession().getAttribute("USERDETAILS", javax.portlet.PortletSession.APPLICATION_SCOPE);
/*			logger.debug("roleList.isAccMgmtRqstShow in UserInfoInterceptor======== "+userDetails.isShowAccMgmtReq());
			...
			if(portletSession.getAttribute(LexmarkConstants.SERVICES_USER, portletSession.APPLICATION_SCOPE )!= null) {
				return;
			}
			...
			if(logger.isDebugEnabled()) {
				servicesUser = (ServicesUser)portletSession.getAttribute(LexmarkConstants.SERVICES_USER, portletSession.APPLICATION_SCOPE);
