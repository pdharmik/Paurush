...
public interface CreateLgsRequest {
	...
	CreateServiceRequestResult createChangeManagementServiceRequest(CreateServiceRequestContract contract, Map<String,String> accountDetails) throws Exception;
