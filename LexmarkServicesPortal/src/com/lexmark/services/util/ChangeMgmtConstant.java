...
public interface ChangeMgmtConstant {
	...
	String[] SUPPLYHISTORYCOLUMNS = new String[] {"expediteOrder","", "serviceRequestNumber", "serviceRequestDate",
			...
			"requestor.firstName", "requestor.lastName","requestor.emailAddress", "requestor.workPhone"};
	...
	String[] CHANGEHISTORYCOLUMNS = new String[] { "serviceRequestNumber", "serviceRequestDate",
			...
			"serviceAddress.country","serviceAddress.postalCode",
			"primaryContact.firstName","primaryContact.lastName", "primaryContact.emailAddress", "primaryContact.workPhone",
			"requestor.firstName", "requestor.lastName","requestor.emailAddress", "requestor.workPhone","coveredService"};
	//coveredService has been added for CI Defect 11270
	...
	String [] B2BREQUESTSCOLUMNS = new String[]{"serviceRequestNumber","serviceRequestDate","requestType","area","serviceRequestStatus","webOrderNumber","primaryContact.firstName","primaryContact.lastName","primaryContact.emailAddress"};
...
/*********Added for B2B Requests***********/
	 String B2B_REQUESTS = "B2B_REQUESTS";
...
/*********Added for  GRID_CREATION_IDS_FOR_HISTORY***********/
	 ...
	 String[] GRID_CREATION_IDS_FOR_HISTORY=new String[] {"allRequestHistory","changeRequestHistory","supplyRequestHistory","serviceRequestListGrid","hardwareRequestListGrid","B2BRequestListGrid"};
/*********Added for  GRIDTYPE***********/
