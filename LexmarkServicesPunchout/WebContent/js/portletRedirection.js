function getBaseURL() {
	...
	if(URLWithoutParams.indexOf("/partner-portal") != -1){
		...
		baseURL=baseURL.replace("partner-portal","global-services")
	}else{
		baseURL = URLWithoutParams.substring(0, URLWithoutParams.lastIndexOf('/global-services') + '/global-services'.length) + "/";
	}
	return baseURL;
};
