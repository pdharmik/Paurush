...
public class XmlViewServiceLocator extends org.apache.axis.client.Service implements com.siebel.analytics.web.soap.v5.XmlViewService {
    ...
    private java.lang.String XmlViewServiceSoap_address = "https://dlxkssbliapp03.lex.lexmark.com:9002/analytics/saw.dll?SoapImpl=xmlViewService";
    ...
    public com.siebel.analytics.web.soap.v5.XmlViewServiceSoap getXmlViewServiceSoap() throws javax.xml.rpc.ServiceException {
    ...
    public com.siebel.analytics.web.soap.v5.XmlViewServiceSoap getXmlViewServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.siebel.analytics.web.soap.v5.XmlViewServiceStub _stub = new com.siebel.analytics.web.soap.v5.XmlViewServiceStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.siebel.analytics.web.soap.v5.XmlViewServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.siebel.analytics.web.soap.v5.XmlViewServiceStub _stub = new com.siebel.analytics.web.soap.v5.XmlViewServiceStub(new java.net.URL(XmlViewServiceSoap_address), this);
                _stub.setPortName(getXmlViewServiceSoapWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("com.siebel.analytics.web/soap/v5", "XmlViewService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("com.siebel.analytics.web/soap/v5", "XmlViewServiceSoap"));
        }
