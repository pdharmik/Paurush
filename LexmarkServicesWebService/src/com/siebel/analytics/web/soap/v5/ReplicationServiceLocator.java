...
public class ReplicationServiceLocator extends org.apache.axis.client.Service implements com.siebel.analytics.web.soap.v5.ReplicationService {
    ...
    private java.lang.String ReplicationServiceSoap_address = "https://dlxkssbliapp03.lex.lexmark.com:9002/analytics/saw.dll?SoapImpl=replicationService";
    ...
    public com.siebel.analytics.web.soap.v5.ReplicationServiceSoap getReplicationServiceSoap() throws javax.xml.rpc.ServiceException {
    ...
    public com.siebel.analytics.web.soap.v5.ReplicationServiceSoap getReplicationServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.siebel.analytics.web.soap.v5.ReplicationServiceStub _stub = new com.siebel.analytics.web.soap.v5.ReplicationServiceStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.siebel.analytics.web.soap.v5.ReplicationServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.siebel.analytics.web.soap.v5.ReplicationServiceStub _stub = new com.siebel.analytics.web.soap.v5.ReplicationServiceStub(new java.net.URL(ReplicationServiceSoap_address), this);
                _stub.setPortName(getReplicationServiceSoapWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("com.siebel.analytics.web/soap/v5", "ReplicationService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("com.siebel.analytics.web/soap/v5", "ReplicationServiceSoap"));
        }
