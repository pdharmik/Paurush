...
public class MetadataServiceLocator extends org.apache.axis.client.Service implements com.siebel.analytics.web.soap.v5.MetadataService {
    ...
    private java.lang.String MetadataServiceSoap_address = "https://dlxkssbliapp03.lex.lexmark.com:9002/analytics/saw.dll?SoapImpl=metadataService";
    ...
    public com.siebel.analytics.web.soap.v5.MetadataServiceSoap getMetadataServiceSoap() throws javax.xml.rpc.ServiceException {
    ...
    public com.siebel.analytics.web.soap.v5.MetadataServiceSoap getMetadataServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.siebel.analytics.web.soap.v5.MetadataServiceStub _stub = new com.siebel.analytics.web.soap.v5.MetadataServiceStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.siebel.analytics.web.soap.v5.MetadataServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.siebel.analytics.web.soap.v5.MetadataServiceStub _stub = new com.siebel.analytics.web.soap.v5.MetadataServiceStub(new java.net.URL(MetadataServiceSoap_address), this);
                _stub.setPortName(getMetadataServiceSoapWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("com.siebel.analytics.web/soap/v5", "MetadataService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("com.siebel.analytics.web/soap/v5", "MetadataServiceSoap"));
        }
