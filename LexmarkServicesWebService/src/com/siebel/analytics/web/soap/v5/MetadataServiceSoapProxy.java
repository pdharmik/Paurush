...
public class MetadataServiceSoapProxy implements com.siebel.analytics.web.soap.v5.MetadataServiceSoap {
  private String _endpoint = null;
  private com.siebel.analytics.web.soap.v5.MetadataServiceSoap metadataServiceSoap = null;
  ...
  private void _initMetadataServiceSoapProxy() {
    try {
      metadataServiceSoap = (new com.siebel.analytics.web.soap.v5.MetadataServiceLocator()).getMetadataServiceSoap();
  ...
  public com.siebel.analytics.web.soap.v5.MetadataServiceSoap getMetadataServiceSoap() {
    if (metadataServiceSoap == null)
      _initMetadataServiceSoapProxy();
