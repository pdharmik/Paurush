...
public class DescribeTableResult  implements java.io.Serializable {
    private com.siebel.analytics.web.soap.v5.SATable table;

    public DescribeTableResult() {
    }

    public DescribeTableResult(
           com.siebel.analytics.web.soap.v5.SATable table) {
           this.table = table;
    }
     ...
     * @return table
     */
    public com.siebel.analytics.web.soap.v5.SATable getTable() {
        return table;
    }
     ...
     * @param table
     */
    public void setTable(com.siebel.analytics.web.soap.v5.SATable table) {
        this.table = table;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("com.siebel.analytics.web/soap/v5", ">describeTableResult"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("table");
        elemField.setXmlName(new javax.xml.namespace.QName("com.siebel.analytics.web/soap/v5", "table"));
