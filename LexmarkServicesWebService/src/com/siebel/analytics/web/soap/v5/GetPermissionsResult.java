...
public class GetPermissionsResult  implements java.io.Serializable {
    ...
    /**
     * Gets the _return value for this GetPermissionsResult.
     * 
     * @return _return
     */
    ...
    /**
     * Sets the _return value for this GetPermissionsResult.
     * 
     * @param _return
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("com.siebel.analytics.web/soap/v5", ">getPermissionsResult"));
