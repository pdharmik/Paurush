...
public class Impersonateex  implements java.io.Serializable {
    ...
    private com.siebel.analytics.web.soap.v5.SAWSessionParameters sessionparams;
    ...
    public Impersonateex(
           ...
           com.siebel.analytics.web.soap.v5.SAWSessionParameters sessionparams) {
           this.name = name;
     ...
     */
    public com.siebel.analytics.web.soap.v5.SAWSessionParameters getSessionparams() {
        return sessionparams;
    }
     ...
     * @param sessionparams
     */
    public void setSessionparams(com.siebel.analytics.web.soap.v5.SAWSessionParameters sessionparams) {
        this.sessionparams = sessionparams;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("com.siebel.analytics.web/soap/v5", ">impersonateex"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("com.siebel.analytics.web/soap/v5", "password"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("impersonateID");
        elemField.setXmlName(new javax.xml.namespace.QName("com.siebel.analytics.web/soap/v5", "impersonateID"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("sessionparams");
        elemField.setXmlName(new javax.xml.namespace.QName("com.siebel.analytics.web/soap/v5", "sessionparams"));
        elemField.setXmlType(new javax.xml.namespace.QName("com.siebel.analytics.web/soap/v5", "SAWSessionParameters"));
