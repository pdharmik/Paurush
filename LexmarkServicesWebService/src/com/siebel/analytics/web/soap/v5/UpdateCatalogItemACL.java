...
public class UpdateCatalogItemACL  implements java.io.Serializable {
    ...
    private com.siebel.analytics.web.soap.v5.UpdateCatalogItemACLParams options;
    ...
    public UpdateCatalogItemACL(
           ...
           com.siebel.analytics.web.soap.v5.UpdateCatalogItemACLParams options,
     ...
     * @return options
     */
    public com.siebel.analytics.web.soap.v5.UpdateCatalogItemACLParams getOptions() {
        return options;
    }
     ...
     * @param options
     */
    public void setOptions(com.siebel.analytics.web.soap.v5.UpdateCatalogItemACLParams options) {
        this.options = options;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("com.siebel.analytics.web/soap/v5", ">updateCatalogItemACL"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("com.siebel.analytics.web/soap/v5", "UpdateCatalogItemACLParams"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
