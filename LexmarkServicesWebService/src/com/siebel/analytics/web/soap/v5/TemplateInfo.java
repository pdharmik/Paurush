...
public class TemplateInfo  implements java.io.Serializable {
    ...
    private com.siebel.analytics.web.soap.v5.TemplateInfoInstance[] instance;
    ...
    public TemplateInfo(
           ...
           com.siebel.analytics.web.soap.v5.TemplateInfoInstance[] instance) {
     ...
     * @return instance
     */
    public com.siebel.analytics.web.soap.v5.TemplateInfoInstance[] getInstance() {
        return instance;
    }
     ...
     * @param instance
     */
    public void setInstance(com.siebel.analytics.web.soap.v5.TemplateInfoInstance[] instance) {
        this.instance = instance;
    }

    public com.siebel.analytics.web.soap.v5.TemplateInfoInstance getInstance(int i) {
        return this.instance[i];
    }

    public void setInstance(int i, com.siebel.analytics.web.soap.v5.TemplateInfoInstance _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("com.siebel.analytics.web/soap/v5", "TemplateInfo"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("templateForEach");
        elemField.setXmlName(new javax.xml.namespace.QName("com.siebel.analytics.web/soap/v5", "templateForEach"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("templateIterator");
        elemField.setXmlName(new javax.xml.namespace.QName("com.siebel.analytics.web/soap/v5", "templateIterator"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("instance");
        elemField.setXmlName(new javax.xml.namespace.QName("com.siebel.analytics.web/soap/v5", "instance"));
        elemField.setXmlType(new javax.xml.namespace.QName("com.siebel.analytics.web/soap/v5", "TemplateInfoInstance"));
