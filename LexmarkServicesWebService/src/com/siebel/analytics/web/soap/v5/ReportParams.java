...
public class ReportParams  implements java.io.Serializable {
    ...
    private com.siebel.analytics.web.soap.v5.Variable[] variables;

    private com.siebel.analytics.web.soap.v5.NameValuePair[] nameValues;

    private com.siebel.analytics.web.soap.v5.TemplateInfo[] templateInfos;
    ...
    public ReportParams(
           ...
           com.siebel.analytics.web.soap.v5.Variable[] variables,
           com.siebel.analytics.web.soap.v5.NameValuePair[] nameValues,
           com.siebel.analytics.web.soap.v5.TemplateInfo[] templateInfos) {
     ...
     * @return variables
     */
    public com.siebel.analytics.web.soap.v5.Variable[] getVariables() {
        return variables;
    }
     ...
     * @param variables
     */
    public void setVariables(com.siebel.analytics.web.soap.v5.Variable[] variables) {
        this.variables = variables;
    }

    public com.siebel.analytics.web.soap.v5.Variable getVariables(int i) {
        return this.variables[i];
    }

    public void setVariables(int i, com.siebel.analytics.web.soap.v5.Variable _value) {
     ...
     * @return nameValues
     */
    public com.siebel.analytics.web.soap.v5.NameValuePair[] getNameValues() {
        return nameValues;
    }
     ...
     * @param nameValues
     */
    public void setNameValues(com.siebel.analytics.web.soap.v5.NameValuePair[] nameValues) {
        this.nameValues = nameValues;
    }

    public com.siebel.analytics.web.soap.v5.NameValuePair getNameValues(int i) {
        return this.nameValues[i];
    }

    public void setNameValues(int i, com.siebel.analytics.web.soap.v5.NameValuePair _value) {
     ...
     */
    public com.siebel.analytics.web.soap.v5.TemplateInfo[] getTemplateInfos() {
        return templateInfos;
    }
     ...
     * @param templateInfos
     */
    public void setTemplateInfos(com.siebel.analytics.web.soap.v5.TemplateInfo[] templateInfos) {
        this.templateInfos = templateInfos;
    }

    public com.siebel.analytics.web.soap.v5.TemplateInfo getTemplateInfos(int i) {
        return this.templateInfos[i];
    }

    public void setTemplateInfos(int i, com.siebel.analytics.web.soap.v5.TemplateInfo _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("com.siebel.analytics.web/soap/v5", "ReportParams"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("filterExpressions");
        elemField.setXmlName(new javax.xml.namespace.QName("com.siebel.analytics.web/soap/v5", "filterExpressions"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("com.siebel.analytics.web/soap/v5", "variables"));
        elemField.setXmlType(new javax.xml.namespace.QName("com.siebel.analytics.web/soap/v5", "Variable"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("com.siebel.analytics.web/soap/v5", "nameValues"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("com.siebel.analytics.web/soap/v5", "templateInfos"));
        elemField.setXmlType(new javax.xml.namespace.QName("com.siebel.analytics.web/soap/v5", "TemplateInfo"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
