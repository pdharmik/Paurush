...
public class XmlViewServiceSoapProxy implements com.siebel.analytics.web.soap.v5.XmlViewServiceSoap {
  private String _endpoint = null;
  private com.siebel.analytics.web.soap.v5.XmlViewServiceSoap xmlViewServiceSoap = null;
  ...
  private void _initXmlViewServiceSoapProxy() {
    try {
      xmlViewServiceSoap = (new com.siebel.analytics.web.soap.v5.XmlViewServiceLocator()).getXmlViewServiceSoap();
  ...
  public com.siebel.analytics.web.soap.v5.XmlViewServiceSoap getXmlViewServiceSoap() {
    if (xmlViewServiceSoap == null)
      _initXmlViewServiceSoapProxy();
  ...
  public java.lang.Object getResults(com.siebel.analytics.web.soap.v5.ReportRef report, java.lang.String outputFormat, boolean encodeInString, com.siebel.analytics.web.soap.v5.ReportParams reportParams, java.lang.String sessionID) throws java.rmi.RemoteException{
    if (xmlViewServiceSoap == null)
      _initXmlViewServiceSoapProxy();
    return xmlViewServiceSoap.getResults(report, outputFormat, encodeInString, reportParams, sessionID);
  }
