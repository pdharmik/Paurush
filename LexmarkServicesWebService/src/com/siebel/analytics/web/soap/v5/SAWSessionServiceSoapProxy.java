...
public class SAWSessionServiceSoapProxy implements com.siebel.analytics.web.soap.v5.SAWSessionServiceSoap {
  private String _endpoint = null;
  private com.siebel.analytics.web.soap.v5.SAWSessionServiceSoap sAWSessionServiceSoap = null;
  ...
  private void _initSAWSessionServiceSoapProxy() {
    try {
      sAWSessionServiceSoap = (new com.siebel.analytics.web.soap.v5.SAWSessionServiceLocator()).getSAWSessionServiceSoap();
  ...
  public com.siebel.analytics.web.soap.v5.SAWSessionServiceSoap getSAWSessionServiceSoap() {
    if (sAWSessionServiceSoap == null)
      _initSAWSessionServiceSoapProxy();
