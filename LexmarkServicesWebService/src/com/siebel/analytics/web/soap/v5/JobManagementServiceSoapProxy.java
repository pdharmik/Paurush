...
public class JobManagementServiceSoapProxy implements com.siebel.analytics.web.soap.v5.JobManagementServiceSoap {
  private String _endpoint = null;
  private com.siebel.analytics.web.soap.v5.JobManagementServiceSoap jobManagementServiceSoap = null;
  ...
  private void _initJobManagementServiceSoapProxy() {
    try {
      jobManagementServiceSoap = (new com.siebel.analytics.web.soap.v5.JobManagementServiceLocator()).getJobManagementServiceSoap();
  ...
  public com.siebel.analytics.web.soap.v5.JobManagementServiceSoap getJobManagementServiceSoap() {
    if (jobManagementServiceSoap == null)
      _initJobManagementServiceSoapProxy();
