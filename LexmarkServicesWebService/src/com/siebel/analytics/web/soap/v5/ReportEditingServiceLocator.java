...
public class ReportEditingServiceLocator extends org.apache.axis.client.Service implements com.siebel.analytics.web.soap.v5.ReportEditingService {
    ...
    private java.lang.String ReportEditingServiceSoap_address = "https://dlxkssbliapp03.lex.lexmark.com:9002/analytics/saw.dll?SoapImpl=reportService";
    ...
    public com.siebel.analytics.web.soap.v5.ReportEditingServiceSoap getReportEditingServiceSoap() throws javax.xml.rpc.ServiceException {
    ...
    public com.siebel.analytics.web.soap.v5.ReportEditingServiceSoap getReportEditingServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.siebel.analytics.web.soap.v5.ReportEditingServiceStub _stub = new com.siebel.analytics.web.soap.v5.ReportEditingServiceStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.siebel.analytics.web.soap.v5.ReportEditingServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.siebel.analytics.web.soap.v5.ReportEditingServiceStub _stub = new com.siebel.analytics.web.soap.v5.ReportEditingServiceStub(new java.net.URL(ReportEditingServiceSoap_address), this);
                _stub.setPortName(getReportEditingServiceSoapWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("com.siebel.analytics.web/soap/v5", "ReportEditingService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("com.siebel.analytics.web/soap/v5", "ReportEditingServiceSoap"));
        }
