...
public class IBotServiceLocator extends org.apache.axis.client.Service implements com.siebel.analytics.web.soap.v6.IBotService {
    ...
    private java.lang.String IBotServiceSoap_address = "http://dlxkssbliapp03.lex.lexmark.com:9704/analytics/saw.dll?SoapImpl=ibotService";
    ...
    public com.siebel.analytics.web.soap.v6.IBotServiceSoap getIBotServiceSoap() throws javax.xml.rpc.ServiceException {
    ...
    public com.siebel.analytics.web.soap.v6.IBotServiceSoap getIBotServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.siebel.analytics.web.soap.v6.IBotServiceStub _stub = new com.siebel.analytics.web.soap.v6.IBotServiceStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.siebel.analytics.web.soap.v6.IBotServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.siebel.analytics.web.soap.v6.IBotServiceStub _stub = new com.siebel.analytics.web.soap.v6.IBotServiceStub(new java.net.URL(IBotServiceSoap_address), this);
                _stub.setPortName(getIBotServiceSoapWSDDServiceName());
                return _stub;
            }
        }
