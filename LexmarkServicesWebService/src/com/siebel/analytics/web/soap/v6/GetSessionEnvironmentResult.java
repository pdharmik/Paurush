...
public class GetSessionEnvironmentResult  implements java.io.Serializable {
    private com.siebel.analytics.web.soap.v6.SessionEnvironment _return;

    public GetSessionEnvironmentResult() {
    }

    public GetSessionEnvironmentResult(
           com.siebel.analytics.web.soap.v6.SessionEnvironment _return) {
     ...
     * @return _return
     */
    public com.siebel.analytics.web.soap.v6.SessionEnvironment get_return() {
        return _return;
    }
     ...
     * @param _return
     */
    public void set_return(com.siebel.analytics.web.soap.v6.SessionEnvironment _return) {
        this._return = _return;
    }
