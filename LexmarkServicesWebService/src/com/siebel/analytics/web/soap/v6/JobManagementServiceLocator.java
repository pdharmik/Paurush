...
public class JobManagementServiceLocator extends org.apache.axis.client.Service implements com.siebel.analytics.web.soap.v6.JobManagementService {
    ...
    private java.lang.String JobManagementServiceSoap_address = "http://dlxkssbliapp03.lex.lexmark.com:9704/analytics/saw.dll?SoapImpl=jobManagementService";
    ...
    public com.siebel.analytics.web.soap.v6.JobManagementServiceSoap getJobManagementServiceSoap() throws javax.xml.rpc.ServiceException {
    ...
    public com.siebel.analytics.web.soap.v6.JobManagementServiceSoap getJobManagementServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.siebel.analytics.web.soap.v6.JobManagementServiceStub _stub = new com.siebel.analytics.web.soap.v6.JobManagementServiceStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.siebel.analytics.web.soap.v6.JobManagementServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.siebel.analytics.web.soap.v6.JobManagementServiceStub _stub = new com.siebel.analytics.web.soap.v6.JobManagementServiceStub(new java.net.URL(JobManagementServiceSoap_address), this);
                _stub.setPortName(getJobManagementServiceSoapWSDDServiceName());
                return _stub;
            }
        }
