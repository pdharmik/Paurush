...
public class SASubjectArea  implements java.io.Serializable {
    ...
    private com.siebel.analytics.web.soap.v6.SATable[] tables;
    ...
    public SASubjectArea(
           ...
           com.siebel.analytics.web.soap.v6.SATable[] tables) {
           this.name = name;
     ...
     * @return tables
     */
    public com.siebel.analytics.web.soap.v6.SATable[] getTables() {
        return tables;
    }
     ...
     * @param tables
     */
    public void setTables(com.siebel.analytics.web.soap.v6.SATable[] tables) {
        this.tables = tables;
    }

    public com.siebel.analytics.web.soap.v6.SATable getTables(int i) {
        return this.tables[i];
    }

    public void setTables(int i, com.siebel.analytics.web.soap.v6.SATable _value) {
