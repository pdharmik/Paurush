...
public class ReplicationServiceSoapProxy implements com.siebel.analytics.web.soap.v6.ReplicationServiceSoap {
  private String _endpoint = null;
  private com.siebel.analytics.web.soap.v6.ReplicationServiceSoap replicationServiceSoap = null;
  ...
  private void _initReplicationServiceSoapProxy() {
    try {
      replicationServiceSoap = (new com.siebel.analytics.web.soap.v6.ReplicationServiceLocator()).getReplicationServiceSoap();
  ...
  public com.siebel.analytics.web.soap.v6.ReplicationServiceSoap getReplicationServiceSoap() {
    if (replicationServiceSoap == null)
      _initReplicationServiceSoapProxy();
