...
public class ReportParams  implements java.io.Serializable {
    ...
    private com.siebel.analytics.web.soap.v6.Variable[] variables;

    private com.siebel.analytics.web.soap.v6.NameValuePair[] nameValues;

    private com.siebel.analytics.web.soap.v6.TemplateInfo[] templateInfos;
    ...
    public ReportParams(
           ...
           com.siebel.analytics.web.soap.v6.Variable[] variables,
           com.siebel.analytics.web.soap.v6.NameValuePair[] nameValues,
           com.siebel.analytics.web.soap.v6.TemplateInfo[] templateInfos,
     ...
     * @return variables
     */
    public com.siebel.analytics.web.soap.v6.Variable[] getVariables() {
        return variables;
    }
     ...
     * @param variables
     */
    public void setVariables(com.siebel.analytics.web.soap.v6.Variable[] variables) {
        this.variables = variables;
    }

    public com.siebel.analytics.web.soap.v6.Variable getVariables(int i) {
        return this.variables[i];
    }

    public void setVariables(int i, com.siebel.analytics.web.soap.v6.Variable _value) {
     ...
     * @return nameValues
     */
    public com.siebel.analytics.web.soap.v6.NameValuePair[] getNameValues() {
        return nameValues;
    }
     ...
     * @param nameValues
     */
    public void setNameValues(com.siebel.analytics.web.soap.v6.NameValuePair[] nameValues) {
        this.nameValues = nameValues;
    }

    public com.siebel.analytics.web.soap.v6.NameValuePair getNameValues(int i) {
        return this.nameValues[i];
    }

    public void setNameValues(int i, com.siebel.analytics.web.soap.v6.NameValuePair _value) {
     ...
     */
    public com.siebel.analytics.web.soap.v6.TemplateInfo[] getTemplateInfos() {
        return templateInfos;
    }
     ...
     * @param templateInfos
     */
    public void setTemplateInfos(com.siebel.analytics.web.soap.v6.TemplateInfo[] templateInfos) {
        this.templateInfos = templateInfos;
    }

    public com.siebel.analytics.web.soap.v6.TemplateInfo getTemplateInfos(int i) {
        return this.templateInfos[i];
    }

    public void setTemplateInfos(int i, com.siebel.analytics.web.soap.v6.TemplateInfo _value) {
