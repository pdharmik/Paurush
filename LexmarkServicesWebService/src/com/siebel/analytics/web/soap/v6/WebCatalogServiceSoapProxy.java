...
public class WebCatalogServiceSoapProxy implements com.siebel.analytics.web.soap.v6.WebCatalogServiceSoap {
  private String _endpoint = null;
  private com.siebel.analytics.web.soap.v6.WebCatalogServiceSoap webCatalogServiceSoap = null;
  ...
  private void _initWebCatalogServiceSoapProxy() {
    try {
      webCatalogServiceSoap = (new com.siebel.analytics.web.soap.v6.WebCatalogServiceLocator()).getWebCatalogServiceSoap();
  ...
  public com.siebel.analytics.web.soap.v6.WebCatalogServiceSoap getWebCatalogServiceSoap() {
    if (webCatalogServiceSoap == null)
      _initWebCatalogServiceSoapProxy();
