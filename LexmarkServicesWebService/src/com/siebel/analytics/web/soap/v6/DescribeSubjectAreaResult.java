...
public class DescribeSubjectAreaResult  implements java.io.Serializable {
    private com.siebel.analytics.web.soap.v6.SASubjectArea subjectArea;

    public DescribeSubjectAreaResult() {
    }

    public DescribeSubjectAreaResult(
           com.siebel.analytics.web.soap.v6.SASubjectArea subjectArea) {
     ...
     * @return subjectArea
     */
    public com.siebel.analytics.web.soap.v6.SASubjectArea getSubjectArea() {
        return subjectArea;
    }
     ...
     * @param subjectArea
     */
    public void setSubjectArea(com.siebel.analytics.web.soap.v6.SASubjectArea subjectArea) {
        this.subjectArea = subjectArea;
    }
