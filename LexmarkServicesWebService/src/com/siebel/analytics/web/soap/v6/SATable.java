...
public class SATable  implements java.io.Serializable {
    ...
    private com.siebel.analytics.web.soap.v6.SAColumn[] columns;
    ...
    public SATable(
           ...
           com.siebel.analytics.web.soap.v6.SAColumn[] columns) {
           this.name = name;
     ...
     * @return columns
     */
    public com.siebel.analytics.web.soap.v6.SAColumn[] getColumns() {
        return columns;
    }
     ...
     * @param columns
     */
    public void setColumns(com.siebel.analytics.web.soap.v6.SAColumn[] columns) {
        this.columns = columns;
    }

    public com.siebel.analytics.web.soap.v6.SAColumn getColumns(int i) {
        return this.columns[i];
    }

    public void setColumns(int i, com.siebel.analytics.web.soap.v6.SAColumn _value) {
