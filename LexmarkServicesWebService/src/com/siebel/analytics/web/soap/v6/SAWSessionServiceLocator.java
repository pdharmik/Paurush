...
public class SAWSessionServiceLocator extends org.apache.axis.client.Service implements com.siebel.analytics.web.soap.v6.SAWSessionService {
    ...
    private java.lang.String SAWSessionServiceSoap_address = "http://dlxkssbliapp03.lex.lexmark.com:9704/analytics/saw.dll?SoapImpl=nQSessionService";
    ...
    public com.siebel.analytics.web.soap.v6.SAWSessionServiceSoap getSAWSessionServiceSoap() throws javax.xml.rpc.ServiceException {
    ...
    public com.siebel.analytics.web.soap.v6.SAWSessionServiceSoap getSAWSessionServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.siebel.analytics.web.soap.v6.SAWSessionServiceStub _stub = new com.siebel.analytics.web.soap.v6.SAWSessionServiceStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.siebel.analytics.web.soap.v6.SAWSessionServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.siebel.analytics.web.soap.v6.SAWSessionServiceStub _stub = new com.siebel.analytics.web.soap.v6.SAWSessionServiceStub(new java.net.URL(SAWSessionServiceSoap_address), this);
                _stub.setPortName(getSAWSessionServiceSoapWSDDServiceName());
                return _stub;
            }
        }
