...
public class SecurityServiceLocator extends org.apache.axis.client.Service implements com.siebel.analytics.web.soap.v6.SecurityService {
    ...
    private java.lang.String SecurityServiceSoap_address = "http://dlxkssbliapp03.lex.lexmark.com:9704/analytics/saw.dll?SoapImpl=securityService";
    ...
    public com.siebel.analytics.web.soap.v6.SecurityServiceSoap getSecurityServiceSoap() throws javax.xml.rpc.ServiceException {
    ...
    public com.siebel.analytics.web.soap.v6.SecurityServiceSoap getSecurityServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.siebel.analytics.web.soap.v6.SecurityServiceStub _stub = new com.siebel.analytics.web.soap.v6.SecurityServiceStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.siebel.analytics.web.soap.v6.SecurityServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.siebel.analytics.web.soap.v6.SecurityServiceStub _stub = new com.siebel.analytics.web.soap.v6.SecurityServiceStub(new java.net.URL(SecurityServiceSoap_address), this);
                _stub.setPortName(getSecurityServiceSoapWSDDServiceName());
                return _stub;
            }
        }
