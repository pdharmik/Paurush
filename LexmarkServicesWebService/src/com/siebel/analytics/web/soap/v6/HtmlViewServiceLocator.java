...
public class HtmlViewServiceLocator extends org.apache.axis.client.Service implements com.siebel.analytics.web.soap.v6.HtmlViewService {
    ...
    private java.lang.String HtmlViewService_address = "http://dlxkssbliapp03.lex.lexmark.com:9704/analytics/saw.dll?SoapImpl=htmlViewService";
    ...
    public com.siebel.analytics.web.soap.v6.HtmlViewServiceSoap getHtmlViewService() throws javax.xml.rpc.ServiceException {
    ...
    public com.siebel.analytics.web.soap.v6.HtmlViewServiceSoap getHtmlViewService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.siebel.analytics.web.soap.v6.HtmlViewServiceStub _stub = new com.siebel.analytics.web.soap.v6.HtmlViewServiceStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.siebel.analytics.web.soap.v6.HtmlViewServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.siebel.analytics.web.soap.v6.HtmlViewServiceStub _stub = new com.siebel.analytics.web.soap.v6.HtmlViewServiceStub(new java.net.URL(HtmlViewService_address), this);
                _stub.setPortName(getHtmlViewServiceWSDDServiceName());
                return _stub;
            }
        }
