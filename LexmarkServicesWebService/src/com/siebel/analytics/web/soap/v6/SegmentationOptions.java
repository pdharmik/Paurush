...
public class SegmentationOptions  implements java.io.Serializable {
    ...
    private com.siebel.analytics.web.soap.v6.OverrideType countOverride;

    private com.siebel.analytics.web.soap.v6.OverrideType cacheOverride;

    private java.math.BigDecimal samplingFactor;

    private com.siebel.analytics.web.soap.v6.NameValuePair[] govRules;

    private com.siebel.analytics.web.soap.v6.NameValuePair[] prompts;
    ...
    public SegmentationOptions(
           ...
           com.siebel.analytics.web.soap.v6.OverrideType countOverride,
           com.siebel.analytics.web.soap.v6.OverrideType cacheOverride,
           java.math.BigDecimal samplingFactor,
           com.siebel.analytics.web.soap.v6.NameValuePair[] govRules,
           com.siebel.analytics.web.soap.v6.NameValuePair[] prompts) {
     ...
     */
    public com.siebel.analytics.web.soap.v6.OverrideType getCountOverride() {
        return countOverride;
    }
     ...
     * @param countOverride
     */
    public void setCountOverride(com.siebel.analytics.web.soap.v6.OverrideType countOverride) {
        this.countOverride = countOverride;
    }
     ...
     */
    public com.siebel.analytics.web.soap.v6.OverrideType getCacheOverride() {
        return cacheOverride;
    }
     ...
     * @param cacheOverride
     */
    public void setCacheOverride(com.siebel.analytics.web.soap.v6.OverrideType cacheOverride) {
        this.cacheOverride = cacheOverride;
    }
     ...
     * @return govRules
     */
    public com.siebel.analytics.web.soap.v6.NameValuePair[] getGovRules() {
        return govRules;
    }
     ...
     * @param govRules
     */
    public void setGovRules(com.siebel.analytics.web.soap.v6.NameValuePair[] govRules) {
        this.govRules = govRules;
    }

    public com.siebel.analytics.web.soap.v6.NameValuePair getGovRules(int i) {
        return this.govRules[i];
    }

    public void setGovRules(int i, com.siebel.analytics.web.soap.v6.NameValuePair _value) {
     ...
     * @return prompts
     */
    public com.siebel.analytics.web.soap.v6.NameValuePair[] getPrompts() {
        return prompts;
    }
     ...
     * @param prompts
     */
    public void setPrompts(com.siebel.analytics.web.soap.v6.NameValuePair[] prompts) {
        this.prompts = prompts;
    }

    public com.siebel.analytics.web.soap.v6.NameValuePair getPrompts(int i) {
        return this.prompts[i];
    }

    public void setPrompts(int i, com.siebel.analytics.web.soap.v6.NameValuePair _value) {
