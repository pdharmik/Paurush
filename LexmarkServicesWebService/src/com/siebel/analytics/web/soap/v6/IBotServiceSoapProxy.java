...
public class IBotServiceSoapProxy implements com.siebel.analytics.web.soap.v6.IBotServiceSoap {
  private String _endpoint = null;
  private com.siebel.analytics.web.soap.v6.IBotServiceSoap iBotServiceSoap = null;
  ...
  private void _initIBotServiceSoapProxy() {
    try {
      iBotServiceSoap = (new com.siebel.analytics.web.soap.v6.IBotServiceLocator()).getIBotServiceSoap();
  ...
  public com.siebel.analytics.web.soap.v6.IBotServiceSoap getIBotServiceSoap() {
    if (iBotServiceSoap == null)
      _initIBotServiceSoapProxy();
