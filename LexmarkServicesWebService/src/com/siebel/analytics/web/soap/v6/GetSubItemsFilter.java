...
public class GetSubItemsFilter  implements java.io.Serializable {
    private com.siebel.analytics.web.soap.v6.NameValuePair[] itemInfoFilters;
    ...
    public GetSubItemsFilter(
           com.siebel.analytics.web.soap.v6.NameValuePair[] itemInfoFilters,
     ...
     */
    public com.siebel.analytics.web.soap.v6.NameValuePair[] getItemInfoFilters() {
        return itemInfoFilters;
    }
     ...
     */
    public void setItemInfoFilters(com.siebel.analytics.web.soap.v6.NameValuePair[] itemInfoFilters) {
        this.itemInfoFilters = itemInfoFilters;
    }

    public com.siebel.analytics.web.soap.v6.NameValuePair getItemInfoFilters(int i) {
        return this.itemInfoFilters[i];
    }

    public void setItemInfoFilters(int i, com.siebel.analytics.web.soap.v6.NameValuePair _value) {
