...
public class ConditionServiceSoapProxy implements com.siebel.analytics.web.soap.v6.ConditionServiceSoap {
  private String _endpoint = null;
  private com.siebel.analytics.web.soap.v6.ConditionServiceSoap conditionServiceSoap = null;
  ...
  private void _initConditionServiceSoapProxy() {
    try {
      conditionServiceSoap = (new com.siebel.analytics.web.soap.v6.ConditionServiceLocator()).getConditionServiceSoap();
  ...
  public com.siebel.analytics.web.soap.v6.ConditionServiceSoap getConditionServiceSoap() {
    if (conditionServiceSoap == null)
      _initConditionServiceSoapProxy();
