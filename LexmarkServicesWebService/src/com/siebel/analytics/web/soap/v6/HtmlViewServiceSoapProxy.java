...
public class HtmlViewServiceSoapProxy implements com.siebel.analytics.web.soap.v6.HtmlViewServiceSoap {
  private String _endpoint = null;
  private com.siebel.analytics.web.soap.v6.HtmlViewServiceSoap htmlViewServiceSoap = null;
  ...
  private void _initHtmlViewServiceSoapProxy() {
    try {
      htmlViewServiceSoap = (new com.siebel.analytics.web.soap.v6.HtmlViewServiceLocator()).getHtmlViewService();
  ...
  public com.siebel.analytics.web.soap.v6.HtmlViewServiceSoap getHtmlViewServiceSoap() {
    if (htmlViewServiceSoap == null)
      _initHtmlViewServiceSoapProxy();
