...
public class ConditionServiceLocator extends org.apache.axis.client.Service implements com.siebel.analytics.web.soap.v6.ConditionService {
    ...
    private java.lang.String ConditionServiceSoap_address = "http://dlxkssbliapp03.lex.lexmark.com:9704/analytics/saw.dll?SoapImpl=conditionService";
    ...
    public com.siebel.analytics.web.soap.v6.ConditionServiceSoap getConditionServiceSoap() throws javax.xml.rpc.ServiceException {
    ...
    public com.siebel.analytics.web.soap.v6.ConditionServiceSoap getConditionServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.siebel.analytics.web.soap.v6.ConditionServiceStub _stub = new com.siebel.analytics.web.soap.v6.ConditionServiceStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.siebel.analytics.web.soap.v6.ConditionServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.siebel.analytics.web.soap.v6.ConditionServiceStub _stub = new com.siebel.analytics.web.soap.v6.ConditionServiceStub(new java.net.URL(ConditionServiceSoap_address), this);
                _stub.setPortName(getConditionServiceSoapWSDDServiceName());
                return _stub;
            }
        }
