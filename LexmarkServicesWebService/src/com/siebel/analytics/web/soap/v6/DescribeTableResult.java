...
public class DescribeTableResult  implements java.io.Serializable {
    private com.siebel.analytics.web.soap.v6.SATable table;

    public DescribeTableResult() {
    }

    public DescribeTableResult(
           com.siebel.analytics.web.soap.v6.SATable table) {
           this.table = table;
    }
     ...
     * @return table
     */
    public com.siebel.analytics.web.soap.v6.SATable getTable() {
        return table;
    }
     ...
     * @param table
     */
    public void setTable(com.siebel.analytics.web.soap.v6.SATable table) {
        this.table = table;
    }
