...
public class ACL  implements java.io.Serializable {
    ...
    private com.siebel.analytics.web.soap.v6.AccessControlToken[] accessControlTokens;
    ...
    public ACL(
           ...
           com.siebel.analytics.web.soap.v6.AccessControlToken[] accessControlTokens) {
           this.dummy = dummy;
     ...
     */
    public com.siebel.analytics.web.soap.v6.AccessControlToken[] getAccessControlTokens() {
        return accessControlTokens;
    }
     ...
     */
    public void setAccessControlTokens(com.siebel.analytics.web.soap.v6.AccessControlToken[] accessControlTokens) {
        this.accessControlTokens = accessControlTokens;
    }

    public com.siebel.analytics.web.soap.v6.AccessControlToken getAccessControlTokens(int i) {
        return this.accessControlTokens[i];
    }

    public void setAccessControlTokens(int i, com.siebel.analytics.web.soap.v6.AccessControlToken _value) {
