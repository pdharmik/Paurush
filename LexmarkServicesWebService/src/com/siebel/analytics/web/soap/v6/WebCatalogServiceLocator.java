...
public class WebCatalogServiceLocator extends org.apache.axis.client.Service implements com.siebel.analytics.web.soap.v6.WebCatalogService {
    ...
    private java.lang.String WebCatalogServiceSoap_address = "http://dlxkssbliapp03.lex.lexmark.com:9704/analytics/saw.dll?SoapImpl=webCatalogService";
    ...
    public com.siebel.analytics.web.soap.v6.WebCatalogServiceSoap getWebCatalogServiceSoap() throws javax.xml.rpc.ServiceException {
    ...
    public com.siebel.analytics.web.soap.v6.WebCatalogServiceSoap getWebCatalogServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.siebel.analytics.web.soap.v6.WebCatalogServiceStub _stub = new com.siebel.analytics.web.soap.v6.WebCatalogServiceStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.siebel.analytics.web.soap.v6.WebCatalogServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.siebel.analytics.web.soap.v6.WebCatalogServiceStub _stub = new com.siebel.analytics.web.soap.v6.WebCatalogServiceStub(new java.net.URL(WebCatalogServiceSoap_address), this);
                _stub.setPortName(getWebCatalogServiceSoapWSDDServiceName());
                return _stub;
            }
        }
