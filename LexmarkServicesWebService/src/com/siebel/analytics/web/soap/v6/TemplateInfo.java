...
public class TemplateInfo  implements java.io.Serializable {
    ...
    private com.siebel.analytics.web.soap.v6.TemplateInfoInstance[] instance;
    ...
    public TemplateInfo(
           ...
           com.siebel.analytics.web.soap.v6.TemplateInfoInstance[] instance) {
     ...
     * @return instance
     */
    public com.siebel.analytics.web.soap.v6.TemplateInfoInstance[] getInstance() {
        return instance;
    }
     ...
     * @param instance
     */
    public void setInstance(com.siebel.analytics.web.soap.v6.TemplateInfoInstance[] instance) {
        this.instance = instance;
    }

    public com.siebel.analytics.web.soap.v6.TemplateInfoInstance getInstance(int i) {
        return this.instance[i];
    }

    public void setInstance(int i, com.siebel.analytics.web.soap.v6.TemplateInfoInstance _value) {
