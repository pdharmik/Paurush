...
public class LXKCustomerContact_webServices_provider_processCustomerContactWS_BinderStub extends org.apache.axis.client.Stub implements com.lexmark.webServices.processCustomerContact.client.ProcessCustomerContactWS_PortType {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setReturnClass(com.lexmark.webServices.processCustomerContact.client.PublishContactsResponse.class);
    ...
    public LXKCustomerContact_webServices_provider_processCustomerContactWS_BinderStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            cls = com.lexmark.webServices.processCustomerContact.client.Americas.class;
            ...
            cachedSerQNames.add(qName);
            cls = com.lexmark.webServices.processCustomerContact.client.APG.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(enumsf);
            cachedDeserFactories.add(enumdf);

            qName = new javax.xml.namespace.QName("http://dlxkswmis1.lex.lexmark.com/LXKCustomerContact/webServices/provider/processCustomerContactWS", "ArrayOfbyte");
            cachedSerQNames.add(qName);
            cls = byte[].class;
            cachedSerClasses.add(cls);
            qName = new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "byte");
            qName2 = new javax.xml.namespace.QName("", "ArrayOfbyteItem");
            ...
            cachedSerQNames.add(qName);
            cls = com.lexmark.webServices.processCustomerContact.client.Roles[].class;
            cachedSerClasses.add(cls);
            ...
            qName = new javax.xml.namespace.QName("http://dlxkswmis1.lex.lexmark.com/LXKCustomerContact/webServices/provider/processCustomerContactWS", "ArrayOfroute");
            cachedSerQNames.add(qName);
            cls = com.lexmark.webServices.processCustomerContact.client.Route[].class;
            cachedSerClasses.add(cls);
            qName = new javax.xml.namespace.QName("http://dlxkswmis1.lex.lexmark.com/LXKCustomerContact/webServices/provider/processCustomerContactWS", "route");
            qName2 = new javax.xml.namespace.QName("", "ArrayOfrouteItem");
            cachedSerFactories.add(new org.apache.axis.encoding.ser.ArraySerializerFactory(qName, qName2));
            cachedDeserFactories.add(new org.apache.axis.encoding.ser.ArrayDeserializerFactory());

            qName = new javax.xml.namespace.QName("http://dlxkswmis1.lex.lexmark.com/LXKCustomerContact/webServices/provider/processCustomerContactWS", "ArrayOfshort");
            cachedSerQNames.add(qName);
            cls = short[].class;
            cachedSerClasses.add(cls);
            qName = new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "short");
            qName2 = new javax.xml.namespace.QName("", "ArrayOfshortItem");
            cachedSerFactories.add(new org.apache.axis.encoding.ser.ArraySerializerFactory(qName, qName2));
            cachedDeserFactories.add(new org.apache.axis.encoding.ser.ArrayDeserializerFactory());
            ...
            cachedSerQNames.add(qName);
            cls = com.lexmark.webServices.processCustomerContact.client.CustomerContact.class;
            cachedSerClasses.add(cls);
            ...
            cachedSerQNames.add(qName);
            cls = com.lexmark.webServices.processCustomerContact.client.CustomerContact2.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = com.lexmark.webServices.processCustomerContact.client.Data.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = com.lexmark.webServices.processCustomerContact.client.DocumentMetaData.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = com.lexmark.webServices.processCustomerContact.client.EMEA.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(enumsf);
            cachedDeserFactories.add(enumdf);

            qName = new javax.xml.namespace.QName("http://dlxkswmis1.lex.lexmark.com/LXKCustomerContact/webServices/provider/processCustomerContactWS", "envelope");
            cachedSerQNames.add(qName);
            cls = com.lexmark.webServices.processCustomerContact.client.Envelope.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = com.lexmark.webServices.processCustomerContact.client.IntegrationFrequency.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(enumsf);
            cachedDeserFactories.add(enumdf);
            ...
            cachedSerQNames.add(qName);
            cls = com.lexmark.webServices.processCustomerContact.client.LargeDocumentHandling.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = com.lexmark.webServices.processCustomerContact.client.ObjectChangeActionType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(enumsf);
            cachedDeserFactories.add(enumdf);
            ...
            cachedSerQNames.add(qName);
            cls = com.lexmark.webServices.processCustomerContact.client.PhysicalAddress.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = com.lexmark.webServices.processCustomerContact.client.PublishContacts.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = com.lexmark.webServices.processCustomerContact.client.PublishContactsResponse.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = com.lexmark.webServices.processCustomerContact.client.RelevantGeographies.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = com.lexmark.webServices.processCustomerContact.client.StorageType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(enumsf);
            cachedDeserFactories.add(enumdf);
            ...
            cachedSerQNames.add(qName);
            cls = com.lexmark.webServices.processCustomerContact.client.TradingPartnerMetaData.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {parameters});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (com.lexmark.webServices.processCustomerContact.client.PublishContactsResponse) _resp;
            } catch (java.lang.Exception _exception) {
                return (com.lexmark.webServices.processCustomerContact.client.PublishContactsResponse) org.apache.axis.utils.JavaUtils.convert(_resp, com.lexmark.webServices.processCustomerContact.client.PublishContactsResponse.class);
            }
        }
