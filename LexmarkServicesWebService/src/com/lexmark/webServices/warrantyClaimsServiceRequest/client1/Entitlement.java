...
public class Entitlement  implements java.io.Serializable {
    ...
    private com.lexmark.webServices.warrantyClaimsServiceRequest.client1.EntitlementServiceDetails entitlementServiceDetails;
    ...
    public Entitlement(
           ...
           com.lexmark.webServices.warrantyClaimsServiceRequest.client1.EntitlementServiceDetails entitlementServiceDetails) {
     ...
     */
    public com.lexmark.webServices.warrantyClaimsServiceRequest.client1.EntitlementServiceDetails getEntitlementServiceDetails() {
        return entitlementServiceDetails;
    }
     ...
     */
    public void setEntitlementServiceDetails(com.lexmark.webServices.warrantyClaimsServiceRequest.client1.EntitlementServiceDetails entitlementServiceDetails) {
        this.entitlementServiceDetails = entitlementServiceDetails;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://dlxkswmis1.lex.lexmark.com/ServiceRequest/warrantyClaimsServiceRequestWS", "Entitlement"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://dlxkswmis1.lex.lexmark.com/ServiceRequest/warrantyClaimsServiceRequestWS", "EntitlementServiceDetails"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
