...
public class LargeDocumentHandling  implements java.io.Serializable {
    private com.lexmark.webServices.processCustomerContactCM.StorageType storageType;

    public LargeDocumentHandling() {
    }

    public LargeDocumentHandling(
           com.lexmark.webServices.processCustomerContactCM.StorageType storageType) {
     ...
     * @return storageType
     */
    public com.lexmark.webServices.processCustomerContactCM.StorageType getStorageType() {
        return storageType;
    }
     ...
     * @param storageType
     */
    public void setStorageType(com.lexmark.webServices.processCustomerContactCM.StorageType storageType) {
        this.storageType = storageType;
    }
