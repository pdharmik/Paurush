...
public class RelevantGeographies  implements java.io.Serializable {
    private com.lexmark.webServices.processCustomerContactCM.Americas americas;

    private com.lexmark.webServices.processCustomerContactCM.EMEA EMEA;

    private com.lexmark.webServices.processCustomerContactCM.APG APG;

    public RelevantGeographies() {
    }

    public RelevantGeographies(
           com.lexmark.webServices.processCustomerContactCM.Americas americas,
           com.lexmark.webServices.processCustomerContactCM.EMEA EMEA,
           com.lexmark.webServices.processCustomerContactCM.APG APG) {
     ...
     * @return americas
     */
    public com.lexmark.webServices.processCustomerContactCM.Americas getAmericas() {
        return americas;
    }
     ...
     * @param americas
     */
    public void setAmericas(com.lexmark.webServices.processCustomerContactCM.Americas americas) {
        this.americas = americas;
    }
     ...
     * @return EMEA
     */
    public com.lexmark.webServices.processCustomerContactCM.EMEA getEMEA() {
        return EMEA;
    }
     ...
     * @param EMEA
     */
    public void setEMEA(com.lexmark.webServices.processCustomerContactCM.EMEA EMEA) {
        this.EMEA = EMEA;
    }
     ...
     * @return APG
     */
    public com.lexmark.webServices.processCustomerContactCM.APG getAPG() {
        return APG;
    }
     ...
     * @param APG
     */
    public void setAPG(com.lexmark.webServices.processCustomerContactCM.APG APG) {
        this.APG = APG;
    }
