...
public class AddressWSInput  implements java.io.Serializable {
    private com.lexmark.SiebelShared.createServiceRequest.client.DocumentMetaData2 documentMetaData;

    private com.lexmark.SiebelShared.createServiceRequest.client.AddressData addressData;

    public AddressWSInput() {
    }

    public AddressWSInput(
           com.lexmark.SiebelShared.createServiceRequest.client.DocumentMetaData2 documentMetaData,
           com.lexmark.SiebelShared.createServiceRequest.client.AddressData addressData) {
     ...
     */
    public com.lexmark.SiebelShared.createServiceRequest.client.DocumentMetaData2 getDocumentMetaData() {
        return documentMetaData;
    }
     ...
     */
    public void setDocumentMetaData(com.lexmark.SiebelShared.createServiceRequest.client.DocumentMetaData2 documentMetaData) {
        this.documentMetaData = documentMetaData;
    }
     ...
     * @return addressData
     */
    public com.lexmark.SiebelShared.createServiceRequest.client.AddressData getAddressData() {
        return addressData;
    }
     ...
     * @param addressData
     */
    public void setAddressData(com.lexmark.SiebelShared.createServiceRequest.client.AddressData addressData) {
        this.addressData = addressData;
    }
