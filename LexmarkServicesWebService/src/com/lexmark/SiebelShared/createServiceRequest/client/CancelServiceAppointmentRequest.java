...
public class CancelServiceAppointmentRequest  implements java.io.Serializable {
    private com.lexmark.SiebelShared.createServiceRequest.client.CancelServiceAppointmentRequestListWSInput cancelServiceAppointmentRequestListWSInput;

    public CancelServiceAppointmentRequest() {
    }

    public CancelServiceAppointmentRequest(
           com.lexmark.SiebelShared.createServiceRequest.client.CancelServiceAppointmentRequestListWSInput cancelServiceAppointmentRequestListWSInput) {
     ...
     */
    public com.lexmark.SiebelShared.createServiceRequest.client.CancelServiceAppointmentRequestListWSInput getCancelServiceAppointmentRequestListWSInput() {
        return cancelServiceAppointmentRequestListWSInput;
    }
     ...
     */
    public void setCancelServiceAppointmentRequestListWSInput(com.lexmark.SiebelShared.createServiceRequest.client.CancelServiceAppointmentRequestListWSInput cancelServiceAppointmentRequestListWSInput) {
        this.cancelServiceAppointmentRequestListWSInput = cancelServiceAppointmentRequestListWSInput;
    }
