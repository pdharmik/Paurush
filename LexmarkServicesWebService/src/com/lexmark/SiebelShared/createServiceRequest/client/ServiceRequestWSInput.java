...
public class ServiceRequestWSInput  implements java.io.Serializable {
    ...
    private com.lexmark.SiebelShared.createServiceRequest.client.ServiceRequestData3 serviceRequestData;
    ...
    public ServiceRequestWSInput(
           ...
           com.lexmark.SiebelShared.createServiceRequest.client.ServiceRequestData3 serviceRequestData) {
     ...
     */
    public com.lexmark.SiebelShared.createServiceRequest.client.ServiceRequestData3 getServiceRequestData() {
        return serviceRequestData;
    }
     ...
     */
    public void setServiceRequestData(com.lexmark.SiebelShared.createServiceRequest.client.ServiceRequestData3 serviceRequestData) {
        this.serviceRequestData = serviceRequestData;
    }
