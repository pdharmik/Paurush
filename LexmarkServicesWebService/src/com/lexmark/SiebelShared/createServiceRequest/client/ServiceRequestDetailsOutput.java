...
public class ServiceRequestDetailsOutput  implements java.io.Serializable {
    private com.lexmark.SiebelShared.createServiceRequest.client.ServiceRequestWSOutput serviceRequestWSOutput;

    public ServiceRequestDetailsOutput() {
    }

    public ServiceRequestDetailsOutput(
           com.lexmark.SiebelShared.createServiceRequest.client.ServiceRequestWSOutput serviceRequestWSOutput) {
     ...
     */
    public com.lexmark.SiebelShared.createServiceRequest.client.ServiceRequestWSOutput getServiceRequestWSOutput() {
        return serviceRequestWSOutput;
    }
     ...
     */
    public void setServiceRequestWSOutput(com.lexmark.SiebelShared.createServiceRequest.client.ServiceRequestWSOutput serviceRequestWSOutput) {
        this.serviceRequestWSOutput = serviceRequestWSOutput;
    }
