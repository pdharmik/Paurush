...
public class AddressCleanseWSInput  implements java.io.Serializable {
    private com.lexmark.SiebelShared.createServiceRequest.client.AddressWSInput addressWSInput;

    public AddressCleanseWSInput() {
    }

    public AddressCleanseWSInput(
           com.lexmark.SiebelShared.createServiceRequest.client.AddressWSInput addressWSInput) {
     ...
     */
    public com.lexmark.SiebelShared.createServiceRequest.client.AddressWSInput getAddressWSInput() {
        return addressWSInput;
    }
     ...
     */
    public void setAddressWSInput(com.lexmark.SiebelShared.createServiceRequest.client.AddressWSInput addressWSInput) {
        this.addressWSInput = addressWSInput;
    }
