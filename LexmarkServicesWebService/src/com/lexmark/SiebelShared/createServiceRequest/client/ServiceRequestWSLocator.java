...
public class ServiceRequestWSLocator extends org.apache.axis.client.Service implements com.lexmark.SiebelShared.createServiceRequest.client.ServiceRequestWS {
    ...
    public com.lexmark.SiebelShared.createServiceRequest.client.ServiceRequestWS_PortType getServiceRequest_serviceRequestWS_Port() throws javax.xml.rpc.ServiceException {
    ...
    public com.lexmark.SiebelShared.createServiceRequest.client.ServiceRequestWS_PortType getServiceRequest_serviceRequestWS_Port(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.lexmark.SiebelShared.createServiceRequest.client.ServiceRequest_serviceRequestWS_BinderStub _stub = new com.lexmark.SiebelShared.createServiceRequest.client.ServiceRequest_serviceRequestWS_BinderStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.lexmark.SiebelShared.createServiceRequest.client.ServiceRequestWS_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.lexmark.SiebelShared.createServiceRequest.client.ServiceRequest_serviceRequestWS_BinderStub _stub = new com.lexmark.SiebelShared.createServiceRequest.client.ServiceRequest_serviceRequestWS_BinderStub(new java.net.URL(ServiceRequest_serviceRequestWS_Port_address), this);
                _stub.setPortName(getServiceRequest_serviceRequestWS_PortWSDDServiceName());
                return _stub;
            }
        }
