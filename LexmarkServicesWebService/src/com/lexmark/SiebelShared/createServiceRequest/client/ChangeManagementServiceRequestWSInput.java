...
public class ChangeManagementServiceRequestWSInput  implements java.io.Serializable {
    private com.lexmark.SiebelShared.createServiceRequest.client.ChangeManagementServiceRequestWSInput2 changeManagementServiceRequestWSInput;

    public ChangeManagementServiceRequestWSInput() {
    }

    public ChangeManagementServiceRequestWSInput(
           com.lexmark.SiebelShared.createServiceRequest.client.ChangeManagementServiceRequestWSInput2 changeManagementServiceRequestWSInput) {
     ...
     */
    public com.lexmark.SiebelShared.createServiceRequest.client.ChangeManagementServiceRequestWSInput2 getChangeManagementServiceRequestWSInput() {
        return changeManagementServiceRequestWSInput;
    }
     ...
     */
    public void setChangeManagementServiceRequestWSInput(com.lexmark.SiebelShared.createServiceRequest.client.ChangeManagementServiceRequestWSInput2 changeManagementServiceRequestWSInput) {
        this.changeManagementServiceRequestWSInput = changeManagementServiceRequestWSInput;
    }
