...
public class GetServiceRequestStatusInput  implements java.io.Serializable {
    private com.lexmark.SiebelShared.createServiceRequest.client.GetServiceRequestStatusWSInput getServiceRequestStatusWSInput;

    public GetServiceRequestStatusInput() {
    }

    public GetServiceRequestStatusInput(
           com.lexmark.SiebelShared.createServiceRequest.client.GetServiceRequestStatusWSInput getServiceRequestStatusWSInput) {
     ...
     */
    public com.lexmark.SiebelShared.createServiceRequest.client.GetServiceRequestStatusWSInput getGetServiceRequestStatusWSInput() {
        return getServiceRequestStatusWSInput;
    }
     ...
     */
    public void setGetServiceRequestStatusWSInput(com.lexmark.SiebelShared.createServiceRequest.client.GetServiceRequestStatusWSInput getServiceRequestStatusWSInput) {
        this.getServiceRequestStatusWSInput = getServiceRequestStatusWSInput;
    }
