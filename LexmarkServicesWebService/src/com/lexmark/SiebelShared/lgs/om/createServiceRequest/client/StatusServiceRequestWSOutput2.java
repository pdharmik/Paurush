...
public class StatusServiceRequestWSOutput2  implements java.io.Serializable {
    private com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.DocumentMetaData3 documentMetaData;

    private com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.StatusServiceRequestData statusServiceRequestData;

    public StatusServiceRequestWSOutput2() {
    }

    public StatusServiceRequestWSOutput2(
           com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.DocumentMetaData3 documentMetaData,
           com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.StatusServiceRequestData statusServiceRequestData) {
     ...
     */
    public com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.DocumentMetaData3 getDocumentMetaData() {
        return documentMetaData;
    }
     ...
     */
    public void setDocumentMetaData(com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.DocumentMetaData3 documentMetaData) {
        this.documentMetaData = documentMetaData;
    }
     ...
     */
    public com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.StatusServiceRequestData getStatusServiceRequestData() {
        return statusServiceRequestData;
    }
     ...
     */
    public void setStatusServiceRequestData(com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.StatusServiceRequestData statusServiceRequestData) {
        this.statusServiceRequestData = statusServiceRequestData;
    }
