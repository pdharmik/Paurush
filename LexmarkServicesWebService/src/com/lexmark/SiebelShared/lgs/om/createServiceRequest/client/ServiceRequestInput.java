...
public class ServiceRequestInput  implements java.io.Serializable {
    private com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.ServiceRequestWSInput serviceRequestWSInput;

    public ServiceRequestInput() {
    }

    public ServiceRequestInput(
           com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.ServiceRequestWSInput serviceRequestWSInput) {
     ...
     */
    public com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.ServiceRequestWSInput getServiceRequestWSInput() {
        return serviceRequestWSInput;
    }
     ...
     */
    public void setServiceRequestWSInput(com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.ServiceRequestWSInput serviceRequestWSInput) {
        this.serviceRequestWSInput = serviceRequestWSInput;
    }
