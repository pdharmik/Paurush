...
public class SellableItemServiceRequestWSInput  implements java.io.Serializable {
    private com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.SellableItemsServiceRequestWSInput sellableItemsServiceRequestWSInput;

    public SellableItemServiceRequestWSInput() {
    }

    public SellableItemServiceRequestWSInput(
           com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.SellableItemsServiceRequestWSInput sellableItemsServiceRequestWSInput) {
     ...
     */
    public com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.SellableItemsServiceRequestWSInput getSellableItemsServiceRequestWSInput() {
        return sellableItemsServiceRequestWSInput;
    }
     ...
     */
    public void setSellableItemsServiceRequestWSInput(com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.SellableItemsServiceRequestWSInput sellableItemsServiceRequestWSInput) {
        this.sellableItemsServiceRequestWSInput = sellableItemsServiceRequestWSInput;
    }
