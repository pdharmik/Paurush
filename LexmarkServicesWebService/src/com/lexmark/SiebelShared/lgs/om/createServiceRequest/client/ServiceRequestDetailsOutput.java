...
public class ServiceRequestDetailsOutput  implements java.io.Serializable {
    private com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.ServiceRequestWSOutput serviceRequestWSOutput;

    public ServiceRequestDetailsOutput() {
    }

    public ServiceRequestDetailsOutput(
           com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.ServiceRequestWSOutput serviceRequestWSOutput) {
     ...
     */
    public com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.ServiceRequestWSOutput getServiceRequestWSOutput() {
        return serviceRequestWSOutput;
    }
     ...
     */
    public void setServiceRequestWSOutput(com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.ServiceRequestWSOutput serviceRequestWSOutput) {
        this.serviceRequestWSOutput = serviceRequestWSOutput;
    }
