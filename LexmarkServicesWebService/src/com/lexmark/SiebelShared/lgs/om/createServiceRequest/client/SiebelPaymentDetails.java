...
public class SiebelPaymentDetails  implements java.io.Serializable {
    private com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.PaymentDetails paymentDetails;

    public SiebelPaymentDetails() {
    }

    public SiebelPaymentDetails(
           com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.PaymentDetails paymentDetails) {
     ...
     */
    public com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.PaymentDetails getPaymentDetails() {
        return paymentDetails;
    }
     ...
     */
    public void setPaymentDetails(com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.PaymentDetails paymentDetails) {
        this.paymentDetails = paymentDetails;
    }
