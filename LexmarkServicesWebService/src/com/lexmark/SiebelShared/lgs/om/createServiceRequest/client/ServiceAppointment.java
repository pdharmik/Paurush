...
public class ServiceAppointment  implements java.io.Serializable {
    private com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.GetServiceAppointmentWSInput getServiceAppointmentWSInput;

    public ServiceAppointment() {
    }

    public ServiceAppointment(
           com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.GetServiceAppointmentWSInput getServiceAppointmentWSInput) {
     ...
     */
    public com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.GetServiceAppointmentWSInput getGetServiceAppointmentWSInput() {
        return getServiceAppointmentWSInput;
    }
     ...
     */
    public void setGetServiceAppointmentWSInput(com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.GetServiceAppointmentWSInput getServiceAppointmentWSInput) {
        this.getServiceAppointmentWSInput = getServiceAppointmentWSInput;
    }
