...
public class SelectedServiceDetails2  implements java.io.Serializable {
    private com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.Entitlement5 entitlement;

    public SelectedServiceDetails2() {
    }

    public SelectedServiceDetails2(
           com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.Entitlement5 entitlement) {
     ...
     * @return entitlement
     */
    public com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.Entitlement5 getEntitlement() {
        return entitlement;
    }
     ...
     * @param entitlement
     */
    public void setEntitlement(com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.Entitlement5 entitlement) {
        this.entitlement = entitlement;
    }
