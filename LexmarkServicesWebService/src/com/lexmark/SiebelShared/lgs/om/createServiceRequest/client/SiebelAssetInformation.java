...
public class SiebelAssetInformation  implements java.io.Serializable {
    ...
    private com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.SiebelAddress installedAtAddress;

    private com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.Entitlement4 entitlement;

    private com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.SiebelContact assetContact;

    private com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.Account3 account;
    ...
    public SiebelAssetInformation(
           ...
           com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.SiebelAddress installedAtAddress,
           com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.Entitlement4 entitlement,
           com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.SiebelContact assetContact,
           com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.Account3 account,
     ...
     */
    public com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.SiebelAddress getInstalledAtAddress() {
        return installedAtAddress;
    }
     ...
     */
    public void setInstalledAtAddress(com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.SiebelAddress installedAtAddress) {
        this.installedAtAddress = installedAtAddress;
    }
     ...
     * @return entitlement
     */
    public com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.Entitlement4 getEntitlement() {
        return entitlement;
    }
     ...
     * @param entitlement
     */
    public void setEntitlement(com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.Entitlement4 entitlement) {
        this.entitlement = entitlement;
    }
     ...
     * @return assetContact
     */
    public com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.SiebelContact getAssetContact() {
        return assetContact;
    }
     ...
     * @param assetContact
     */
    public void setAssetContact(com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.SiebelContact assetContact) {
        this.assetContact = assetContact;
    }
     ...
     * @return account
     */
    public com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.Account3 getAccount() {
        return account;
    }
     ...
     * @param account
     */
    public void setAccount(com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.Account3 account) {
        this.account = account;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://dlxkswmis1.lex.lexmark.com/ServiceRequest/serviceRequestWS", "SiebelAssetInformation"));
