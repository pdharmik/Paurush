...
public class AddressWSOutput  implements java.io.Serializable {
    private com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.AddressData2 addressData;

    public AddressWSOutput() {
    }

    public AddressWSOutput(
           com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.AddressData2 addressData) {
     ...
     * @return addressData
     */
    public com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.AddressData2 getAddressData() {
        return addressData;
    }
     ...
     * @param addressData
     */
    public void setAddressData(com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.AddressData2 addressData) {
        this.addressData = addressData;
    }
