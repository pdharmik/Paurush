...
public class ServiceRequestWSOutput  implements java.io.Serializable {
    private com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.DocumentMetaData documentMetaData;

    private com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.ServiceRequestData serviceRequestData;

    public ServiceRequestWSOutput() {
    }

    public ServiceRequestWSOutput(
           com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.DocumentMetaData documentMetaData,
           com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.ServiceRequestData serviceRequestData) {
     ...
     */
    public com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.DocumentMetaData getDocumentMetaData() {
        return documentMetaData;
    }
     ...
     */
    public void setDocumentMetaData(com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.DocumentMetaData documentMetaData) {
        this.documentMetaData = documentMetaData;
    }
     ...
     */
    public com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.ServiceRequestData getServiceRequestData() {
        return serviceRequestData;
    }
     ...
     */
    public void setServiceRequestData(com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.ServiceRequestData serviceRequestData) {
        this.serviceRequestData = serviceRequestData;
    }
