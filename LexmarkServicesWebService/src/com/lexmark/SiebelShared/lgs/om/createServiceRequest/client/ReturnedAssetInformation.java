...
public class ReturnedAssetInformation  implements java.io.Serializable {
    ...
    private com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.InstalledAtAddress2 installedAtAddress;

    private com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.Entitlement3 entitlement;

    private com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.AssetContact2 assetContact;

    private com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.Account2 account;
    ...
    public ReturnedAssetInformation(
           ...
           com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.InstalledAtAddress2 installedAtAddress,
           com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.Entitlement3 entitlement,
           com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.AssetContact2 assetContact,
           com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.Account2 account,
     ...
     */
    public com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.InstalledAtAddress2 getInstalledAtAddress() {
        return installedAtAddress;
    }
     ...
     */
    public void setInstalledAtAddress(com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.InstalledAtAddress2 installedAtAddress) {
        this.installedAtAddress = installedAtAddress;
    }
     ...
     * @return entitlement
     */
    public com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.Entitlement3 getEntitlement() {
        return entitlement;
    }
     ...
     * @param entitlement
     */
    public void setEntitlement(com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.Entitlement3 entitlement) {
        this.entitlement = entitlement;
    }
     ...
     * @return assetContact
     */
    public com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.AssetContact2 getAssetContact() {
        return assetContact;
    }
     ...
     * @param assetContact
     */
    public void setAssetContact(com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.AssetContact2 assetContact) {
        this.assetContact = assetContact;
    }
     ...
     * @return account
     */
    public com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.Account2 getAccount() {
        return account;
    }
     ...
     * @param account
     */
    public void setAccount(com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.Account2 account) {
        this.account = account;
    }
