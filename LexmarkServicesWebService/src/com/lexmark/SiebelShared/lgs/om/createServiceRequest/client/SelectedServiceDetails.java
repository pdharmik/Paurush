...
public class SelectedServiceDetails  implements java.io.Serializable {
    private com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.Entitlement2 entitlement;

    public SelectedServiceDetails() {
    }

    public SelectedServiceDetails(
           com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.Entitlement2 entitlement) {
     ...
     * @return entitlement
     */
    public com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.Entitlement2 getEntitlement() {
        return entitlement;
    }
     ...
     * @param entitlement
     */
    public void setEntitlement(com.lexmark.SiebelShared.lgs.om.createServiceRequest.client.Entitlement2 entitlement) {
        this.entitlement = entitlement;
    }
