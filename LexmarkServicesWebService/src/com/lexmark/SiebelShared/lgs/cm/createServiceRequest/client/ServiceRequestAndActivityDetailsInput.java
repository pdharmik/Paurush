...
public class ServiceRequestAndActivityDetailsInput  implements java.io.Serializable {
    private com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.GetServiceRequestAndActivityDetails getServiceRequestAndActivityDetails;

    public ServiceRequestAndActivityDetailsInput() {
    }

    public ServiceRequestAndActivityDetailsInput(
           com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.GetServiceRequestAndActivityDetails getServiceRequestAndActivityDetails) {
     ...
     */
    public com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.GetServiceRequestAndActivityDetails getGetServiceRequestAndActivityDetails() {
        return getServiceRequestAndActivityDetails;
    }
     ...
     */
    public void setGetServiceRequestAndActivityDetails(com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.GetServiceRequestAndActivityDetails getServiceRequestAndActivityDetails) {
        this.getServiceRequestAndActivityDetails = getServiceRequestAndActivityDetails;
    }
