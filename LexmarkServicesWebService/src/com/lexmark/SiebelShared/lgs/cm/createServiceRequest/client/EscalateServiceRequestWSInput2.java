...
public class EscalateServiceRequestWSInput2  implements java.io.Serializable {
    private com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.DocumentMetaData6 documentMetaData;

    private com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.EscalateServiceRequestData escalateServiceRequestData;

    public EscalateServiceRequestWSInput2() {
    }

    public EscalateServiceRequestWSInput2(
           com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.DocumentMetaData6 documentMetaData,
           com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.EscalateServiceRequestData escalateServiceRequestData) {
     ...
     */
    public com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.DocumentMetaData6 getDocumentMetaData() {
        return documentMetaData;
    }
     ...
     */
    public void setDocumentMetaData(com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.DocumentMetaData6 documentMetaData) {
        this.documentMetaData = documentMetaData;
    }
     ...
     */
    public com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.EscalateServiceRequestData getEscalateServiceRequestData() {
        return escalateServiceRequestData;
    }
     ...
     */
    public void setEscalateServiceRequestData(com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.EscalateServiceRequestData escalateServiceRequestData) {
        this.escalateServiceRequestData = escalateServiceRequestData;
    }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://dlxkswmis1.lex.lexmark.com/ServiceRequest/serviceRequestWS", "DocumentMetaData6"));
