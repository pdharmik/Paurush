...
public class AddressCleanseWSOutput  implements java.io.Serializable {
    private com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.AddressWSOutput addressWSOutput;

    public AddressCleanseWSOutput() {
    }

    public AddressCleanseWSOutput(
           com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.AddressWSOutput addressWSOutput) {
     ...
     */
    public com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.AddressWSOutput getAddressWSOutput() {
        return addressWSOutput;
    }
     ...
     */
    public void setAddressWSOutput(com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.AddressWSOutput addressWSOutput) {
        this.addressWSOutput = addressWSOutput;
    }
