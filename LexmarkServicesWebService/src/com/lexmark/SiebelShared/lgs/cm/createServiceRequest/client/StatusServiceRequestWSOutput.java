...
public class StatusServiceRequestWSOutput  implements java.io.Serializable {
    private com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.StatusServiceRequestWSOutput2 statusServiceRequestWSOutput;

    public StatusServiceRequestWSOutput() {
    }

    public StatusServiceRequestWSOutput(
           com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.StatusServiceRequestWSOutput2 statusServiceRequestWSOutput) {
     ...
     */
    public com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.StatusServiceRequestWSOutput2 getStatusServiceRequestWSOutput() {
        return statusServiceRequestWSOutput;
    }
     ...
     */
    public void setStatusServiceRequestWSOutput(com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.StatusServiceRequestWSOutput2 statusServiceRequestWSOutput) {
        this.statusServiceRequestWSOutput = statusServiceRequestWSOutput;
    }
