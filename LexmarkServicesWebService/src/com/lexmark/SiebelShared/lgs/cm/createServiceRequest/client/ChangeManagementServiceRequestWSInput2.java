...
public class ChangeManagementServiceRequestWSInput2  implements java.io.Serializable {
    private com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.DocumentMetaData2 documentMetaData;

    private com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.ChangeManagementServiceRequestData changeManagementServiceRequestData;

    public ChangeManagementServiceRequestWSInput2() {
    }

    public ChangeManagementServiceRequestWSInput2(
           com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.DocumentMetaData2 documentMetaData,
           com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.ChangeManagementServiceRequestData changeManagementServiceRequestData) {
     ...
     */
    public com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.DocumentMetaData2 getDocumentMetaData() {
        return documentMetaData;
    }
     ...
     */
    public void setDocumentMetaData(com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.DocumentMetaData2 documentMetaData) {
        this.documentMetaData = documentMetaData;
    }
     ...
     */
    public com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.ChangeManagementServiceRequestData getChangeManagementServiceRequestData() {
        return changeManagementServiceRequestData;
    }
     ...
     */
    public void setChangeManagementServiceRequestData(com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.ChangeManagementServiceRequestData changeManagementServiceRequestData) {
        this.changeManagementServiceRequestData = changeManagementServiceRequestData;
    }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://dlxkswmis1.lex.lexmark.com/ServiceRequest/serviceRequestWS", "DocumentMetaData2"));
