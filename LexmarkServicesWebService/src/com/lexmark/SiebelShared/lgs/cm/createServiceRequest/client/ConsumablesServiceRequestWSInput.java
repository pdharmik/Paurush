...
public class ConsumablesServiceRequestWSInput  implements java.io.Serializable {
    private com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.ConsumablesServiceRequestWSInput2 consumablesServiceRequestWSInput;

    public ConsumablesServiceRequestWSInput() {
    }

    public ConsumablesServiceRequestWSInput(
           com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.ConsumablesServiceRequestWSInput2 consumablesServiceRequestWSInput) {
     ...
     */
    public com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.ConsumablesServiceRequestWSInput2 getConsumablesServiceRequestWSInput() {
        return consumablesServiceRequestWSInput;
    }
     ...
     */
    public void setConsumablesServiceRequestWSInput(com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.ConsumablesServiceRequestWSInput2 consumablesServiceRequestWSInput) {
        this.consumablesServiceRequestWSInput = consumablesServiceRequestWSInput;
    }
