...
public class CancelServiceAppointmentRequestListWSInput  implements java.io.Serializable {
    private com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.DocumentMetaData15 documentMetaData;

    private com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.CancelServiceAppointmentData2 cancelServiceAppointmentData;

    public CancelServiceAppointmentRequestListWSInput() {
    }

    public CancelServiceAppointmentRequestListWSInput(
           com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.DocumentMetaData15 documentMetaData,
           com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.CancelServiceAppointmentData2 cancelServiceAppointmentData) {
     ...
     */
    public com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.DocumentMetaData15 getDocumentMetaData() {
        return documentMetaData;
    }
     ...
     */
    public void setDocumentMetaData(com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.DocumentMetaData15 documentMetaData) {
        this.documentMetaData = documentMetaData;
    }
     ...
     */
    public com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.CancelServiceAppointmentData2 getCancelServiceAppointmentData() {
        return cancelServiceAppointmentData;
    }
     ...
     */
    public void setCancelServiceAppointmentData(com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.CancelServiceAppointmentData2 cancelServiceAppointmentData) {
        this.cancelServiceAppointmentData = cancelServiceAppointmentData;
    }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://dlxkswmis1.lex.lexmark.com/ServiceRequest/serviceRequestWS", "DocumentMetaData15"));
