...
public class EscalateServiceRequestWSInput  implements java.io.Serializable {
    private com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.EscalateServiceRequestWSInput2 escalateServiceRequestWSInput;

    public EscalateServiceRequestWSInput() {
    }

    public EscalateServiceRequestWSInput(
           com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.EscalateServiceRequestWSInput2 escalateServiceRequestWSInput) {
     ...
     */
    public com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.EscalateServiceRequestWSInput2 getEscalateServiceRequestWSInput() {
        return escalateServiceRequestWSInput;
    }
     ...
     */
    public void setEscalateServiceRequestWSInput(com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.EscalateServiceRequestWSInput2 escalateServiceRequestWSInput) {
        this.escalateServiceRequestWSInput = escalateServiceRequestWSInput;
    }
