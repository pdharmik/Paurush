...
public class GetServiceAppointmentWSInput  implements java.io.Serializable {
    private com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.DocumentMetaData documentMetaData;

    private com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.GetServiceAppointmentData getServiceAppointmentData;

    public GetServiceAppointmentWSInput() {
    }

    public GetServiceAppointmentWSInput(
           com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.DocumentMetaData documentMetaData,
           com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.GetServiceAppointmentData getServiceAppointmentData) {
     ...
     */
    public com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.DocumentMetaData getDocumentMetaData() {
        return documentMetaData;
    }
     ...
     */
    public void setDocumentMetaData(com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.DocumentMetaData documentMetaData) {
        this.documentMetaData = documentMetaData;
    }
     ...
     */
    public com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.GetServiceAppointmentData getGetServiceAppointmentData() {
        return getServiceAppointmentData;
    }
     ...
     */
    public void setGetServiceAppointmentData(com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.GetServiceAppointmentData getServiceAppointmentData) {
        this.getServiceAppointmentData = getServiceAppointmentData;
    }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://dlxkswmis1.lex.lexmark.com/ServiceRequest/serviceRequestWS", "DocumentMetaData"));
