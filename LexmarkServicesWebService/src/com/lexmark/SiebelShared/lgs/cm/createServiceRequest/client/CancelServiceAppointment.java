...
public class CancelServiceAppointment  implements java.io.Serializable {
    private com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.CancelServiceAppointmentWSInput cancelServiceAppointmentWSInput;

    public CancelServiceAppointment() {
    }

    public CancelServiceAppointment(
           com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.CancelServiceAppointmentWSInput cancelServiceAppointmentWSInput) {
     ...
     */
    public com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.CancelServiceAppointmentWSInput getCancelServiceAppointmentWSInput() {
        return cancelServiceAppointmentWSInput;
    }
     ...
     */
    public void setCancelServiceAppointmentWSInput(com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.CancelServiceAppointmentWSInput cancelServiceAppointmentWSInput) {
        this.cancelServiceAppointmentWSInput = cancelServiceAppointmentWSInput;
    }
