...
public class ConsumablesServiceRequestWSInput2  implements java.io.Serializable {
    private com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.DocumentMetaData4 documentMetaData;

    private com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.ConsumablesServiceRequestData consumablesServiceRequestData;

    public ConsumablesServiceRequestWSInput2() {
    }

    public ConsumablesServiceRequestWSInput2(
           com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.DocumentMetaData4 documentMetaData,
           com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.ConsumablesServiceRequestData consumablesServiceRequestData) {
     ...
     */
    public com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.DocumentMetaData4 getDocumentMetaData() {
        return documentMetaData;
    }
     ...
     */
    public void setDocumentMetaData(com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.DocumentMetaData4 documentMetaData) {
        this.documentMetaData = documentMetaData;
    }
     ...
     */
    public com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.ConsumablesServiceRequestData getConsumablesServiceRequestData() {
        return consumablesServiceRequestData;
    }
     ...
     */
    public void setConsumablesServiceRequestData(com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.ConsumablesServiceRequestData consumablesServiceRequestData) {
        this.consumablesServiceRequestData = consumablesServiceRequestData;
    }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://dlxkswmis1.lex.lexmark.com/ServiceRequest/serviceRequestWS", "DocumentMetaData4"));
