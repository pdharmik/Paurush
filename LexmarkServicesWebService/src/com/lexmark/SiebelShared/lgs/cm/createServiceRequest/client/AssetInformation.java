...
public class AssetInformation  implements java.io.Serializable {
    ...
    private com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.InstalledAtAddress installedAtAddress;

    private com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.Entitlement entitlement;

    private com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.AssetContact assetContact;

    private com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.Account account;
    ...
    public AssetInformation(
           ...
           com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.InstalledAtAddress installedAtAddress,
           com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.Entitlement entitlement,
           com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.AssetContact assetContact,
           com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.Account account,
     ...
     */
    public com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.InstalledAtAddress getInstalledAtAddress() {
        return installedAtAddress;
    }
     ...
     */
    public void setInstalledAtAddress(com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.InstalledAtAddress installedAtAddress) {
        this.installedAtAddress = installedAtAddress;
    }
     ...
     * @return entitlement
     */
    public com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.Entitlement getEntitlement() {
        return entitlement;
    }
     ...
     * @param entitlement
     */
    public void setEntitlement(com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.Entitlement entitlement) {
        this.entitlement = entitlement;
    }
     ...
     * @return assetContact
     */
    public com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.AssetContact getAssetContact() {
        return assetContact;
    }
     ...
     * @param assetContact
     */
    public void setAssetContact(com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.AssetContact assetContact) {
        this.assetContact = assetContact;
    }
     ...
     * @return account
     */
    public com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.Account getAccount() {
        return account;
    }
     ...
     * @param account
     */
    public void setAccount(com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.Account account) {
        this.account = account;
    }
