...
public class CancelServiceRequestWSInput  implements java.io.Serializable {
    private com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.CancelServiceRequestWSInput2 cancelServiceRequestWSInput;

    public CancelServiceRequestWSInput() {
    }

    public CancelServiceRequestWSInput(
           com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.CancelServiceRequestWSInput2 cancelServiceRequestWSInput) {
     ...
     */
    public com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.CancelServiceRequestWSInput2 getCancelServiceRequestWSInput() {
        return cancelServiceRequestWSInput;
    }
     ...
     */
    public void setCancelServiceRequestWSInput(com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.CancelServiceRequestWSInput2 cancelServiceRequestWSInput) {
        this.cancelServiceRequestWSInput = cancelServiceRequestWSInput;
    }
