...
public class GetServiceRequestStatusWSInput  implements java.io.Serializable {
    private com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.DocumentMetaData9 documentMetaData;

    private com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.GetServiceRequestStatusData getServiceRequestStatusData;

    public GetServiceRequestStatusWSInput() {
    }

    public GetServiceRequestStatusWSInput(
           com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.DocumentMetaData9 documentMetaData,
           com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.GetServiceRequestStatusData getServiceRequestStatusData) {
     ...
     */
    public com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.DocumentMetaData9 getDocumentMetaData() {
        return documentMetaData;
    }
     ...
     */
    public void setDocumentMetaData(com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.DocumentMetaData9 documentMetaData) {
        this.documentMetaData = documentMetaData;
    }
     ...
     */
    public com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.GetServiceRequestStatusData getGetServiceRequestStatusData() {
        return getServiceRequestStatusData;
    }
     ...
     */
    public void setGetServiceRequestStatusData(com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.GetServiceRequestStatusData getServiceRequestStatusData) {
        this.getServiceRequestStatusData = getServiceRequestStatusData;
    }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://dlxkswmis1.lex.lexmark.com/ServiceRequest/serviceRequestWS", "DocumentMetaData9"));
