...
public class UpdateServiceRequestActivityWSInput  implements java.io.Serializable {
    private com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.DocumentMetaData5 documentMetaData;

    private com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.ServiceRequestData2 serviceRequestData;

    public UpdateServiceRequestActivityWSInput() {
    }

    public UpdateServiceRequestActivityWSInput(
           com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.DocumentMetaData5 documentMetaData,
           com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.ServiceRequestData2 serviceRequestData) {
     ...
     */
    public com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.DocumentMetaData5 getDocumentMetaData() {
        return documentMetaData;
    }
     ...
     */
    public void setDocumentMetaData(com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.DocumentMetaData5 documentMetaData) {
        this.documentMetaData = documentMetaData;
    }
     ...
     */
    public com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.ServiceRequestData2 getServiceRequestData() {
        return serviceRequestData;
    }
     ...
     */
    public void setServiceRequestData(com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.ServiceRequestData2 serviceRequestData) {
        this.serviceRequestData = serviceRequestData;
    }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://dlxkswmis1.lex.lexmark.com/ServiceRequest/serviceRequestWS", "DocumentMetaData5"));
