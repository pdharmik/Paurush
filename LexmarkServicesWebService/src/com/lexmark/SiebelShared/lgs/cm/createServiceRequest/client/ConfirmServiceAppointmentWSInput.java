...
public class ConfirmServiceAppointmentWSInput  implements java.io.Serializable {
    private com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.DocumentMetaData7 documentMetaData;

    private com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.ConfirmServiceAppointmentData confirmServiceAppointmentData;

    public ConfirmServiceAppointmentWSInput() {
    }

    public ConfirmServiceAppointmentWSInput(
           com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.DocumentMetaData7 documentMetaData,
           com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.ConfirmServiceAppointmentData confirmServiceAppointmentData) {
     ...
     */
    public com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.DocumentMetaData7 getDocumentMetaData() {
        return documentMetaData;
    }
     ...
     */
    public void setDocumentMetaData(com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.DocumentMetaData7 documentMetaData) {
        this.documentMetaData = documentMetaData;
    }
     ...
     */
    public com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.ConfirmServiceAppointmentData getConfirmServiceAppointmentData() {
        return confirmServiceAppointmentData;
    }
     ...
     */
    public void setConfirmServiceAppointmentData(com.lexmark.SiebelShared.lgs.cm.createServiceRequest.client.ConfirmServiceAppointmentData confirmServiceAppointmentData) {
        this.confirmServiceAppointmentData = confirmServiceAppointmentData;
    }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://dlxkswmis1.lex.lexmark.com/ServiceRequest/serviceRequestWS", "DocumentMetaData7"));
