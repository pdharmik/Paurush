...
public class SiebelActivityNotes  implements java.io.Serializable {
    ...
    private com.lexmark.SiebelShared.debriefs.NoteAuthor noteAuthor;
    ...
    public SiebelActivityNotes(
           ...
           com.lexmark.SiebelShared.debriefs.NoteAuthor noteAuthor,
     ...
     * @return noteAuthor
     */
    public com.lexmark.SiebelShared.debriefs.NoteAuthor getNoteAuthor() {
        return noteAuthor;
    }
     ...
     * @param noteAuthor
     */
    public void setNoteAuthor(com.lexmark.SiebelShared.debriefs.NoteAuthor noteAuthor) {
        this.noteAuthor = noteAuthor;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://dashrwmis002.lex.lexmark.com/LXKAssetManagementStatus.webServices.provider:AssetManagementStatus", "SiebelActivityNotes"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://dashrwmis002.lex.lexmark.com/LXKAssetManagementStatus.webServices.provider:AssetManagementStatus", "NoteAuthor"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
