...
public class SiebelAssetManagementInformation  implements java.io.Serializable {
    ...
    private com.lexmark.SiebelShared.debriefs.SiebelAddress installedAtAddress;

    private com.lexmark.SiebelShared.debriefs.SiebelMeterReadInformation[] meterReadInformation;
    ...
    public SiebelAssetManagementInformation(
           ...
           com.lexmark.SiebelShared.debriefs.SiebelAddress installedAtAddress,
           com.lexmark.SiebelShared.debriefs.SiebelMeterReadInformation[] meterReadInformation) {
     ...
     */
    public com.lexmark.SiebelShared.debriefs.SiebelAddress getInstalledAtAddress() {
        return installedAtAddress;
    }
     ...
     */
    public void setInstalledAtAddress(com.lexmark.SiebelShared.debriefs.SiebelAddress installedAtAddress) {
        this.installedAtAddress = installedAtAddress;
    }
     ...
     */
    public com.lexmark.SiebelShared.debriefs.SiebelMeterReadInformation[] getMeterReadInformation() {
        return meterReadInformation;
    }
     ...
     */
    public void setMeterReadInformation(com.lexmark.SiebelShared.debriefs.SiebelMeterReadInformation[] meterReadInformation) {
        this.meterReadInformation = meterReadInformation;
    }

    public com.lexmark.SiebelShared.debriefs.SiebelMeterReadInformation getMeterReadInformation(int i) {
        return this.meterReadInformation[i];
    }

    public void setMeterReadInformation(int i, com.lexmark.SiebelShared.debriefs.SiebelMeterReadInformation _value) {
        this.meterReadInformation[i] = _value;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://dashrwmis002.lex.lexmark.com/LXKAssetManagementStatus.webServices.provider:AssetManagementStatus", "SiebelAssetManagementInformation"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://dashrwmis002.lex.lexmark.com/LXKAssetManagementStatus.webServices.provider:AssetManagementStatus", "SiebelMeterReadInformation"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
