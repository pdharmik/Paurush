...
package com.businessobjects.service.Service_Realtime_Batch_DQ_Siebel_account_match.input;
...
public class DataSet  implements java.io.Serializable {
    ...
    private com.businessobjects.service.Service_Realtime_Batch_DQ_Siebel_account_match.input.DataSetRecord[] record;
    ...
    public DataSet(
           ...
           com.businessobjects.service.Service_Realtime_Batch_DQ_Siebel_account_match.input.DataSetRecord[] record) {
     ...
     * @return record
     */
    public com.businessobjects.service.Service_Realtime_Batch_DQ_Siebel_account_match.input.DataSetRecord[] getRecord() {
        return record;
    }
     ...
     * @param record
     */
    public void setRecord(com.businessobjects.service.Service_Realtime_Batch_DQ_Siebel_account_match.input.DataSetRecord[] record) {
        this.record = record;
    }

    public com.businessobjects.service.Service_Realtime_Batch_DQ_Siebel_account_match.input.DataSetRecord getRecord(int i) {
        return this.record[i];
    }

    public void setRecord(int i, com.businessobjects.service.Service_Realtime_Batch_DQ_Siebel_account_match.input.DataSetRecord _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://businessobjects.com/service/Service_Realtime_Batch_DQ_Siebel_account_match/input", ">DataSet"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://businessobjects.com/service/Service_Realtime_Batch_DQ_Siebel_account_match/input", ">>DataSet>Record"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
