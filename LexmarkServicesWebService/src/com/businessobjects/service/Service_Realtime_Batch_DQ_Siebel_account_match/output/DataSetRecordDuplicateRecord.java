...
public class DataSetRecordDuplicateRecord  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://businessobjects.com/service/Service_Realtime_Batch_DQ_Siebel_account_match/output", ">>>DataSet>Record>DuplicateRecord"));
