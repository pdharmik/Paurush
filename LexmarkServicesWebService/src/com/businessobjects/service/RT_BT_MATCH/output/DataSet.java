...
public class DataSet  implements java.io.Serializable {
    ...
    private com.businessobjects.service.RT_BT_MATCH.output.DataSetRecord[] record;
    ...
    public DataSet(
           ...
           com.businessobjects.service.RT_BT_MATCH.output.DataSetRecord[] record) {
           this.action = action;
     ...
     * @return record
     */
    public com.businessobjects.service.RT_BT_MATCH.output.DataSetRecord[] getRecord() {
        return record;
    }
     ...
     * @param record
     */
    public void setRecord(com.businessobjects.service.RT_BT_MATCH.output.DataSetRecord[] record) {
        this.record = record;
    }

    public com.businessobjects.service.RT_BT_MATCH.output.DataSetRecord getRecord(int i) {
        return this.record[i];
    }

    public void setRecord(int i, com.businessobjects.service.RT_BT_MATCH.output.DataSetRecord _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://businessobjects.com/service/RT_BT_MATCH/output", ">DataSet"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://businessobjects.com/service/RT_BT_MATCH/output", ">>DataSet>Record"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
