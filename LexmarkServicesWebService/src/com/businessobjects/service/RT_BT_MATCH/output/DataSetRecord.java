...
public class DataSetRecord  implements java.io.Serializable {
    ...
    private com.businessobjects.service.RT_BT_MATCH.output.DataSetRecordDuplicateRecord[] duplicateRecord;
    ...
    public DataSetRecord(
           ...
           com.businessobjects.service.RT_BT_MATCH.output.DataSetRecordDuplicateRecord[] duplicateRecord) {
     ...
     */
    public com.businessobjects.service.RT_BT_MATCH.output.DataSetRecordDuplicateRecord[] getDuplicateRecord() {
        return duplicateRecord;
    }
     ...
     */
    public void setDuplicateRecord(com.businessobjects.service.RT_BT_MATCH.output.DataSetRecordDuplicateRecord[] duplicateRecord) {
        this.duplicateRecord = duplicateRecord;
    }

    public com.businessobjects.service.RT_BT_MATCH.output.DataSetRecordDuplicateRecord getDuplicateRecord(int i) {
        return this.duplicateRecord[i];
    }

    public void setDuplicateRecord(int i, com.businessobjects.service.RT_BT_MATCH.output.DataSetRecordDuplicateRecord _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://businessobjects.com/service/RT_BT_MATCH/output", ">>DataSet>Record"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://businessobjects.com/service/RT_BT_MATCH/output", ">>>DataSet>Record>DuplicateRecord"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
