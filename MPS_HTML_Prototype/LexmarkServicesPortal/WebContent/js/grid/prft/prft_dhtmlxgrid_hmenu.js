...
dhtmlXGridObject.prototype._createHContext = function() {
	...
	a.push("<table><tr><td colspan='2'><div><h4><a style='cursor: pointer' onclick='document.getElementById(\"grid_menu\").style.display=\"none\"'>"
...
dhtmlXGridObject.prototype._showHContext = function(mode, x, y) {
	...
	if (mode) {
		...
		this._hContext.style.left = parseInt(x - 220) + "px";
