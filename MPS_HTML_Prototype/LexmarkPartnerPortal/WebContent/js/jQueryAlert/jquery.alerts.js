...
(function($) {
	...
	$.alerts = {
		...
		_show: function(title, msg, value, type, callback) {
			...
			switch( type ) {
				case 'alert':
					$("#popup_message").after('<div id="popup_panel"><a href="javascript:void(0);" class="button_anchor" id="popup_ok"><span>'+ $.alerts.okButton +'</span></a></div>');
				...
				break;
				case 'confirm':
					$("#popup_message").after('<div id="popup_panel"><a href="javascript:void(0);" class="button_anchor" id="popup_ok"><span>'+ $.alerts.okButton +'</span></a>&nbsp;<a href="javascript:void(0);" class="cancel_button_anchor" id="popup_cancel" ><span>' + $.alerts.cancelButton + '</span></a></div>');
					$("#popup_ok").click( function() {
						$.alerts._hide();
				...
				break;
				case 'iConfirm':
					$("#popup_message").after('<div id="popup_panel" style="text-align:'+$.alerts.iPosition+';"><a href="javascript:void(0);" class="button_anchor" id="popup_ok"><span>'+ $.alerts.iOkButton +'</span></a>&nbsp;<a href="javascript:void(0);" class="cancel_button_anchor" id="popup_cancel" ><span>' + $.alerts.iCancelButton + '</span></a></div>');
					$("#popup_ok").click( function() {
						$.alerts._hide();
						if( callback ) callback(true);
						return false;
