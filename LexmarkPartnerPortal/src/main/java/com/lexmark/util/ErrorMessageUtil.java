...
public class ErrorMessageUtil {
	...
	public static String getErrorMessage(String bundleName, String errorCode, Locale locale) {
		return getErrorMessage(bundleName, errorCode, null, locale);
	}
