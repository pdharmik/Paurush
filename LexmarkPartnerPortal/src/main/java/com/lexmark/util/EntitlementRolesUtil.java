...
public class EntitlementRolesUtil {
	...
	/**
	 * This method is to do the following: a. Get the list of user roles and 
	 * Entitlement Role mapping lists.
	 * b. Create a map object with key as "Entitlement Name" and value as True 
	 * or False based on user role list and entitlement map list 
	 * 
	 * @param List<String> userRoleList
	 * @param HashMap<String, EntitlementRoleMapping>roles4EntitlementMap
