...
import com.lexmark.exception.AccountNotAssociatedException;
...
public class AccountAssociateInterceptor extends HandlerInterceptorAdapter {
	...
	private void handleAccountAssociate(PortletRequest portletRequest)throws Exception{
		...
		ServicesUser servicesUser  = (ServicesUser)portletSession.getAttribute(LexmarkConstants.SERVICES_USER_PHASE2, portletSession.APPLICATION_SCOPE);	
