...
function initURLParams(){
	...
	function initialiseGrid(){
		...
		requestListGrid.attachEvent("onBeforeSorting", function(index){
			//alert('on sorting');
			if("setDbpersistentFlag" in JSON_Param){
				if(JSON_Param["setDbpersistentFlag"]==false){
					dBPersistentFlag=false;
				}else{
					dBPersistentFlag=true;
				}
		...
		//The below section is commented as the filter search was not working
		...
		//The below code is added to make the adress filter search working
		...
		requestListGrid.attachEvent("onRowSelect", onrowselectfunction);
	...
	function setDefaultHiddenColumns(){
		...
		//alert(' returning setDefaultHiddenColumns');
