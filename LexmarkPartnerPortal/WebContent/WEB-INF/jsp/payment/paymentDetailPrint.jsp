	...
	<tr>
		<td>
			<div class="portlet-wrap-inner">
				<div id="paymentInfoPrint" class="columns two"></div>
			</div>
		</td>
	</tr>
	<tr>
...
<script type="text/javascript">
	document.getElementById("paymentInfoPrint").innerHTML = window.opener.document.getElementById("paymentInfo").innerHTML;
	var pageSize = 20;
	var parentgrid = window.opener.paymentLineItemGrid;
 	...
 	function afterPrint()
	{
 	...
 	function pagesetup_null(){                
 	 ...
 	 function doPrint(){
 		window.opener.callOmnitureAction('Payment Detail', 'Payment Detail Print');
