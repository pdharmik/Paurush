<%-- This jsp would print the invoice for both ap and ar from the grid --%>
<%@ include file="/WEB-INF/jsp/include.jsp"%>
<%@ include file="/WEB-INF/jsp/includeGrid.jsp"%>
<script src='<html:rootPath/>js/grid/ext/dhtmlxgrid_drag.js'></script>
...
<script type="text/javascript">
	...
	if(window.opener.invoiceGrid.getRowId(0)==null){
	var pageSize = 20;
	var parentgrid = window.opener.invoiceGrid;
