...
function Filters(){};
	...
	function  LBSAddressInformation(){
		this.LBSField=["lat","lng","floorNumber","id","buildingId","buildingName","regionId","regionName","address","city","state","country","zipCode","extAddressId","campusId","campusName","floorId","floorName","levelOfDetails","attributes"];
		this.HtmlId=["lbs_lat","lbs_lng","lbs_floorNumber","assetId","lbs_buildingId","lbs_buildingName","lbs_regionId","lbs_regionName","lbs_address","lbs_city","lbs_state","lbs_country","lbs_zipCode","lbs_extAddressId","lbs_campusId","lbs_campusName","lbs_floorId","lbs_floorName","lbs_levelOfDetails"];
	};
