...
function onTrackingNumberClick(carrier, trackingNumber) {
	...
	if (carrier == "Federal Express") {
		// height and width increased for defect 17238
		webPage = window.open("","Child",config = "height=700,width=970,toolbar=1,scrollbars=1,location=1,status=1,resizable=1");
