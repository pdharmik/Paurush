...
function addConsumablesAddress(addressId,addressName,addressLine1,addressLine2,addressCity,
		addressState,addressProvince,addressStateProvince,addressCountry,addressPostCode,storefrontName,phyloc1,
		phyloc2, phyloc3, favorite)
	{
		...
		jQuery("#consumablesContactAddressStateProvince").val(addressStateProvince);
