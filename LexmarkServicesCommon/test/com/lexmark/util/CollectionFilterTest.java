...
public class CollectionFilterTest {
	...
	@Test
	public void testMultiConditionFilterWithClassName() {
		Map<String , Object>  noFuzzyFilter = new HashMap<String, Object>();
		noFuzzyFilter.put("Asset.assetId", "123");
		noFuzzyFilter.put("Asset.serialNumber", "abc");
		...
		noFuzzyFilter = new HashMap<String, Object>();
		noFuzzyFilter.put("Asset.assetId", "123");
		noFuzzyFilter.put("Asset.ipAddress", "192.168.1");
