...
public class SiebelLocalization implements Serializable {
	...
	public enum SiebelLocalizationOptionEnum {
		...
		PARTNER_PRINTER_PART_STATUS("Partner Printer Part Status","PARTNER_PRINTER_PART_STATUS"),
		PARTNER_NON_PRINTER_PART_STATUS("Partner Non Printer Part Status","PARTNER_NON_PRINTER_PART_STATUS"),
		...
		//Added for LBS 1.5 Device Status.
		LBS_DEVICE_STATUS_SUPPLES("LBS Supplies","LBS_DEVICE_STATUS_SUPPLES"),
		LBS_DEVICE_STATUS_DEVICES("LBS Devices","LBS_DEVICE_STATUS_DEVICES"),
		LBS_DEVICE_STATUS_ALERTS("LBS Alerts","LBS_DEVICE_STATUS_ALERTS"),
		LBS_DEVICE_STATUS_UTILIZATION("LBS Utilization","LBS_DEVICE_STATUS_UTILIZATION"),
		LBS_DEVICE_STATUS_REPROTINGSTATUS("LBS ReportingStatus","LBS_DEVICE_STATUS_REPROTINGSTATUS"),
		LBS_DEVICE_STATUS_EXPIRATION("LBS Expiration","LBS_DEVICE_STATUS_EXPIRATION"),
		LBS_ADDRESSLOD("LBS address lod","LBS_ADDRESS_LOD"),
		LBS_FLOORLOD("LBS floor lod","LBS_FLOOR_LOD"),
		LBS_ISLBSADDRESS("Is lbs Address","IS_LBS_ADDRESS"),
		LBS_DEVICE_INTERNAL("LBS Devices Internal","LBS_DEVICE_STATUS_INTERNAL"),
		LBS_MULTISELECT_OPTIONS("LBS Multiselect Options","LBS_MULTISELECT_STATUS_OPTIONS"),
		COUNTRYLIST_WITHOUT_ZIPCODE("Country Without Zip", "COUNTRYLIST_WITHOUT_ZIPCODE"),
		ARIBA_ACCOUNTS("Ariba Accounts", "ARIBA_ACCOUNTS");
		//Ends LBS 1.5
