...
public class LocalizedEntitlementServiceDetailContract extends CachingContract implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -965797674804445810L;
