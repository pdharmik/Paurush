 ...
 * @author i.prikhodko
 *
 * The mapping file :  do-contractedandentitleddevice-mapping.xml
 */

public class ContractedAndEntitledDeviceDo extends AccountAsset implements
		Serializable {

	private static final long serialVersionUID = 1L;

	public static final String BO = "LXK MPS Contracted Consumable Only Asset List";
	public static final String BC = "LXK MPS Contracted Consumable Only Asset List";
	...
	private ArrayList<ConsumableDeviceTypeDo> type;
	...
	public void setContractedMdmLevel1AccountId(
			String contractedMdmLevel1AccountId) {
	...
	public void setContractedMdmLevel2AccountId(
			String contractedMdmLevel2AccountId) {
	...
	public void setContractedMdmLevel3AccountId(
			String contractedMdmLevel3AccountId) {
	...
	public void setContractedMdmLevel4AccountId(
			String contractedMdmLevel4AccountId) {
	...
	public void setContractedMdmLevel5AccountId(
			String contractedMdmLevel5AccountId) {
	...
	public void setType(ArrayList<ConsumableDeviceTypeDo> type) {
		this.type = type;
	}

	public ArrayList<ConsumableDeviceTypeDo> getType() {
		return type;
	}
