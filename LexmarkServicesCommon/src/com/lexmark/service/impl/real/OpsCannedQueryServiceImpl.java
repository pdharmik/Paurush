...
public class OpsCannedQueryServiceImpl implements CannedQueryService {
	private static Logger LOGGER = LogManager.getLogger(CannedQueryServiceImpl.class);
	private String queryAll="select * from ops_canned_queries";
	private String queryById="select * from ops_canned_queries where canned_id= :cannedId";
	@Override
