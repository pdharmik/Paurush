...
public class ServiceRequestListPaginationTest extends RequestServiceStatefulBase {
	...
	public static List<Object[]> filterParameters() {
		...
		list.add(new Object[] { 10, 25 });
		list.add(new Object[] { 15, 30 });

		return list;
	}

	public ServiceRequestListPaginationTest(int startRecordNumber, int increment) {
	...
	public void testRetrieveServiceRequestsPagination() throws Exception {
		...
		doTestRetrieveServiceRequestsPagination(contract);
	}

	private void doTestRetrieveServiceRequestsPagination(ServiceRequestListContract contract)
			throws Exception {
