...
public class Move {
	...
	@Test
	  public void testMoveAnAsset() throws Exception {
   ...
   //               WebDriver driver = new InternetExplorerDriver();
    ...
    driver.manage().timeouts().implicitlyWait(5,TimeUnit.SECONDS);
	    ...
	    Thread.sleep(5000);
	    System.out.println("Checking Bookmarked device");
	    
	    
	    //Click Move an asset
	    driver.findElement(By.xpath("//html/body/div[2]/div[2]/div/div/div/div/div/div/div/div[7]/div[3]/div/div[4]/div/div[1]/div[2]/table/tbody/tr[2]/td[1]/img")).click();
	    driver.manage().timeouts().implicitlyWait(8,TimeUnit.SECONDS);
	    System.out.println("Click Move an Asset");
	    ...
	    assertEquals("Change Asset Information", driver.findElement(By.cssSelector("h3.pageTitle")).getText());
	    driver.findElement(By.id("custReferenceId")).clear();
	    driver.findElement(By.id("custReferenceId")).sendKeys("34656");
	    driver.findElement(By.id("costCenter")).clear();
	    driver.findElement(By.id("costCenter")).sendKeys("3476547");
	    driver.findElement(By.id("addtnlDescription")).clear();
	    driver.findElement(By.id("addtnlDescription")).sendKeys("724746");
	    ...
	    driver.findElement(By.id("hostName")).sendKeys("nandhu");
	    driver.findElement(By.id("customerAssetTag")).clear();
	    driver.findElement(By.id("customerAssetTag")).sendKeys("462346");
	    driver.findElement(By.id("assetCostCenter")).clear();
	    driver.findElement(By.id("assetCostCenter")).sendKeys("34623456");
	    Thread.sleep(5000);
	    
	     
	    driver.findElement(By.xpath("//html/body/div[4]/div[2]/div/div/div/div/div/div/div/div[12]/div[3]/div[1]/form/div[11]/div/div[1]/ul/div/li/div/div[2]/div[1]/span")).click();
	    Thread.sleep(5000);
	    
	    // Select an Address
	    driver.findElement(By.id("moveToAddressLink")).click();
	    driver.manage().timeouts().implicitlyWait(25,TimeUnit.SECONDS);
	    
	    driver.findElement(By.xpath("//html/body/div[6]/div[2]/div/div/div/div[4]/div/div[1]/div[1]/table/tbody/tr[3]/td[3]/div/input")).clear();
	    driver.findElement(By.xpath("//html/body/div[6]/div[2]/div/div/div/div[4]/div/div[1]/div[1]/table/tbody/tr[3]/td[3]/div/input")).sendKeys(objSheet.getCell(4,i).getContents());
	    Thread.sleep(10000);	    
	    driver.findElement(By.xpath("//html/body/div[6]/div[2]/div/div/div/div[4]/div/div[1]/div[2]/table/tbody/tr[2]/td[1]/div/input")).click();
	    Thread.sleep(5000);
	    driver.findElement(By.id("moveTophysicalLocation1")).clear();
	    driver.findElement(By.id("moveTophysicalLocation1")).sendKeys("1");
	    driver.findElement(By.id("moveTophysicalLocation2")).clear();
	    driver.findElement(By.id("moveTophysicalLocation2")).sendKeys("2");
	    driver.findElement(By.id("moveTophysicalLocation3")).clear();
	    driver.findElement(By.id("moveTophysicalLocation3")).sendKeys("wipro");
	    Thread.sleep(5000);
	    System.out.println("Slecting Address");
	   ...
	   Toolkit.getDefaultToolkit().getSystemClipboard().setContents(ss, null);
	    ...
	    driver.findElement(By.xpath("//html/body/div[4]/div[2]/div/div/div/div/div/div/div/div[12]/div[3]/div[1]/div/div/div/div/div/form/button[2]")).click();
	    Thread.sleep(10000);
	 ...
	 // Review page
	   ...
	   SRnum[i] = Request_Number;
	    ...
	    assertEquals("Move Asset", driver.findElement(By.id("subarea")).getText());
