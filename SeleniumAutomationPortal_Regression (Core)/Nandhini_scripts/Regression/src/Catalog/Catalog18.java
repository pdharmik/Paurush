         ...
         driver.findElement(By.cssSelector("a.createNewRequestPopUp > span")).click();
          ...
          new Select(driver.findElement(By.id("partType"))).selectByVisibleText("Waste Bottle");
           ...
           driver.findElement(By.id("poNumber")).sendKeys(objSheet.getCell(5, i).getContents());
	  	    ...
	  	    driver.findElement(By.xpath("//html/body/div[2]/div[2]/div/div/div/div/div/div/div/div[13]/div/div/div[8]/form[1]/div[4]/div[2]/div/ul/li[2]/span/img[1]")).click(); //click on from calendar icon
	  	    ...
	  	    driver.findElement(By.xpath("//*[@id='rc_iframe_table']/tbody/tr[9]/td[1]")).click();  //Select date cell
