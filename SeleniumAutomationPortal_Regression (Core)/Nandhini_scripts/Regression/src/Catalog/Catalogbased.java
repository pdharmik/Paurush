        ...
        driver.manage().timeouts().implicitlyWait(3,TimeUnit.SECONDS);
         ...
         driver.findElement(By.cssSelector("a.createNewRequestPopUp > span")).click();
          ...
          //Verify details 
           ...
           System.out.println("Selecting Address,Product");
          ...
          driver.findElement(By.id("productType")).click();  
           ...
           System.out.println("Selcting Ship to address");
           ...
           Thread.sleep(4000);  
           driver.findElement(By.xpath("//html/body/div[5]/div/div[2]/button[2]")).click();	            
           Thread.sleep(4000);
