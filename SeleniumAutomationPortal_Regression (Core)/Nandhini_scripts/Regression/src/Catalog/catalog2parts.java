        ...
        driver.manage().timeouts().implicitlyWait(3,TimeUnit.SECONDS);
         ...
         driver.findElement(By.cssSelector("a.createNewRequestPopUp > span")).click();
          driver.manage().timeouts().implicitlyWait(8,TimeUnit.SECONDS);
           System.out.println("Creating catalobased");
          ...
          new Select(driver.findElement(By.id("partType"))).selectByVisibleText("Waste Bottle");
           ...
           driver.findElement(By.id("partQuantity1-5R15NMX")).click();
           driver.findElement(By.id("partQuantity1-5R15NMX")).clear();
           driver.findElement(By.id("partQuantity1-5R15NMX")).sendKeys(objSheet.getCell(3, i).getContents()); 
           driver.findElement(By.cssSelector("input.button")).click();
           driver.manage().timeouts().implicitlyWait(7,TimeUnit.SECONDS);
           ...
           //Request details page_Enter details
           
           
           
           
           //Select Primary Contact for this request
           
           driver.findElement(By.linkText("Select a different contact")).click();
           driver.manage().timeouts().implicitlyWait(25,TimeUnit.SECONDS);
           driver.findElement(By.cssSelector("td..filter > input[type=\"text\"]")).clear();
           driver.findElement(By.cssSelector("td..filter > input[type=\"text\"]")).sendKeys(objSheet.getCell(6, i).getContents());
           Thread.sleep(5000);
           driver.findElement(By.xpath("//input[@id='btn_select_1-8MN7WFK']")).click();
           Thread.sleep(5000);
           
           
           
         //Check same as requestor check box
           
           driver.findElement(By.cssSelector("span.checkbox_Span.check_Off")).click();
           Thread.sleep(5000);
       	System.out.println("Cchecking Same as requestor check box");
           
           
           //Select'Add an Additional Contact' button
           
           assertEquals("Add an Additional Contact for this Request", driver.findElement(By.id("addiContactButton")).getText());
           driver.findElement(By.id("addiContactButton")).click();
           Thread.sleep(20000); 
           driver.findElement(By.xpath("//html/body/div[4]/div[2]/div/div/div[4]/div[1]/div/div[1]/table/tbody/tr[3]/td[4]/input")).clear();
           driver.findElement(By.xpath("//html/body/div[4]/div[2]/div/div/div[4]/div[1]/div/div[1]/table/tbody/tr[3]/td[4]/input")).sendKeys(objSheet.getCell(6, i).getContents());
           Thread.sleep(8000);
           driver.findElement(By.xpath("//input[@id='btn_select_1-8MN7WFK']")).click();
           Thread.sleep(8000); 
