...
public class Assetbased14 {
    ...
    // Login Portal
			 driver.get("https://portal-qa.lexmark.com/web/global-services/login?");
 ...
 // Creating Assetbased SR
  ...
  //Primary contact for this request
    ...
    //select different ship to address
    System.out.println("Selecting Ship to Address");
    ...
    driver.findElement(By.xpath("//html/body/div[6]/div[2]/div/div/div/div[4]/div/div[1]/div[1]/table/tbody/tr[3]/td[3]/div/input")).sendKeys(objSheet.getCell(6,i).getContents());
    Thread.sleep(8000);
