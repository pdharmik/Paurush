...
//Click Invoice Tab
	    ...
	    try {
			...
			Thread.sleep(2000);
	    	driver.findElement(By.xpath("//*[@id='button0']")).click();
	    	//Select an account
	    	Thread.sleep(2000);
...
//click Detail link
		...
		//Id is not there to check
	    
	    driver.findElement(By.xpath("//html/body/div[3]/div[2]/div/div/div/div/div/div/div/div[7]/div[1]/div[3]/div/div[2]/div[5]/div/div/div[1]/div[2]/table/tbody/tr[2]/td[7]")).click();
		Thread.sleep(3000);
