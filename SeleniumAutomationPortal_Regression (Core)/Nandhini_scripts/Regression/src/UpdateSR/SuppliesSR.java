...
public class SuppliesSR {

	
	 @Test
	 
	  public void testUpdateSuppliesSR() throws Exception {	 
		 

			  System.out.println("starting Update Supplies SR");
	    ...
	    // Request tab
	         ...
	         Thread.sleep(10000);
	    System.out.println("Create Update Supplies SR");
	    
	    // Update Supplies Request     
	//    driver.findElement(By.xpath("//html/body/div[3]/div[3]/div/div/div/div/div/div/div/div[13]/div/div[6]/div[1]/ul[1]/li[5]/a")).click();
	    Thread.sleep(8000);
	  
	    driver.findElement(By.linkText("1-54472890164")).click();
	    Thread.sleep(4000);
	    
	    // Supplies Request Detailes Page
	    driver.findElement(By.id("updateButton")).click();
	    Thread.sleep(5000);
	    
	    // Inquiry
	    driver.findElement(By.id("custReferenceId")).clear();
	    driver.findElement(By.id("custReferenceId")).sendKeys("346325");
	    driver.findElement(By.id("costCenter")).clear();
	    driver.findElement(By.id("costCenter")).sendKeys("34645");
	 ...
	 // Inquiry_Confirmation Page
        ...
        assertEquals("Consumables SR", driver.findElement(By.id("subArea")).getText());
     ...
     //   LogOff
        ...
        //Open siebel application 		
           ...
           assertEquals("Consumables SR", driver.findElement(By.name("s_2_1_175_0")).getAttribute("value"));
