...
<div class="portlet-wrap">
      ...
      <div class="portletBlock bgSolid">
       <div class="portlet-wrap rounded popupInner">
        <div class="expand-min">
          ...
          <div class="portlet-wrap-inner"><div id="deviceHistoryGrid" style="background-color: white;"></div></div>
      ...
      <div id="detailsView" class="portlet-wrap rounded popupInner" style="height:400px;"> 
      <div class="journal-content-article" style="width: 100%!important;margin: 0!important;">
      <h1><spring:message	code="requestInfo.heading.requestDetails" /></h1>
</div>
      
      <div id="detailDiv" style="display:none"> <iframe src="" id="detailFrame" style="width:100%;height:400px;border:0;" ></iframe> </div></div>
  </div>
...
initURLParams = function(){
	...
	xmlURLQueryParams={
			isFavorite:false,
			urlParameters:["direction","orderBy","filterCriterias","isFavorite","<%=ISPOPUP%>","assetId","gridType","timezoneOffset","fromFleetManager","searchCriterias","isTwoYearHistoryFlag"],
			setParameters : function(){
									...
									this["isTwoYearHistoryFlag"]=isTwoYearHistoryFlag;
									},
...
var isTwoYearHistoryFlag;
isTwoYearHistoryFlag="${isTwoYearHistoryFlag}";
...
function changeTabs(type){
			...
			if(type=='changeRequest')
				...
				requestHistoryObj.setGridType(3);
				}
