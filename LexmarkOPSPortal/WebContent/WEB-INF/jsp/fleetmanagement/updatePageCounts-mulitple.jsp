...
<div id="templatePgCount{{id}}" class="marginTB10">
	<div style="margin-bottom:5px" id="assetInfo-PgCount{{id}}" onClick="onClickAssetInfoPG('{{id}}')">
		<div style="background-color:#eeeeee;padding:2px 10px;cursor:pointer">
			<span class="fontBold">Serial Number: </span><span class="span-apart">{{serialNumber}}</span>
			<span class="fontBold">IP Address: </span><span class="span-apart">{{ipAddress}}</span>
			<span class="fontBold">Model: </span><span class="span-apart">{{name}}</span>
			<span class="fontBold">Asset Tag: </span class="span-apart"><span>{{customerDeviceTag}}</span>
...
<thead>
	<tr>
		<th>Page Count Type</th>
		<th>DateTime Update</th>
		<th>Current Page Count</th>
		<th>Date/Time</th>
		<th>New Page Count</th>
	</tr>
</thead>
<tbody>
