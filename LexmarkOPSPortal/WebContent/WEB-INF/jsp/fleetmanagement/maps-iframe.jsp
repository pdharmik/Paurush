...
<div id="maps-Div-Popup">
	 ...
	 <div id="uam-mps-view-map">
        <iframe id="uam-mps-view-map-iframe" class="uam-test-iframe map-img" name="uam-mps-view-map-iframe" scrolling="no" style="height:600px;width:100%; float:left; border: 1px solid #e8e8e8;"></iframe>
    </div>
