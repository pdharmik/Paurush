...
<div id="totalContent" style="max-height: 500px; overflow-y: auto">
<div class="">
			<div id="rptAdminScdlMntnTitle"  style="TEXT-ALIGN: left; padding-left: 5px;">
        		<span class="orangeSectionTitles">
            		<spring:message code="meterRead.label.pageCountExport" />
        		</span><br/><br/>
	    	</div>

	    	<div  class="labelBold" style="TEXT-ALIGN: left; height:30px;padding-left: 5px;">
				<spring:message code="meterRead.label.exportPageCountsFor"/>
			</div>
			<div style="TEXT-ALIGN: left; height:30px; padding-left: 40px;"></div>
			<div>
