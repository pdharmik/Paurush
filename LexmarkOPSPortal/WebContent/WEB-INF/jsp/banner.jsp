...
<div class="portlet-section-body">
		...
		<script type="text/javascript">
			var flashvars = {xmlpath: "/LexmarkOPSPortal/xml/media_rotator.xml"};
			swfobject.embedSWF("/LexmarkOPSPortal/images/flash/lexmark2.swf", "lex", "970", "380", "9.0.0", false, flashvars, false, false);
		</script>
		<div id="lex">
