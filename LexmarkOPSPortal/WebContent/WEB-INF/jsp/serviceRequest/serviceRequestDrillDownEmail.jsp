		...
		<tr><td><br></td></tr>
  		...
  		<tr>
    		<td colspan="3" width="100%" height="60" align="right" valign="top">
    			 <button id="btnClose" class="button_cancel" style="width:65px" onClick="closeWindow(this);dialog.dialog('close');"><spring:message code='button.cancel'/></button> &nbsp; <button class="button" style="width:65px;cursor:pointer;" id="btnSendEmail" onClick="doSending();"><spring:message code='button.send'/></button>
    		</td>
  		</tr>
		</table>
</div>
