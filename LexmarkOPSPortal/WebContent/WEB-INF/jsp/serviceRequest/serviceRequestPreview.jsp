              ...
              <thead>
				...
				<div class="portlet-wrap-inner">
					<div class="grid-controls">
						<div class="utilities">
							<ul>
								<li class="first"><a id="newest" name="newest" href="#allRequestHistory" onclick="onNewestClick(this)" style="font-weight: bold;"><spring:message code="serviceRequest.label.newestRequests"/></a></li>
    				...
    				<div class="utilities">
						<ul>
							<li class="first"><a id="viewAll" name="viewAll" href="#" onclick="onViewAllClick()" style="color:black;"><spring:message code="serviceRequest.label.viewAll"/></a></li>
						</ul>
					</div><!-- utilities -->
