...
<div style="border: #B5CDE4 1px solid;">

<table style="margin-top:5px;" width='100%'>
	<tr>
		<td colspan='2'>
			<h5><spring:message code="serviceRequest.description.createNewAddress"/>:</h5><br>
			<label id="requiredFieldsErrorMsg2" style="color:red;display:none"><spring:message code="serviceRequest.errorMsg.pleaseFillInAllRequiredFields"/></label>
		</td>
	</tr>
	<tr >
	...
	<tr >
		<td width="50%"><select id="country" style="width: 180px;" name="countryDropDownList" onChange="getState();">
...
<br/>
<div align="right" ; style="margin-right:30px" ><button name="btnCancel" class="button_cancel" onClick="Liferay.Popup.close(this);"><spring:message code="button.cancel"/></button> &nbsp;<button name="btnSubmit" class="button" onClick="createNew(this);"><spring:message code="button.save"/></button></div>
