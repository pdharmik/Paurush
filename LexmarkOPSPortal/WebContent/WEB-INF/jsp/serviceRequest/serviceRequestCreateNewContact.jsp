...
<div style="border: #B5CDE4 1px solid; " valign="top;">
	<table style="margin-top:10px;" valign="top;">	
		...
		<tr>
			<td colspan="2" height="20px">
				<label id="requiredFieldsErrorMsg" style="color:red;display:none"><spring:message code="serviceRequest.errorMsg.pleaseFillInAllRequiredFields"/>&nbsp;</label>
				<label id="emailErrorMsg" style="color:red;display:none"><spring:message code="email.label.invalidEmailAddress"/>&nbsp;</label>
			</td>
		</tr>
		<tr align="left"> 
