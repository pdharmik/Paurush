...
<div class="left-nav">
			<div class="left-nav-inner" style="overflow:hidden;">
              ...
              <thead>
				...
				<ul class="filters">
					<li><a id="RecentSRList" style="font-weight: bold;" onclick="callOmnitureAction('Service Request', 'Recent Service Requests'); reLoadGrid('RecentSRList');" href="#" ><spring:message code="serviceRequest.title.recentRequests"/></a></li>
