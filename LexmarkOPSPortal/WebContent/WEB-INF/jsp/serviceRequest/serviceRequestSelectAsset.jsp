...
/* added for MPS breakfix	*/
#subnavigation {
	background: #fff url("/LexmarkOPSPortal/images/subnav_bg.png") repeat-x;
	border: #9998a1 1px solid;
	border-top: 0;
	padding:5px;
	overflow:hidden;
	clear:both;
...
.ie .button, .ie .button:focus, .ie .gridbox .button, .ie .gridbox .button:focus {
	background: url(/LexmarkOPSPortal/images/buttonBg.jpg) #0076a3 repeat-x 0px 0px; !important;
}
.button, .button:focus, .gridbox .button, .gridbox .button:focus {color: #d9eef7;
	background: #00abea;
	background: -webkit-gradient(linear, left top, left bottom, from(#00abea), to(#0076a3));
	background: -moz-linear-gradient(top, #00abea, #0076a3);
}
...
<table id="deviceTable" width="100%" border="0">
	<tr>
		...
		<table width="100%" border="0">
			...
			<tr>
				<td colspan="2" align="left"><label for="txtSearchValue" id="labErrorMsg" style="color: red"></label></td>
			</tr>			
			<tr>
    ...
    <div id="device_list_container">
	    ...
	    <div id="serviceDeviceListGrid" style="width:100%">
	    </div>
...
<div id="noRecordFound" style="width:100%">
...
<div id="globalSearch" style="border: #B5CDE4 1px solid; margin: 5px;">
...
<div id="searchResult" style="border: #B5CDE4 1px solid; margin: 5px;">
<div id="globalSerachResultContainer" style="width: 580px; height: 250px;">
<div id="globalDevice">
<table style="margin-left:20px" >
	<tr valign="center">
		...
		<td>
			<div style='margin-left: 50px'>
				<button class="button" type="button" onClick="requestServiceForDeviceNotFound('#select#');" style="background: url(/LexmarkOPSPortal/images/buttonBg.jpg) #0076a3 repeat-x 0px 0px; !important;">
...
<div id="divManualAsset" style="display: none; height: 280px; border: #B5CDE4 1px solid; margin: 5px;">
<table style="margin-left:20px">
	<tr>
		<td class="manualSerialTD">*<spring:message code="serviceRequest.label.MachineType" />:<br/>
			...
			<label for="machineType" id="machineTypeErrorMsg" style="color:red" />
		</td>
	...
	<tr>
		<td class="manualSerialTD"><spring:message code="serviceRequest.label.productTLI" />: <br/>
			...
			<label for="productTLI" id="productTLIErrorMsg" style="color:red"/>
		</td>
	</tr>
	<tr>
		<td class="manualSerialTD">
...
<div id="typeOfService" class="portlet-wrap rounded" style="width: 100%;">
	<div class="portlet-header">
	<h3><spring:message code="serviceRequest.label.problemDescription" /></h3>
	</div>
	<div  class="portlet-wrap-inner">
		<table width="500px" style="margin-bottom: 1px;margin-left:35px">
			<tr>
				<td valign="top"><b><spring:message code="serviceRequest.label.problemDescription" /></b><br />
				</td>
			</tr>
			<tr>
				<td valign="top" align="left" style="padding-left: 1cm;"><textarea 	style="width: 400px; height: 100px"></textarea></td>
			</tr>
			<tr>
				<td valign="center" align="left" style="padding-left: 1cm"><spring:message 	code="serviceRequest.label.ReferenceNumber" />: <br />
				<input style="width: 400px; height: 22px" /></td>
			</tr>
			<tr>
				<td>
					<div>
					...
					<div align="left" style="width: 300px; margin-left: 30px">
					...
					<div id="otherDiv" style="margin-left: 55px;">
