    ...
    <div class="main-wrap">
      <div class="content"> 
        ...
        <div class="utilities printPage1 floatR">
          <ul>
            <li class="first"><a href="javascript:print();"><img src="/LexmarkOPSPortal/images/transparent.png" class="ui_icon_sprite print-icon"
                  ...
                  <ul class="form">
                      ...
                      <li>
	                	...
	                	<li class="fav">
							...
							<img id="starIMG_${deviceDetailForm.device.assetId}" class='ui_icon_sprite bookmark-star-icon' src='<html:imagesPath/>transparent.png' 
	                	...
	                	<c:otherwise>
	                	<li>
							<img id="starIMG_${deviceDetailForm.device.assetId}" class="ui_icon_sprite removebookmark-icon" src="<html:imagesPath/>transparent.png" 
							name='favorite.png' onClick="updateUserFavoriteAsset('${deviceDetailForm.device.assetId}');" 
							style="cursor:pointer;" width="15" height="15" />
							<a href="javascript:updateUserFavoriteAsset('${deviceDetailForm.device.assetId}');" 
							id="starTXT_${deviceDetailForm.device.assetId}">
                  ...
                  <div class="columnInner infoBox rounded shadow">
                    ...
                    <ul class="form">
                      ...
                      <li>
                        ...
                        <span style="height:auto">${deviceDetailForm.device.assetContact.emailAddress}</span></li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              <div class="columnInner">
                <div class="left-nav">
                  <div class="left-nav-inner"> 
                    ...
                    <ul class="filters">
                      <li id="li_all_request_types" class="selected" onclick="javascript:show_load(this.id);" style="cursor: pointer;word-wrap: break-word;">
                      <a style="padding: 5px 5px 5px 15px !important;">
                      <spring:message code="deviceDetail.label.allRequestTypes"/></a></li>
                      <li id="li_supplies_requests" onclick="javascript:show_load(this.id);" style="cursor: pointer;word-wrap: break-word;">
                      <a style="padding: 5px 5px 5px 15px !important;">
                      <spring:message code="deviceDetail.label.suppliesRequests"/></a></li>
                      <%--Commented as of now MPS 2.1 will uncomment after jan release 
                      <li id="li_change_requests" onclick="javascript:show_load(this.id);" style="cursor: pointer;">
                      <a>
                      <spring:message code="deviceDetail.label.changeRequests"/></a></li>
                      --%>
                      <li id="li_service_requests" onclick="javascript:show_load(this.id);" style="cursor: pointer;word-wrap: break-word;">
                      <a style="padding: 5px 5px 5px 15px !important;">
                ...
                <div id="all_request_types">
                  <div class="right-column">
                    ...
                    <div class="export">
                   		<ul>
                    		<li class="first1"><a href="#"><img src="/LexmarkOPSPortal/images/transparent.png" class="ui_icon_sprite spreadsheet-icon" onclick="return  download('csv');" alt="Export to Excel" title="<spring:message code="requestInfo.tooltip.exporttoexcel"/>"/></a></li>
              				<li><img src="/LexmarkOPSPortal/images/transparent.png" class="ui_icon_sprite pdf-icon" onClick="return download('pdf')"; style="cursor:pointer"; title="<spring:message code='requestInfo.tooltip.exporttopdf'/>"; /></li>
              				<li><a href="#"><img src="/LexmarkOPSPortal/images/transparent.png" class="ui_icon_sprite print-icon" onclick="return print_list();" alt="Print" title="<spring:message code="requestInfo.tooltip.print"/>"/></a></li>
                    	</ul>
                    </div>
                    <!--added for BRD 14-02-01-ENDS----> 
                      ...
                      <div class="expand-min">
                        <ul>
                          <li class="first"><img src="<html:imagesPath/>/transparent.png" class="ui_icon_sprite customize-icon"  style="cursor:pointer" alt="Customize Grid" title="Customize Grid" />
