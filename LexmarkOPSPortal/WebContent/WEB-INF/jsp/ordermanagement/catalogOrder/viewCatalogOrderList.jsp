	      ...
	      <c:if test="${sessionScope.accountCurrentDetails['splitterFlag'] == 'true'}"> 
		        	...
		        	<div class="portletBlock infoBox rounded shadow split backgroundLight">
			          ...
			          <div class="columnsTwo">
			            ...
			            <!-- changed on June 11, 2013 for adding X image in header   <h4>&nbsp;<img src="<html:rootPath/>images/close.png" id="closeImage" style="display:none"  class="floatR positionUp" onclick="deleteCatalogDetails();" /></h4>-->	             
			              ...
			              <div style="width:80%;float:left;"><ul class="form" >
			                <li>
				...
				<div class="columnsTwo">
           			<div class="columnInner">
						...
						<ul class="form">
							...
							</span><span id="productTypeLoading" class="treeLoading" style="display:none;width:auto!important;float:left!important;"><img src="<html:imagesPath/>loading-icon.gif"/></span>
							</li>
							<li><label for="productModel"><spring:message code="serviceRequest.label.productModel"/> </label>
							<span id="showProductModel"><select id="productModel"><option value=""><spring:message code="requestInfo.option.select"/></option></select></span><span id="productModelLoading" class="treeLoading" style="display:none;width:auto!important;float:left!important;"><img src="<html:imagesPath/>loading-icon.gif"/></span>	
							</li>
						</ul>
					</div>
				</div>
				<div class="columnsTwo">
					<div class="columnInner">
						...
						<ul class="form">
							...
							<span id="showPartType"><select id="partType"><option value=""><spring:message code="requestInfo.option.select"/></option></select></span><span id="partTypeLoading" class="treeLoading" style="display:none;width:auto!important;float:left!important;"><img src="<html:imagesPath/>loading-icon.gif"/></span>
							</li>
			...
			<br>
				<div class="colunmInner rounded shadow">
					<div id="catalogListGridObj" style="width:100%"></div>
