...
var htmlContent='<div><h4 class="cartClass"><a style="cursor:pointer"><img class="helpIcon" cursor="pointer" onclick="closePopup();" width="18" height="18" src="/LexmarkServicesPortal/images/close.png" title=""></a><spring:message code="requestInfo.title.cartView"/></h4></div>';
function cartView(){
