  ...
  <div id="content-wrapper">
          ...
          <table id="catalogDetailPartTab">
				...
				<c:forEach items="${catalogDetailPageForm.catalogPartList}" var="catalogPartListDetail" varStatus="counter" begin="0">
					<tr class="<c:if test="${counter.index % 2 ne 0}">altRow</c:if>" id= "partRow${counter.index}">
						<td class="w15"><img id= "${counter.index}" height="15" width="15" onclick="deletePartFromCatalogDetail('${catalogPartListDetail.catalogId}', ${counter.index});"class="delete ui_icon_sprite trash-icon" title="Delete"	src="<html:imagesPath/>transparent.png"></td>
	...
	<div id="modaldialogbox" style="min-width: 450px;" >
	    <div class="columnInner" id="loadingDialog">
	    	<div class="columnsTwo w50"><img src="/LexmarkOPSPortal/images/green-check.png" style="width:50px; height:50px" ></img></div>
...
jQuery(document).ready(function() {
	...
	function deletePartFromCatalogDetail(catalogId, partNumberIndex) {
		...
		for (var i = partNumberIndex; i < tableCartRowNum - 2; i ++) {
			...
			tableCart.rows[i+1].cells[0].innerHTML = '<img id= "'+(i)+'" onclick="deletePartFromCatalogDetail('+newCatalogId+', '+(i)+');" class="delete" title="Delete" src="<html:imagesPath/>/tabbarImgs/default/close.png" width="15" height="15">';
			//alert('image is done');
		}
