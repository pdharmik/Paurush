      	...
      	<span id="reqNo">${requestForm.serviceRequest.serviceRequestNumber }</span>
   		...
   		<div class="utilities floatR">
		  	<ul>
	             ...
	             <li><a href="javascript:print();"><img src="/LexmarkOPSPortal/images/transparent.png" class="ui_icon_sprite print-icon" alt="Print this page" height="27" width="27"></a></li>
	           </ul>
         </div>
     </div>
    <div class="main-wrap" >
          ...
          <div class="columnsTwo">
            <div class="columnInner">
              ...
              <!-- Added for OPS Portal -->
                  ...
                  <span id ="agreementName">${requestForm.serviceRequest.agreementName }</span></li>
                <li>
                <li>
                  <label><spring:message code="requestInfo.label.agreementNumber"/> </label>
                  <span id ="agreementNumber">${requestForm.serviceRequest.agreementNumber }</span></li>
                <li>
                <!-- Added for OPS Portal -->
                <li>
               ...
               <li>
                  ...
                  <span id = "requestStatus">${requestForm.serviceRequest.requestStatus }</span></li>
                  
               
               <li>
                  <label><spring:message code="requestInfo.label.subStatus"/> </label>
                  <span id = "subStatus">${requestForm.serviceRequest.subStatus }</span></li>
                  
               
               <li>
                  <label><spring:message code="requestInfo.label.severity"/>:  </label>
                  <span id = "severity">${requestForm.serviceRequest.severity }</span></li>
                  <!-- Added for OPS Portal -->
               <li>
               ...
               <!-- Added for OPS Portal -->
                  	  <li>
                  		<label><spring:message code="requestInfo.label.customerRequestDateTime"/></label>
                  		 <span id="customerRequestDateTime">${requestForm.serviceRequest.customerRequestDateTime }</span></li>
                  	 
                  	  <li>
                  		<label><spring:message code="requestInfo.label.committedDateTime"/> </label>
                  		 <span id="committedDateTime">${requestForm.serviceRequest.committedDateTime }</span></li>
                  		 
                  		 <li>
                  		<label><spring:message code="requestInfo.label.projectName"/> </label>
                  		 <span id="committedDateTime">${requestForm.serviceRequest.projectName }</span></li>
                  		 <li>
                  		<label><spring:message code="requestInfo.label.projectPhase"/> </label>
                  		 <span id="committedDateTime">${requestForm.serviceRequest.projectPhase }</span></li>
                  	  <!-- Added for OPS Portal -->
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="assetDetail">
            <tr> 
              ...
              <td class="pModel"><ul>
                  ...
                  <li class="pModelName" style="text-align: center;"><%-- ${requestForm.serviceRequest.asset.modelNumber } --%>
              ...
              <td class="pDetail"><!-- Inner table: 4 row2 & 2 colums -->
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  --%></li>
                        ...
                        <li id="office"> <label><spring:message code="requestInfo.addressInfo.label.lbsIdentifier"/></label>
                        ${requestForm.serviceRequest.asset.installAddress.LBSIdentifierFlag}</li>
                      </ul></td>
                  </tr>
                </table></td>
            </tr>
...
<!--                         <div id="div_technicianProgressBar">PROGRESS BAR WILL COME HERE</div> -->
        ...
        <c:if test="${requestForm.serviceRequest.serviceActivityStatus!= null ||  not empty requestForm.serviceRequest.servicewebUpdateActivities}">
        <div class="portletBlock infoBox rounded shadow">
          <div class="columnsOne">
            <div class="columnInner">
...
<!--                         <div id="div_technicianProgressBar">PROGRESS BAR WILL COME HERE</div> -->
                        ...
                        <c:if test="${requestForm.serviceRequestTechnicianProgress gt 0 ||  not empty requestForm.serviceRequest.servicewebUpdateActivities}">
	                        <table border="0" cellspacing="0" cellpadding="0">
	                          <tr>
	                            <td><spring:message code="serviceRequest.label.inProcess"/></td>
                        ...
                        <c:if test="${requestForm.serviceRequestTechnicianProgress==0 &&  empty requestForm.serviceRequest.servicewebUpdateActivities}">
	                        <table border="0" cellspacing="0" cellpadding="0">
	                          <tr>
               ...
               <%--  <c:if test="${requestForm.serviceRequestTechnicianXML!= null}">
    			...
    			<c:if test="${ not empty requestForm.serviceRequest.servicewebUpdateActivities}">
    			<table border="0" width="100%" cellspacing="0" cellpadding="0" class="displayGrid">
	                          ...
	                          <c:forEach items="${requestForm.serviceRequest.servicewebUpdateActivities}" var="entry" >
	                          <tr>
	                            ...
	                            <td>${requestForm.serviceRequest.asset.serialNumber}</td>
            ...
            <div class="columnInner">
             <h4 class="expand" id="activity"><spring:message code="Details.supplyRequestDetails.heading.activity"/></h4>
              ...
              <table class="shipment wFull">
                  <tr>
                    <td class="w70p"><div class="status">
                        ...
                        <div id="div_technicianProgressBar1" class="status-bar"></div>
                        <table border="0" cellspacing="0" cellpadding="0">
	                          <tr>
	                            <td><spring:message code="serviceRequest.label.inProcess"/></td>
	                            <td><spring:message code="serviceRequest.label.assigned"/></td>
              ...
              <table border="1" width="100%" cellspacing="0" cellpadding="0">
	                          <tr><td>Activity Type</td><td>Activity Number</td><td>Severity</td><td>Activity Date</td><td>Status</td><td>Description</td></tr>
	                          <c:forEach items="${requestForm.serviceRequest.servicewebUpdateActivities}" var="entry" >
	                          <tr>
	                            <td>${entry.activityType}</td>
	                            <td>${entry.activityId}</td>
        ...
        <!-- OPS ORDER BLOCK -->
        <c:if test="${ not empty requestForm.serviceRequest.orders}">
        <div class="portletBlock infoBox rounded shadow">
          <div class="columnsOne">
            <div class="columnInner">
             <h4 class="" id="activity"><spring:message code="requestInfo.label.orderHeader"/></h4>
              ...
              <table border="0" width="100%" cellspacing="0" cellpadding="0" class="displayGrid">
	                         <thead> <tr><th><spring:message code="requestInfo.label.orderNumber"/></th><th>Order Type</th><th><spring:message code="requestInfo.label.severity"/></th><th><spring:message code="requestInfo.label.activitySubstatus"/></th><th><spring:message code="requestInfo.label.activityStatus"/></th><th><spring:message code="requestInfo.label.serviceProviderName"/></th></tr></thead>
	                          ...
	                          <c:forEach items="${requestForm.serviceRequest.orders}" var="entry" >	                           
...
<!--                         <div id="div_technicianProgressBar">PROGRESS BAR WILL COME HERE</div> -->
                ...
                <div id="div_cancelPrintTable">
							<div id="tab_cancelGrid" style="display:block;">
								<div id="div_cancelContainer" style="background-color: white;width:100%;"></div>
...
// 		</c:if>
	...
	/** 
 	...
 	SRStatusGrid = new dhtmlXGridObject('div_status_container');
  	...
  	SRStatusGrid.setColAlign("left,left,left,left,left");
  	SRStatusGrid.setColTypes("ro,ro,ro,ro,ro");
  	//SRStatusGrid.setColSorting("str,str,str");
  	SRStatusGrid.setInitWidths("250,250,250,250,250");
	...
	SRTechnicianGrid.setColTypes("ro,ro,ro,ro,ro,ro,ro,ro");
	//SRTechnicianGrid.setColSorting("str,str,str");
	SRTechnicianGrid.setInitWidths("150,150,*,150,150,150,150,150");
	...
	/** 
	  *  InProcess Grid config begin
	  Changes to be done for OPS portal
	  */
	...
	//SRInProgressGrid.setColAlign("left,left,left,left,left,right,left,left");
	SRInProgressGrid.setColAlign("left,left,left,left,left,right");
	//SRInProgressGrid.setColTypes("ro,ro,ro,ro,ro,ro,ro,ro");
	SRInProgressGrid.setColTypes("ro,ro,ro,ro,ro,ro");
	//SRInProgressGrid.setColSorting("str,str,str,str,str");
	//SRInProgressGrid.setInitWidths("180,250,170,110,100,120,120,170");
...
var dialog;
	...
	try {
		if(ServiceRqstType=='Consumables_Management') {
			...
			onSRNmbrClick1(ServiceRqstNumber);
		}
	}
	catch (ex) {
		hideOverlay();
	...
	return false;
	 ...
	 function onSRNmbrClick1(serviceRequestNumber,type){
