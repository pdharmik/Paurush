...
<div id="contentDetailsSupply" style="max-height: 500px; overflow-y: auto">
                ...
                <!-- Added for OPS Portal -->
                  	  ...
                  	  <li>
                  		...
                  		<label><spring:message code="requestInfo.label.projectName"/> </label>
                  		 <span id="committedDateTime">${requestFormPopup.serviceRequest.projectName }</span></li>
                  		 <li>
                  		<label><spring:message code="requestInfo.label.projectPhase"/> </label>
                  		 <span id="committedDateTime">${requestFormPopup.serviceRequest.projectPhase }</span></li>
                  	  <!-- Added for OPS Portal -->
              </ul>
            </div>
          </div>
            ...
            <div class="infoBox columnInner rounded shadow">
              ...
              <div class="portletScroll columnInner separatorV">
                         ...
                         <div id="pageCountsDiv">
								<div id="pageCounts" style="width:100%;"></div>	
...
<!--                         <div id="div_technicianProgressBar">PROGRESS BAR WILL COME HERE</div> -->
		...
		<%-- CHanges for MPS 2.1 ENDS--%>
	 		...
	 		if(priceAvailableFlag${status.count}==false && SRShipmentGrid${status.count}!=null){
       ...
       <!-- ACTIVITY BLOCK - START -->
        <c:if test="${requestFormPopup.serviceRequest.serviceActivityStatus!= null || not empty requestFormPopup.serviceRequest.servicewebUpdateActivities}">
        <div class="portletBlock infoBox rounded shadow">
          <div class="columnsOne">
            <div class="columnInner">
               ...
               <%--  <c:if test="${requestFormPopup.serviceRequestTechnicianXML!= null}">
                <div id="div_technicianPrintTable_Popup">
							<div id="tab_technicianGrid_Popup" style="display:block;">
								<div id="div_technicianContainer_Popup" style="background-color: white;width:100%;"></div>
...
<script type="text/javascript">
	...
	SRTechnicianGrid.setImagePath("/LexmarkOPSPortal/images/gridImgs/");
	...
	SRInProgressGrid.setImagePath("/LexmarkOPSPortal/images/gridImgs/");
	...
	//SRInProgressGrid.setInitWidths("180,*,180,100,100,100,100,100");
...
if(${requestFormPopup.cancelledPartsXML!= null}){
	//if(${requestFormPopup.serviceRequestTechnicianProgress==0}){
		jQuery("#div_cancelProgressBar_Popup").progressBar(100 , { width:480,speed:25,increment:1,height:12,showText: false, boxImage: '/LexmarkOPSPortal/images/progressBar/progressbar.gif', barImage : barImagesCancel} );
	//}else{
  	//	jQuery("#div_technicianProgressBar1_Popup").progressBar(${requestFormPopup.serviceRequestTechnicianProgress}, { width:480,speed:25,increment:1,height:12,showText: false, boxImage: '/LexmarkOPSPortal/images/progressBar/progressbar.gif', barImage : barImages} );
	//}
}
