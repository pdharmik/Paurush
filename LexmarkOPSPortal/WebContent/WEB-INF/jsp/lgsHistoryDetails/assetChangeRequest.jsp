               ...
               <!-- Added for OPS Portal -->
                  	  ...
                  	  <li>
                  		...
                  		<label><spring:message code="requestInfo.label.projectName"/> </label>
                  		 <span id="projectName">${requestForm.serviceRequest.projectName }</span></li>
                  		 <li>
                  		<label><spring:message code="requestInfo.label.projectPhase"/> </label>
                  		 <span id="projectPhase">${requestForm.serviceRequest.projectPhase }</span></li>
                  	  <!-- Added for OPS Portal End -->
            ...
            <tr>
              <td class="infoDsiplay"><ul class="form">
                  <li>
                    ...
                    <span id="serialNumber">${requestForm.serviceRequest.asset.serialNumber}</span></li>
                  <li>
...
<c:if test="${requestForm.serviceRequest.serviceActivityStatus!= null || not empty requestForm.serviceRequest.servicewebUpdateActivities || not empty requestForm.serviceRequest.activitywebUpdateActivities}">
...
<!--                         <div id="div_technicianProgressBar">PROGRESS BAR WILL COME HERE</div> -->
                        ...
                        <c:if test="${requestForm.serviceRequestTechnicianProgress gt 0 || not empty requestForm.serviceRequest.servicewebUpdateActivities || not empty requestForm.serviceRequest.activitywebUpdateActivities}">
	                        <table border="0" cellspacing="0" cellpadding="0">
	                          <tr>
                        ...
                        <c:if test="${requestForm.serviceRequestTechnicianProgress==0 && empty requestForm.serviceRequest.servicewebUpdateActivities && empty requestForm.serviceRequest.activitywebUpdateActivities}">
	                        <table border="0" cellspacing="0" cellpadding="0">
	                          <tr>
    			...
    			<%-- <c:if test="${not empty requestForm.serviceRequest.activitywebUpdateActivities}">
    			 <table border="0" width="100%" cellspacing="0" cellpadding="0" class="displayGrid">
	                          <thead><tr><th><spring:message code="requestInfo.label.activityType"/></th><th><spring:message code="requestInfo.label.activityNumber"/></th><th><spring:message code="requestInfo.label.severity"/></th><th><spring:message code="requestInfo.label.activityDate"/></th><th><spring:message code="requestInfo.label.activityStatus"/></th><th><spring:message code="requestInfo.label.activityDescription"/></th><th><spring:message code="requestInfo.label.activitySerialNo"/></th><th><spring:message code="requestInfo.label.activitySubstatus"/></th><th><spring:message code="requestInfo.label.activitydeviceType"/></th></tr></thead>
	                          <c:forEach items="${requestForm.serviceRequest.activitywebUpdateActivities}" var="entry" >
	                          <tr>
	                            <td>${entry.activityType}</td>
	                            <td>${entry.activityId}</td>
	                            <td>${entry.severity}</td>
          ...
          <div class="columnsTwo">
            <div class="infoBox columnInner rounded shadow">
              ...
              <li>
                    ...
                    <span>${requestForm.serviceRequest.asset.installAddress.LBSIdentifierFlag}</span>
                      </li>
					 </c:otherwise>
					 </c:choose>
					</ul>
...
//Added for CI BRD13-10-02--END
	...
	SRStatusGrid = new dhtmlXGridObject('div_status_container');
  	...
  	SRStatusGrid.setInitWidths("200,250,150,150,150");
	...
	function cancelRequest(){
 	...
 	//Added for MPS Phase 2.1
  	...
  	if(${requestForm.serviceRequestTechnicianXML!= null}){
  		...
  		SRTechnicianGrid.setColAlign("left,left,left,left,left,left,left,left,left");
  		SRTechnicianGrid.setColTypes("ro,ro,ro,ro,ro,ro,ro,ro,ro");
  		//SRTechnicianGrid.setColSorting("str,str,str");
  		SRTechnicianGrid.setInitWidths("150,100,100,100,100,100,100,150,100");
