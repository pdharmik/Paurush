...
<tr>
<td>
<table width="953"  border="0" cellspacing="0" cellpadding="0" align="center" style="border-width:1px; border-color:#3A7FA8; border-style:solid; background-color:#ffffff" id="emailPrintWraper">

  <tr>
    <td style="background-color:#3A7FA8;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td  style="padding-top:3px; padding-bottom:3px; padding-left:10px; font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#ffffff"><strong>Install Request Details</strong>&nbsp; &raquo;&nbsp;<strong><span class="step"><spring:message code="Details.supplyRequestDetails.label.rquestNumber"/> <span id="reqNumber"></span></span></strong></td>
        </tr>
      </table></td>
  </tr>
    ...
    <td><!-- PRIMARY SECONDARY CONTACTS & ADDITIONAL INFO - START -->
      ...
      <table width="100%" border="0" cellspacing="5" cellpadding="0">
          ...
          <td width="50%" valign="top" style="border-color:#cccccc; border-width:1px; border-style:solid"><table width="100%" border="0" cellspacing="0" cellpadding="5">
              ...
              <tr>
                ...
                <td style="font-family:Arial, Helvetica, sans-serif; font-size:11px;" id="area"></td>
                 <td style="font-family:Arial, Helvetica, sans-serif; font-size:11px;" id="coveredService"></td>
              </tr>
              <tr>
              ...
              <tr id="orderSource1">
                <td style="font-family:Arial, Helvetica, sans-serif; font-size:11px;"><strong> <spring:message code="Details.supplyRequestDetails.label.orderSource"/></strong></td>
              ...
              <tr>
                ...
                <td style="font-family:Arial, Helvetica, sans-serif; font-size:11px;" id="serviceRequestStatus"></td>
              </tr>
        ...
        <tr>
          <td width="50%" valign="top" style="border-color:#cccccc; border-width:1px; border-style:solid"><table width="100%" border="0" cellspacing="0" cellpadding="5">
              <tr>
                <th colspan="2" align="left" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;background-color:#e7e7e7;border-bottom-color:#aaaaaa; border-bottom-width:1px; border-bottom-style:dotted;"><strong>Primary Service Contact</strong></th>
              </tr>
              <tr>
          ...
          <td  valign="top" style="border-color:#cccccc; border-width:1px; border-style:solid"><table width="100%" border="0" cellspacing="0" cellpadding="5">
              ...
              <tr>
                ...
                <td valign="top"  style="font-family:Arial, Helvetica, sans-serif; font-size:11px;" id="customerReferenceNumber"></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td valign="top"  style="font-family:Arial, Helvetica, sans-serif; font-size:11px;" id="addtnlDescription"></td>
              </tr>
        ...
        <tr id="secondarySection" style="display: none;">
          <td  valign="top" style="border-color:#cccccc; border-width:1px; border-style:solid"><table width="100%" border="0" cellspacing="0" cellpadding="5">
              <tr>
                <th colspan="2" align="left" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;background-color:#e7e7e7;border-bottom-color:#aaaaaa; border-bottom-width:1px; border-bottom-style:dotted;"><strong>Secondary Service Contact</strong></th>
              </tr>
              <tr>
                <td width="100" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;"><strong><spring:message code="requestInfo.label.name"/></strong></td>
