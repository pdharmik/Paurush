              ...
              <ul class="form">
                <!-- Added for OPS Portal -->
                 <li> <label><spring:message code="requestInfo.label.agreementName"/> </label>
                  <span id ="agreementName">${requestFormPopup.serviceRequest.agreementName }</span></li>
                
                <li>
                  <label><spring:message code="requestInfo.label.agreementNumber"/> </label>
                  <span id ="agreementNumber">${requestFormPopup.serviceRequest.agreementNumber }</span></li>
                <li>
                <!-- Added for OPS Portal -->
                <li>
                ...
                <li>
                  ...
                  <li>
	                ...
	                <span id = "orderSource">${requestFormPopup.serviceRequest.orderSource } </span></li>
	                <!-- Added for OPS Portal -->
               <li>
                  <label><spring:message code="requestInfo.label.requestStatus"/></label>
                  <span id = "requestStatus">${requestFormPopup.serviceRequest.requestStatus }</span></li>
                  
               
               <li>
                  <label><spring:message code="requestInfo.label.subStatus"/> </label>
                  <span id = "subStatus">${requestFormPopup.serviceRequest.subStatus }</span></li>
                  
               
               <li>
                  <label><spring:message code="requestInfo.label.severity"/> : </label>
                  <span id = "severity">${requestFormPopup.serviceRequest.severity }</span></li>
...
<%--                   <span><fmt:formatDate value="${requestFormPopup.serviceRequest.serviceRequestDate }" pattern="dd MMM yyyy"/></span></li> --%>
              ...
              <li>
               		...
               		<span id = "accountName">${requestFormPopup.serviceRequest.accountName }</span>
               </li>  
               <!-- Added for OPS Portal -->
                  	  <li>
                  		<label><spring:message code="requestInfo.label.customerRequestDateTime"/></label>
                  		 <span id="customerRequestDateTime">${requestFormPopup.serviceRequest.customerRequestDateTime }</span></li>
                  	 
                  	  <li>
                  		<label><spring:message code="requestInfo.label.committedDateTime"/> </label>
                  		 <span id="committedDateTime">${requestFormPopup.serviceRequest.committedDateTime }</span></li>
                  		 
                  		  <li>
                  		<label><spring:message code="requestInfo.label.projectName"/> </label>
                  		 <span id="projectName">${requestFormPopup.serviceRequest.projectName }</span></li>
                  		 <li>
                  		<label><spring:message code="requestInfo.label.projectPhase"/> </label>
                  		 <span id="projectPhase">${requestFormPopup.serviceRequest.projectPhase }</span></li>
                  	  <!-- Added for OPS Portal End -->
              </ul>
            </div>
          </div>
...
<c:if test="${requestFormPopup.serviceRequest.serviceActivityStatus!= null || not empty requestFormPopup.serviceRequest.servicewebUpdateActivities || not empty requestFormPopup.serviceRequest.activitywebUpdateActivities}">
        <div class="portletBlock infoBox rounded shadow">
          <div class="columnsOne">
            <div class="columnInner">
...
<!--                         <div id="div_technicianProgressBar">PROGRESS BAR WILL COME HERE</div> -->
                        ...
                        <c:if test="${requestFormPopup.serviceRequestTechnicianProgress gt 0 || not empty requestFormPopup.serviceRequest.servicewebUpdateActivities || not empty requestFormPopup.serviceRequest.activitywebUpdateActivities}">
	                        <table border="0" cellspacing="0" cellpadding="0">
	                          <tr>
                        ...
                        <c:if test="${requestFormPopup.serviceRequestTechnicianProgress==0&&   empty requestFormPopup.serviceRequest.servicewebUpdateActivities &&  empty requestFormPopup.serviceRequest.activitywebUpdateActivities}">
	                        <table border="0" cellspacing="0" cellpadding="0">
	                          <tr>
              ...
              <%--   <c:if test="${requestFormPopup.serviceRequestTechnicianXML!= null}">
                <div id="div_technicianPrintTable">
    			 ...
    			 <c:if test="${ not empty requestFormPopup.serviceRequest.servicewebUpdateActivities}">
    			<div class="overflowAuto"><table border="0" width="100%" cellspacing="0" cellpadding="0" class="displayGrid">
	                          ...
	                          <c:forEach items="${requestFormPopup.serviceRequest.servicewebUpdateActivities}" var="entry" >
	                          <tr>
	                        ...
	                        <%--<c:if test="${ not empty requestFormPopup.serviceRequest.activitywebUpdateActivities}">
    			<div class="overflowAuto"><table border="0" width="100%" cellspacing="0" cellpadding="0" class="displayGrid">
	                          <thead><tr><th><spring:message code="requestInfo.label.activityType"/></th><th><spring:message code="requestInfo.label.activityNumber"/></th><th><spring:message code="requestInfo.label.severity"/></th><th><spring:message code="requestInfo.label.activityDate"/></th><th><spring:message code="requestInfo.label.activityStatus"/></th><th><spring:message code="requestInfo.label.activityDescription"/></th><th><spring:message code="requestInfo.label.activitySerialNo"/></th><th><spring:message code="requestInfo.label.activitySubstatus"/></th><th><spring:message code="requestInfo.label.activitydeviceType"/></th></tr></thead>
	                          <c:forEach items="${requestFormPopup.serviceRequest.activitywebUpdateActivities}" var="entry" >
	                          <tr>
	                            <td>${entry.activityType}</td>
	                            <td>${entry.activityId}</td>
	                            <td>${entry.severity}</td>
          ...
          <div class="columnsTwo">
            <div class="infoBox columnInner rounded shadow">
             ...
             <li>
                    ...
                    <span>${requestFormPopup.serviceRequest.asset.moveFromAddress.LBSIdentifierFlag}</span>
                      </li>
              </c:when>
              <c:otherwise>
	                	<li>
                    ...
                    <span>${requestFormPopup.serviceRequest.asset.installAddress.physicalLocation3}</span>
                      ...
                      <li><label><spring:message code="requestInfo.addressInfo.label.lbsIdentifier"/> </label> 
                    <span>${requestFormPopup.serviceRequest.asset.installAddress.LBSIdentifierFlag}</span>
                      </li>
                      </c:otherwise>
					 </c:choose>
          ...
          <c:if test="${requestFormPopup.serviceRequest.subArea eq 'HW MADC Install/Decommission'}">
				  ...
				  <table>
						...
						<th style="width: 12.5%"><spring:message code="requestInfo.label.comments"/></th>
							...
							<td id="deInstallPartNo">${deInstalledAsset.partNumber}</td>
...
<div class="columnsOne">
        ...
        <!-- OPS ORDER BLOCK -->
        <c:if test="${not empty requestFormPopup.serviceRequest.orders}">
        <div class="portletBlock infoBox rounded shadow">
          <div class="columnsOne">
            <div class="columnInner">
             <h4 class="" id="activity"><spring:message code="requestInfo.label.orderHeader"/></h4>
              ...
              <table border="1" width="100%" cellspacing="0" cellpadding="0" class="displayGrid">
	                        <thead> <tr><th><spring:message code="requestInfo.label.orderNumber"/></th><th>Order Type</th><th><spring:message code="requestInfo.label.severity"/></th><th><spring:message code="requestInfo.label.activityStatus"/></th><th><spring:message code="requestInfo.label.activitySubstatus"/></th><th><spring:message code="requestInfo.label.serviceProviderName"/></th></tr></thead>
	                         <tr>
	                          <c:forEach items="${requestFormPopup.serviceRequest.orders}" var="entry" >
