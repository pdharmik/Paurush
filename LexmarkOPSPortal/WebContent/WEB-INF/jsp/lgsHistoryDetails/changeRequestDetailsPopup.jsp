          ...
          <div class="columnsTwo">
            <div class="infoBox columnInner rounded shadow">
              ...
              <ul class="roDisplay">
               ...
               <li><label for="lbsIdentifier"><spring:message code="requestInfo.addressInfo.label.lbsIdentifier"/>  </label><span id="lbsIdentifier"> ${requestFormPopup.serviceRequest.asset.installAddress.LBSIdentifierFlag}</span></li>
              </ul>
            </div>
          </div>
          <div class="columnsTwo">
...
<!-- 	              	</tr> -->
        ...
        <div class="columnInner">
					<div id="notificationsGrid_chngPopup" style="display:block;">
						<div id="notifications_container_chngPopup" style="width:100%;"></div>
...
<script type="text/javascript">
	...
	*/
	SRNotificationsGrid = new dhtmlXGridObject('notifications_container_chngPopup');
 	SRNotificationsGrid.setImagePath("/LexmarkOPSPortal/images/gridImgs/");
	...
	function changeRqstDetails(ServiceRqstNumber,ServiceRqstType) {
		...
		jQuery('#div_progressBar').progressBar('${requestFormPopup.reqProgress}', { width:480,speed:25,increment:1,height:12,showText: false, boxImage: '/LexmarkOPSPortal/images/progressBar/progressbar.gif', barImage:barImages} );
		//alert('before ajax');			
	}
