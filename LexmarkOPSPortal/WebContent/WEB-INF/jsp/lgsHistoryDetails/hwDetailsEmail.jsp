...
<table width="953px" border="0" cellspacing="0" cellpadding="0" align="center" style="margin-top:-9.5%;border-width:1px; border-color:#3A7FA8; border-style:solid; background-color:#ffffff" id="emailPrintWraper">
  ...
  <tr>
    <td style="background-color:#3A7FA8;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="130" height="20" style="padding-top:3px; padding-bottom:3px; padding-left:10px; font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#ffffff"><strong><spring:message code="hardwareDetails.label.hardwareReqDetails"/> </strong> &raquo; <strong><span class="step"><spring:message code="Details.supplyRequestDetails.label.rquestNumber"/> <span id="reqNumber"></span></span></strong></td>
        </tr>
      </table></td>
  </tr>
  <tr>
        ...
        <tr>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="3">
             ...
             <tr>
              ...
              <tr>
                <td style="font-family:Arial, Helvetica, sans-serif; font-size:11px;"><strong><spring:message code="Details.changeRequestDetails.label.itemSubTotalBeforeTax"/></strong></td>
                <td style="font-family:Arial, Helvetica, sans-serif; font-size:11px;" id="beforeTax"></td>
              </tr>
             
              <tr>
                <td style="font-family:Arial, Helvetica, sans-serif; font-size:11px;"><strong><spring:message code="Details.changeRequestDetails.label.tax"/> </strong></td>
                <td style="font-family:Arial, Helvetica, sans-serif; font-size:11px;" id="tax"></td>
              </tr>
              
              <tr>
                <td style="font-family:Arial, Helvetica, sans-serif; font-size:11px;"><strong><spring:message code="Details.changeRequestDetails.label.total"/> </strong></td>
                <td style="font-family:Arial, Helvetica, sans-serif; font-size:11px;" id="total"></td>
              </tr>
        ...
        <tr>
		  ...
		  <table width="100%" border="0" cellspacing="0" cellpadding="5">
              <tr>
                <th colspan="2" align="left" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;background-color:#e7e7e7;border-bottom-color:#aaaaaa; border-bottom-width:1px; border-bottom-style:dotted;"><spring:message code="requestInfo.heading.shipToAddress"/></th>
           		...
           		<tr> 
           			<td colspan="2" valign="top"  style="font-family:Arial, Helvetica, sans-serif; font-size:11px;" id="shipToAddress">
                ...
                <td valign="top"  style="font-family:Arial, Helvetica, sans-serif; font-size:11px;" id="building"></td>
              </tr>
               <tr>
                ...
                <td valign="top"  style="font-family:Arial, Helvetica, sans-serif; font-size:11px;" id="floor"></td>
              </tr>
               <tr>
                ...
                <td valign="top"  style="font-family:Arial, Helvetica, sans-serif; font-size:11px;" id="office"></td>
              </tr>              
            </table></td>
		  ...
		  <table width="100%" border="0" cellspacing="0" cellpadding="5">
              ...
              <tr>
                ...
                <td valign="top"  style="font-family:Arial, Helvetica, sans-serif; font-size:11px;" id="specialInst"></td>
              </tr>
              </table></td>
        </tr>
