...
<div class="left-nav">
	<div class="left-nav-inner">
		...
		<!-- Style added to links for CI BRD13-10-12 -->
		 <c:if test="${ not empty sessionScope.userAccessMapForSr}"> 		
			 	  ...
			 	  <c:if test='${sessionScope.userAccessMapForSr ["SHOW ALL REQUEST"]=="true"}'> 
			 	 	<li  id="<%=ALL_REQUESTS%>" style="overflow:hidden; word-wrap: break-word;"><a href="#" onClick="callOmnitureAction('<%=LexmarkSPOmnitureConstants.REQUESTHISTORY%>','<%=LexmarkSPOmnitureConstants.REQUESTHISTORYLISTALLREQUEST%>');"><spring:message code="requestInfo.requestHistory.heading.allRequestTypes" /></a>
					</li>	
			 	 </c:if>			 	  
			 	 <c:if test='${sessionScope.userAccessMapForSr["SHOW CHANGE MGMT REQUEST"]=="true"}'> 
			 	 	<li  id="<%=CHANGE_REQUESTS%>" style="overflow:hidden; word-wrap: break-word;"><a href="#" onClick="callOmnitureAction('<%=LexmarkSPOmnitureConstants.REQUESTHISTORY%>','<%=LexmarkSPOmnitureConstants.REQUESTHISTORYLISTCHANGEREQUEST%>');"><spring:message code="requestInfo.requestHistory.heading.changeRequests" /></a>
					</li>	
			 	 </c:if>
				 ...
				 <!--c:if test='${sessionScope.userAccessMapForSr["SHOW SERVICE REQUEST"]=="true"}'--> 
			 	 	<li  id="<%=HARDWARE_REQUESTS%>" style="overflow:hidden; word-wrap: break-word;"><a href="#" onClick="callOmnitureAction('<%=LexmarkSPOmnitureConstants.REQUESTHISTORY%>','<%=LexmarkSPOmnitureConstants.REQUESTHISTORYLISTHARDWAREEQUEST%>');"><spring:message code="requestInfo.header.hardwareReq"/></a>
					</li>	
			 	 </c:if>
			 	<c:if test='${sessionScope.userAccessMapForSr["SHOW SERVICE REQUEST"]=="true"}'> 
			 	 	<li  id="<%=SERVICE_REQUESTS%>" style="overflow:hidden;word-wrap: break-word;"><a href="#" onClick="callOmnitureAction('<%=LexmarkSPOmnitureConstants.REQUESTHISTORY%>','<%=LexmarkSPOmnitureConstants.REQUESTHISTORYLISTSERVICEREQUEST%>');"><spring:message code="requestInfo.requestHistory.heading.serviceRequests" /></a>
					</li>	
			 	 </c:if>
			 	 
				 <c:if test='${sessionScope.userAccessMapForSr["SHOW SUPPLIES REQUEST"]=="true"}'> 
			 	 	<li  id="<%=SUPPLY_REQUESTS%>" style="overflow:hidden;word-wrap: break-word;"><a href="#" onClick="callOmnitureAction('<%=LexmarkSPOmnitureConstants.REQUESTHISTORY%>','<%=LexmarkSPOmnitureConstants.REQUESTHISTORYLISTSUPPLYREQUEST%>');"><spring:message code="requestInfo.requestHistory.heading.supplyRequests" /></a>
					</li>	
			 	 </c:if>
		...
		<ul id="radioFilters" class="filters radio">
			<li style="overflow:hidden;"><div style="width:13%;float:left;"><input type="radio" name="filterByView" id="myRequest" value="myRequest" /> </div><div style="width:83%;float:left; word-wrap: break-word;">
					  <label for="myRequest"><spring:message code="requestInfo.options.myRequests" /></label></div>
			</li>
			<li style="overflow:hidden;"><div style="width:13%;float:left;"><input type="radio" name="filterByView" id="bookmarkedAsset" value="bookmarkedAsset"/></div><div style="width:87%;float:left;word-wrap: break-word;">
					<label for="bookmarkedAsset"><spring:message code="requestInfo.options.bookmarkedAssetRequests" /></label></div>
			</li style="overflow:hidden;">
			<li style="overflow:hidden;"><div style="width:13%;float:left;"><input type="radio" name="filterByView" id="showAll"  value="showAll" checked="checked"/></div><div style="width:83%;float:left;word-wrap: break-word;"> <label
		...
		<div id="dateErrorDiv" style="display: none;color:red;"></div>
		 <ul class="filters">
              <li>
                <label for="from" style="word-wrap: break-word;"><spring:message code="requestInfo.requestHistory.label.from" />:</label>
                <span>
               <input id="localizedBeginDate" type="text" size=10  class="w100 w91" readOnly="readonly"></input>
              ...
              <li>
                <label for="to" style="word-wrap: break-word;"><spring:message code="requestInfo.requestHistory.label.to" />:</label>
                <span>
               <input id="localizedEndDate" type="text" size=10  class="w100 w91" readOnly="readonly"></input>
		...
		<div class="left-nav-header">
			...
			<div id='deviceLocInfoDiv' style="display:none;">
					...
					<div style="float:right;padding-right:10px;"><img class="ui_icon_sprite trash-icon" src="<html:imagesPath/>transparent.png" id="deleteDeviceLocBtn" height="18" width="18" /></div>
				</div>
			...
			<div id='chlInfoDiv' style="display:none;">
				...
				<div style="float:right;padding-right:10px;"><img class="ui_icon_sprite trash-icon" src="<html:imagesPath/>transparent.png" id="deleteChlBtn" height="18" width="18" /></div>
			</div>
...
function appednCancelIcon(id){
	...
	if(cancelIsprsnt || $('#'+id).val()==""){return;}
