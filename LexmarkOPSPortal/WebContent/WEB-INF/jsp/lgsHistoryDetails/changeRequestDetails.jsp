          ...
          <div class="columnsTwo">
            <div class="infoBox columnInner rounded shadow">
              ...
              <ul class="roDisplay">
                ...
                <li><label for="lbsIdentifier"><spring:message code="requestInfo.addressInfo.label.lbsIdentifier"/>  </label><span id="lbsIdentifier"> ${requestForm.serviceRequest.asset.installAddress.LBSIdentifierFlag}</span></li>
              </ul>
            </div>
          </div>
          <div class="columnsTwo">
...
<!--        			<div id="div_notificationsPrintTable"> -->
					<div id="notificationsGrid" style="display:block;width:250px!important;">
						<div id="div_notifications_container" style="width:650px!important;"></div>
