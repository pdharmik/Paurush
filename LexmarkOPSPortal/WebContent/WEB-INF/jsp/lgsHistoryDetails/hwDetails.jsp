...
<!-- END -->
   <div class="journal-content-article">
      ...
      <!-- div Added for email and Print Link -->
          <div class="utilities floatR" style="margin-top: -70px !important;">
		  	<ul>
            ...
            <div class="columnInner">
              <ul class="form">
                ...
                <li>
                  ...
                  <span id="projectName">${requestForm.serviceRequest.projectName }</span>
                  </li>
                  <li>
                  <label><spring:message code="requestInfo.label.projectPhase"/> </label>
                  <span id="projectPhase">${requestForm.serviceRequest.projectPhase }</span>
                  </li>
              </ul>
            </div>
          </div>
          ...
          <div class="columnsTwo">
            <div class="infoBox columnInner rounded shadow">
              ...
              <ul class="roDisplay">
                ...
                <li><span id="lbsIdentifier"><spring:message code="requestInfo.addressInfo.label.lbsIdentifier"/>  ${requestForm.serviceRequest.serviceAddress.LBSIdentifierFlag} </span></li>
              </ul>
            </div>
          </div>
          <div class="columnsTwo">
