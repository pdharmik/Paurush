...
<div id="pageCount" style="min-width: 600px;">
   ...
   <div class="portlet-wrap">
      <div class="portletBlock bgSolid">
       <div class="portlet-wrap rounded popupInner">
          <div class="portlet-wrap-inner"><div id="pagecountGrid" style="background-color: white;"></div></div>
				...
				success: function(results){
					...
					if(obj2 !=null){
						if(obj2=="{\"success\":\"<strong>Page Count Data has been successfully updated.</strong>\"}"){
							...
							jQuery("#validationErrors").show();
							value="There has been an error in saving page counts data. Please try again.";
						...
						if(window.parent.window.isSuccessfulUpdate==true)
						{
							...
							initializePageCountGrid(assetID, getSerialNumber, getipAddress, getProductLine, getAssetTag);
						}
