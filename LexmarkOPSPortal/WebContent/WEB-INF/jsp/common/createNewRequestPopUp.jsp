...
<div class="portletBodyWrap modal">
	<div>
       ...
       %>
  <div class="columnsThree hovfx" style="height:auto!important" id="consumablesLinksDiv">
    <div class="columnInner"><img class="ui_icon_sprite widgets req_supplies-icon" src="/LexmarkOPSPortal/images/transparent.png" alt="Supplies Request" ></img>
      ...
      %>
  <div class="columnsThree hovfx" id="changeManagementLinks" style="height:auto!important">
    <div class="columnInner"> <img class="ui_icon_sprite widgets req_change-icon" src="/LexmarkOPSPortal/images/transparent.png" alt="Change Management Requests" />
  ...
  <!-- Moved Inquiry to Request Service Section -->
       ...
       if(createServiceReq!=null && createServiceReq.equalsIgnoreCase("True") && createChangeMgmtReq!=null && createChangeMgmtReq.equalsIgnoreCase("False"))
      {
    	...
    	%> 
    	<div class="columnsThree hovfx" id="breakFixLinks" style="height:auto!important">
    <div class="columnInner"> <img class="ui_icon_sprite widgets req_service-icon" src="/LexmarkOPSPortal/images/transparent.png" alt="Service Request" />
  ...
  <div class="clear"></div>
  <div class="greenBanner"><!-- img src="/LexmarkOPSPortal/images/gogreen.jpg" width="129" height="75" alt="Go Green" /-->
    <div>
      ...
      <a href="#" id="recycleItemLink" style="cursor: pointer" ; ><spring:message code="requestInfo.popup.label.recycleItems"/> &raquo;</a> </div>
  </div>
