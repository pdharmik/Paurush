...
<div class="portletBlock infoBox rounded shadow multi-assets-block">
	<div class="columnsOne">
		<div class="columnInner multi-assets">
			<h4>Devices Included in this Request</h4>
			<c:choose>					
							...
							<table>
								<tbody>
									<tr>
										...
										<td><label>Contact for this Device</label></td>
										<td><form:input path="assetDetailsMap['${assetDetail.key}'].assetContact.firstName" id="${assetDetail.key}_contactName"/></td>
										<c:choose>	
											<c:when test="${pageFlow eq 'Decommission'}">
												<td><label>Pickup From:</label></td>
											</c:when>
											<c:otherwise>
												<td><label>Move to:</label></td>
											</c:otherwise>
									</c:choose>
										<td><label>Building </label><label id="${assetDetail.key}_bldngMandat" class="bldngMandat">*</label></td>
										<td colspan="2">
									...
									<tr>
										...
										<td><label>Contact email address</label></td>
										<td><form:input path="assetDetailsMap['${assetDetail.key}'].assetContact.emailAddress" id="${assetDetail.key}_contactEmail"/></td>
										<td></td>
										<td><label>Floor </label><label id="${assetDetail.key}_flrMandat" class="flrMandat">*</label></td>
										<td colspan="2">
									...
									<tr>
										...
										<td></td>
										<td><label>Zone </label><label id="${assetDetail.key}_zoneMandat" class="zoneMandat">*</label></td>
										<td colspan="2">
									...
									<tr>
										<td colspan="2"><a style="cursor: pointer;" onClick="openPopUpPg('${assetDetail.key}', '${assetDetail.value.serialNumber}', '${assetDetail.value.ipAddress}', '${assetDetail.value.productTLI}', '${assetDetail.value.deviceTag}')">Update Page Count</a></td>
										<td></td>
										<td></td>
										<td></td>
										<td></td>
										<td colspan="2">
											<span id="${assetDetail.key}_gridLi" style="display: none;" class="assetGridLi">
												<a href="#" id="${assetDetail.key}_assetGridLink" class="assetGridLink" assetIndicator="${assetDetail.key}">View Grid</a>
												<div id="assetXYLblDiv">
													<label id="assetXYLbl">Grid X/Y : </label><label id="${assetDetail.key}_assetCoords" class="assetCoords"></label>
												</div>
											</span>
										</td>
									</tr>
