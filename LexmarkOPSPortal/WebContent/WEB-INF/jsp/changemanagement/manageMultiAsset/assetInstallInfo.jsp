...
<div class="columnsOne">
	<div class="infoBox columnInner rounded shadow">
		<c:choose>
			...
			<c:when test="${pageFlow eq 'addMultiple'}">
		...
		<div class="columnsTwo installSection">
			<div class="infoBox columnInner rounded shadow">
				<h4>
					<a href="${addressListPopUpUrl}"
					title="<spring:message code="requestInfo.title.selectAddress"/>"
					id="diffAddressLink" class="lightboxLarge"
					onclick="return popupAddress('diffAddressLink');"><spring:message code="requestInfo.link.selectAnAddress"/>
					</a>
					<c:choose>					
						<c:when test="${pageFlow eq 'Change'}">
...
<!-- infoBox columnInner rounded shadow -->
