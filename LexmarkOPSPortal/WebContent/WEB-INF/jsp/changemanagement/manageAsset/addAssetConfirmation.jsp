              ...
              <div class="infoBox columnInner rounded shadow">
                ...
                <ul class="form wordBreak">
                  ...
                  <li>
                    ...
                    <span id="description" style="word-wrap: break-word;word-break: normal; width:250px">${manageAssetForm.serviceRequest.addtnlDescription}</span>                   
				  </li>
				  <li>
          			...
          			<div class="columnsOne">
            			<div class="infoBox columnInner rounded shadow">
            				<h4><spring:message code="requestInfo.heading.notes"/></h4>
            				 <p class="multiLine notesOverflow" style="word-wrap: break-word;word-break: normal">${attachmentForm.attachmentDescription}</p>
            			</div>
            		</div>
            	</div>
