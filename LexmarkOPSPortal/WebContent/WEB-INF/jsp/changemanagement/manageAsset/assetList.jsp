          ...
          <div class="grid-controls"> 
            ...
            <div class="expand-min">
              ...
              <li class="first"><img class="ui_icon_sprite minimize-icon" src="<html:imagesPath/>transparent.png" alt="Minimize All"
						...
						<li><!-- <a href="#grid" id='headerImageButton'> --><img class="ui_icon_sprite customize-icon" src="<html:imagesPath/>transparent.png"  style="cursor:pointer" height="25" width="25" />
