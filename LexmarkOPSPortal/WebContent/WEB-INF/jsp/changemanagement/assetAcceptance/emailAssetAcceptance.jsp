...
<table width="800"  border="0" cellspacing="0" cellpadding="0" align="center" style="border-width:1px; border-color:#3A7FA8; border-style:solid; background-color:#ffffff" id="emailPrintWraper">
  ...
  <tr>
    <td style="background-color:#3A7FA8;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td  style="padding-top:3px; padding-bottom:3px; padding-left:10px; font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#ffffff"><strong><span id="changeRequest"><spring:message code="requestInfo.cm.heading.changeRequest"/></span>&nbsp; &raquo;&nbsp;
    ...
    <td><!-- PRIMARY SECONDARY CONTACTS & ADDITIONAL INFO - START -->
        ...
        <tr>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="5" style="float: right;">
              ...
              <tr>
                ...
                <td valign="top"  style="font-family:Arial, Helvetica, sans-serif; font-size:11px;"><div id ="addtnlInfo_description" class="smallNotesOverflow"></div>
      ...
      <table width="100%" border="0" cellspacing="5" cellpadding="0" >
        <tr>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="5">
              <tr>
                <th colspan="2" align="left" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;background-color:#e7e7e7;border-bottom-color:#aaaaaa; border-bottom-width:1px; border-bottom-style:dotted;"><spring:message code="requestInfo.cm.chlothers.heading.newChangedSelected"/> </th>
              </tr>
               ...
               <tr>
                ...
                <td valign="top" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;" id="subArea">
				</td>
              </tr>
              <tr>
