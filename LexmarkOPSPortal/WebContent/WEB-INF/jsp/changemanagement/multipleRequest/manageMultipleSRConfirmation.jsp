          ...
          <!-- MAIN CONTENT BEGIN -->
           ...
           <div class="utilities printPage floatR">
		    <ul>
		      ...
		      <li><a href="javascript: print();"><img src="/LexmarkOPSPortal/images/transparent.png" class="ui_icon_sprite print-icon" alt="<spring:message code='requestInfo.link.printThisPage'/>" title="<spring:message code='requestInfo.link.printThisPage'/>"></a></li>
		    </ul>
		  </div>
