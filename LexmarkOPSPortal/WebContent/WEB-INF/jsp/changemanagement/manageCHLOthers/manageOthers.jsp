...
//	Change Account Link Hide/Show for CI-7 Defect #12274
	...
	<c:if test="${chlOthersForm.flowType != null && chlOthersForm.flowType =='cancel'}">
		...
		combo.disable(true);
		jQuery('.dhx_combo_img').attr('src','/LexmarkOPSPortal/images/comboImgs/combo_select_disable.gif');
				...
				<form:input path="prevSRNumber" /> 
                  ...
                  <!-- 	changed -->
					  ...
					  <li>
	                    ...
	                    <span class="comboSelect" id="rqstSubTypeDiv2" style="display: none;margin-left: -18px;">
