...
<div id="content-wrapper-inner">
    ...
    <div id="availableAction" style="display: none;">
    	   	<ul class="filters">
	    	<li><a style="cursor:pointer;" id="editInlineContact"><spring:message code="requestInfo.contact.editContact"/></a></li>
	    	<li><a style="cursor:pointer;" id="editContactAddress"><spring:message code="requestInfo.contact.editContactAddressLink"/></a></li>
	    	</ul>
    	
    </div>
     	<div id="requestConfirmDiv" style="display: none;">
      		
		 <div style="width:auto;float:left;margin-right:30px;">
		 	<img src="<html:imagesPath/>green-check.png" alt="green check" width="50" height="50">
		 </div>
		 <div>
		 	<spring:message code="requestInfo.contact.saved"/>
		 </div>
		 <div class="buttonContainer" style="border-top: 0 dotted #AAAAAA!important;text-align: center!important;">
