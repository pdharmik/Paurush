...
dhtmlXGridObject.prototype._createHContext = function() {
	...
	a.push("<table><tr><td colspan='2'><div><h4><a class='ui_icon_sprite ui-icon-closethick' style='cursor: pointer' onclick='document.getElementById(\"grid_menu\").style.display=\"none\"'>"
			+"</a><label>"
...
dhtmlXGridObject.prototype._showHContext = function(mode, x, y) {
	...
	if (mode) {
		...
		this._hContext.style.left = parseInt(x - 280) + "px";
