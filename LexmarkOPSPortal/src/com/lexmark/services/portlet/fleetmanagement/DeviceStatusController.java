...
public class DeviceStatusController {
	...
	public void retrieveDeviceStatuspopupInformation(ResourceRequest request,
		...
		LOGGER.debug("[in retrieveDeviceStatuspopupInformation]");
		String result = null;
		try{
			...
			LOGGER.debug("[out retrieveDeviceStatuspopupInformation]");
	...
	public void retrieveDropdownValues(PortletRequest request,Model model){
		...
		try {
			...
			alertDevice = commonController.retrieveLocalizedLOVMap(SiebelLocalizationOptionEnum.LBS_DEVICE_INTERNAL.getValue(), request.getLocale());
